...
if ($_GET['admin'] == "newforum") {
    ...
    if ($database->CheckForum($aid)) {
        ...
        echo "<p class=\"error\">" . AL_FORUMNOTCREATED . "</p><p>
<button type=\"submit\" value=\"Upgrade level\" class=\"green build\" name=\"s1\" id=\"btn_save\" onclick=\"window.location.href = 'allianz.php?s=2&admin=newforum'; return false;\">
		...
		<div class=\"button-content\">" . AL_NEWFORUM . "</div></div></button></p>";
    }
}
