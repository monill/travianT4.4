...
<form action="spieler.php" method="POST">
    ...
    <h4 class="round">Edit &#1662;&#1585;&#1608;&#1601;&#1575;&#1740;&#1604;</h4>
        ...
        <tbody>
            <tr>
                ...
                <td class="gender" rowspan="2">
                    <label>
                        <input class="radio" type="radio" name="mw" value="0" <?php if ($session->userinfo['gender'] == 0) {
                                                                                    echo "checked";
                                                                                } ?>> &#1605;&#1588;&#1582;&#1589; &#1606;&#1588;&#1583;&#1607;</label><br>
                    <label>
                        <input class="radio" type="radio" name="mw" value="1" tabindex="5" <?php if ($session->userinfo['gender'] == 1) {
                                                                                                echo "checked";
                                                                                            } ?>> &#1662;&#1587;&#1585; </label><br>
                    <label>
                        <input class="radio" type="radio" name="mw" value="2" <?php if ($session->userinfo['gender'] == 2) {
                                                                                    echo "checked";
                                                                                } ?>>&#1583;&#1582;&#1578;&#1585;</label>
                </td>
            </tr>
    ...
    <table cellpadding="1" cellspacing="1" id="villages">
        ...
        <tbody>
            ...
            while ($row = mysql_fetch_array($sql)) {
                $vname = $row['name'];
                if ($row['owner'] == 2) {
                    $cVName = defined($vname);
                    ($cVName ? constant($vname) : $vname);
                }
                echo "<tr>";
                ...
                while ($row2 = mysql_fetch_array($sql2)) {
                    ...
                    switch ($type) {
                        case 1:
                        case 2:
                            echo "<img class='r1' src='/assets/images/x.gif' title='" . WOOD . "'>";
                            break;
                        case 3:
                            echo "<img class='r1' src='/assets/images/x.gif' title='" . WOOD . "'> <img class='r4' src='/assets/images/x.gif'
                    title='" . CROP . "'>";
                            break;
                        case 4:
                        case 5:
                            echo "<img class='r2' src='/assets/images/x.gif' title='" . CLAY . "'>";
                            break;
                        case 6:
                            echo "<img class='r2' src='/assets/images/x.gif' title='" . CLAY . "'> <img class='r4' src='/assets/images/x.gif'
                    title='" . CROP . "'>";
                        case 7:
                        case 8:
                            echo "<img class='r3' src='/assets/images/x.gif' title='" . IRON . "'>";
                            break;
                        case 9:
                            echo "<img class='r3' src='/assets/images/x.gif' title='" . IRON . "'> <img class='r4' src='/assets/images/x.gif'
                    title='" . CROP . "'>";
                            break;
                        case 10:
                        case 11:
                        case 12:
                            echo "<img class='r4' src='/assets/images/x.gif' title='" . CROP . "'>";
                            break;
                    }
                }
                echo "</td>";
                ...
                echo "<td class=\"coords\"><a href=\"karte.php?x=" . $coords['y'] . " &y=" . $coords['x'] . " \"><span
                        class=\"coordinates coordinatesAligned\"><span class=\"coordinatesWrapper\">";
                if (DIRECTION == 'ltr') {
                    echo "<span class=\"coordinateX\">(" . $coords['x'] . "</span><span
                                class=\"coordinatePipe\">|</span><span class=\"coordinateY\">" . $coords['y'] .
                        ")</span>";
                } elseif (DIRECTION == 'rtl') {
                    echo "<span class=\"coordinateY\">" . $coords['y'] . ")</span><span
                                class=\"coordinatePipe\">|</span><span class=\"coordinateX\">(" . $coords['x'] .
                        "</span>";
                }
                echo "</span></span></td>";
                echo "</tr>";
    ...
    <div class="submitButtonContainer">
        <button type="submit" value="submit" name="s1" id="btn_ok">
            <div class="button-container">
                ...
                <div class="button-contents">&#1584;&#1582;&#1740;&#1585;&#1607;</div>
            </div>
        </button>
    </div>
</form>
