		...
		datas:
		{
			reportId:	'21073608'
                ...
                <div id="message">
                    ...
                    if ($query['nopicn'] == 0) {
                    ?>
                        <img src="/assets/images/x.gif" class="reportImage reportType3" alt="">
                    <?php
                    }
                    ...
                    <table cellspacing="0" cellpadding="0" class="tbg">
                        <tbody>
                            <tr>
                                ...
                                <td class="f16">
                                    <img src="/assets/images/x.gif" class="bigArrow" alt="">
                                </td>
                                <td class="s7">
                                    <div class="boxes boxesColor gray support">
                                        <div class="boxes-tl"></div>
                    ...
                    <table cellpadding="0" cellspacing="0" id="trade">
                        <thead>
                            <tr>
                                <td colspan="2" class="troopHeadline">
                                    ...
                                    echo sprintf(
                                        MK_SENDRES,
                                        '<a href="position_details.php?d=' . $dataarray[0] . '&c=' . $generator->getMapCheck($dataarray[0]) . '">' . $SenderData['name'] . '</a>',
                                        '<a href="position_details.php?d=' . $dataarray[1] . '&c=' . $generator->getMapCheck($dataarray[1]) . '">' . $ReceiveData['name'] . '</a>'
                                    );
                                    ?>
                                </td>
                            </tr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="rArea">
                                        <img class="r1" src="/assets/images/x.gif" title="<?php echo VL_WOOD; ?>">
                                        <?php echo $dataarray[2]; ?>
                                    </div>
                                    <div class="rArea">
                                        <img class="r2" src="/assets/images/x.gif" title="<?php echo VL_CLAY; ?>">
                                        <?php echo $dataarray[3]; ?>
                                    </div>
                                    <div class="rArea">
                                        <img class="r3" src="/assets/images/x.gif" title="<?php echo VL_IRON; ?>">
                                        <?php echo $dataarray[4]; ?>
                                    </div>
                                    <div class="rArea">
                                        <img class="r4" src="/assets/images/x.gif" title="<?php echo VL_CROP; ?>">
                            ...
                            <tr>
                                ...
                                <td><img src="/assets/images/x.gif" class="clock" title="<?php echo BL_TIME; ?>">
                                    0:00:00
                                </td>
                            </tr>
                        </tbody>
