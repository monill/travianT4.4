...
<table cellpadding="1" cellspacing="1" id="player_off" class="row_table_data">
    ...
    <tbody>
        ...
        if ($page == "1" && $lastPage == "1") {
            ...
            $paginationDisplay .= '<img alt="' . PREVPAGE . '" src="/assets/images/x.gif" class="previous disabled">';
            $paginationDisplay .= $centerPages;
            $paginationDisplay .= '<a class="next" href="?tid=31&page=' . $nextPage . '"><img alt="' . NEXTPAGE . '" src="/assets/images/x.gif"></a> ';
            $paginationDisplay .= '<a class="last" href="?tid=31&page=' . $lastPage . '"><img alt="' . LASTPAGE . '" src="/assets/images/x.gif"></a>';
        } elseif ($page != "1" && $page != $lastPage) {
            $paginationDisplay .= '<a class="first" href="?tid=31&page=1"><img alt="' . FIRSTPAGE . '" src="/assets/images/x.gif"></a> ';
            $paginationDisplay .= '<a class="previous" href="?tid=31&page=' . $previous . '"><img alt="' . PREVPAGE . '" src="/assets/images/x.gif"></a>';
            $paginationDisplay .= $centerPages;
            $paginationDisplay .= '<a class="next" href="?tid=31&page=' . $nextPage . '"><img alt="' . NEXTPAGE . '" src="/assets/images/x.gif"></a> ';
            $paginationDisplay .= '<a class="last" href="?tid=31&page=' . $lastPage . '"><img alt="' . LASTPAGE . '" src="/assets/images/x.gif"></a>';
            ...
            <div class="boxes-contents w292">
                <table class="transparent">
                    <tbody>
                        <tr>
                            <td>
                                <span><?php echo AL_RANK; ?> <input type="text" class="text ra" maxlength="5" name="rank" value="<?php $ranks = isset($_POST['rank']) ? $_POST['rank'] : $nranks;
                                                                                                                                    echo $ranks; ?>" /></span>
                            </td>
                            <td>
