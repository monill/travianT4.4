...
if ($_SESSON['access'] == MULTIHUNTER) {
    die("<br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><b><font color='Red'><center>Access Denied: You are not admin</b></font></center>");
}
?>
<style>
    .del {
...
<form action="process.php" method="post">
    ...
    <table id="profile">
        ...
        <tr>
            <td>Server Name</td>
            <td>
                <input type="text" dir="ltr" class="text" name="servername" id="servername" value="<?php echo SERVER_NAME; ?>">
            </td>
        </tr>
        <tr>
    ...
    <table id="profile">
        ...
        <td>
            <?php
            HOME3 == true ? $sts = "selected=\"selected\"" : $sts = "";
            HOME3 == false ? $sts2 = "selected=\"selected\"" : $sts2 = "";
            ?>
        ...
        <table id="member">
            ...
            <table id="profile">
                ...
                <tr>
                    ...
                    <td><?php
                        if (LIMIT_MAILBOX == true) {
                            echo "<input name=\"max_mails\" dir=\"ltr\" class=\"text\" type=\"number\" id=\"max_mails\" value=\"" . MAX_MAIL . "\" size=\"15\">";
                ...
                <tr>
                    ...
                    <td>
                        <?php
                        INCLUDE_ADMIN == true ? $sts = "selected=\"selected\"" : $sts = "";
                        INCLUDE_ADMIN == false ? $sts2 = "selected=\"selected\"" : $sts2 = "";
                        ?>
            ...
            <table id="member">
                ...
                <br />
                <center>
                    <button type="submit" value="Submit" class="build">Submit</button>
                </center>
</form>
<?php
