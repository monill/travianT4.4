...
<div id="build" class="gid17">
    ...
    <div class="build_desc">
        <a href="#" onClick="return Travian.Game.iPopup(17,4);" class="build_logo">
            <img class="building big white g17" src="/assets/images/x.gif" alt="<?php echo B17; ?>" title="<?php echo B17; ?>"/>
        </a>
    ...
    if (isset($_GET['c'])) {
        ...
        <p><b><?php echo RAWMATERIALSDISTRIBUTED ?>.</b> <?php echo COST; ?>: <b>3 </b><img src="/assets/images/x.gif" class="gold"
                                                                                            alt="<?php echo GOLD; ?>"
                                                                                            title="<?php echo GOLD; ?>"/>
        </p>
        <a href="javascript: history.go(-2)"><?php echo BACKTOTHEBUILDING; ?></a>
    ...
    <?php } else { ?>
        ...
        <div class="boxes boxesColor gray traderCount">
            ...
            <div class="boxes-contents"> <?php echo MERCHANTS . ' ' . $market->merchant; ?>
    ...
    ?>
        <form method="POST" name="snd" action="build.php">
            ...
            <table id="send_select" class="send_res" cellpadding="1" cellspacing="1">
                <tr>
                    <td class="ico"><img class="r1" src="/assets/images/x.gif" alt="<?php echo LUMBER; ?>"
                ...
                <tr>
                    <td class="ico"><img class="r2" src="/assets/images/x.gif" alt="<?php echo CLAY; ?>"
                                         title="<?php echo CLAY; ?>"/></td>
                ...
                <tr>
                    <td class="ico"><img class="r3" src="/assets/images/x.gif" alt="<?php echo IRON; ?>"
                                         title="<?php echo IRON; ?>"/></td>
                ...
                <tr>
                    <td class="ico"><img class="r4" src="/assets/images/x.gif" alt="<?php echo CROP; ?>"
                                         title="<?php echo CROP; ?>"/></td>
    ...
    <?php }else { ?>
        <form method="POST" name="snd" action="build.php?t=4">
            ...
            <table id="send_select" class="send_res" cellpadding="1" cellspacing="1">
                ...
                <tr>
                    ...
                    <td class="ico">
                        <a href="#" onClick="upd_res(1,1); return Lumberlse;"><img class="r1" src="/assets/images/x.gif"
                                                                                   alt="<?php echo LUMBER; ?>"
                                                                                   title="<?php echo LUMBER; ?>"/></a>
                    </td>
                    <td class="nam">
                        <?php echo LUMBER; ?>
                    </td>
                    <td class="val">
                        <input class="text" type="text" name="r1" id="r1" value="<?php echo $_POST['r1']; ?>"
                               maxlength="5" onKeyUp="upd_res(1)" tabindex="1">
                    </td>
                    <td class="max">
                        / <a href="#" onMouseUp="add_res(1);"
                             onClick="return Lumberlse;"><?php echo $market->maxcarry; ?></a>
                    </td>
                </tr>
                <tr>
                    <td class="ico">
                        <a href="#" onClick="upd_res(2,1); return Lumberlse;"><img class="r2" src="/assets/images/x.gif"
                                                                                   alt="<?php echo CLAY; ?>"
                                                                                   title="<?php echo CLAY; ?>"/></a>
                    </td>
                    <td class="nam">
                        <?php echo CLAY; ?>
                    </td>
                    <td class="val">
                        <input class="text" type="text" name="r2" id="r2" value="<?php echo $_POST['r2']; ?>"
                               maxlength="5" onKeyUp="upd_res(2)" tabindex="2">
                    </td>
                    <td class="max">
                        / <a href="#" onMouseUp="add_res(2);"
                             onClick="return Lumberlse;"><?php echo $market->maxcarry; ?></a>
                    </td>
                </tr>
                <tr>
                    <td class="ico">
                        <a href="#" onClick="upd_res(3,1); return Lumberlse;"><img class="r3" src="/assets/images/x.gif"
                                                                                   alt="<?php echo IRON; ?>"
                                                                                   title="<?php echo IRON; ?>"/></a>
                    </td>
                    <td class="nam">
                        <?php echo IRON; ?>
                    </td>
                    <td class="val">
                        <input class="text" type="text" name="r3" id="r3" value="<?php echo $_POST['r3']; ?>"
                               maxlength="5" onKeyUp="upd_res(3)" tabindex="3">
                    </td>
                    <td class="max">
                        / <a href="#" onMouseUp="add_res(3);"
                             onClick="return Lumberlse;"><?php echo $market->maxcarry; ?></a>
                    </td>
                </tr>
                <tr>
                    <td class="ico">
                        <a href="#" onClick="upd_res(4,1); return Lumberlse;"><img class="r4" src="/assets/images/x.gif"
                                                                                   alt="<?php echo CROP; ?>"
                                                                                   title="<?php echo CROP; ?>"/></a>
                    </td>
                    <td class="nam">
                        <?php echo CROP; ?>
                    </td>
                    <td class="val">
                        <input class="text" type="text" name="r4" id="r4" value="<?php echo $_POST['r4']; ?>"
                               maxlength="5" onKeyUp="upd_res(4)" tabindex="4">
                    </td>
                    <td class="max">
                        / <a href="#" onMouseUp="add_res(4);"
                             onClick="return Lumberlse;"><?php echo $market->maxcarry; ?></a>
                    </td>
                </tr>
            </table>
                        ...
                        <table cellpadding="0" cellspacing="0" class="transparent compact">
                            ...
                            <tr>
                                ...
                                <td class="compactInput">
                                    <input class="text village" type="text" name="dname"
                                           value="<?php echo(isset($_POST['dname']) ? $_POST['dname'] : ''); ?>"
                                ...
                                <td>
                                    ...
                                    <div class="coordinatesInput">
                                        <div class="xCoord">
                                            ...
                                            <input class="text coordinates x " type="text" name="x" id="x"
                                                   value="<?php echo $coor['x']; ?>" maxlength="4" tabindex="6">
                                        </div>
                                        <div class="yCoord">
                                            <label for="yCoordInput">Y:</label>
                                            <input class="text coordinates y " type="text" name="y" id="y"
                                                   value="<?php echo $coor['y']; ?>" maxlength="4" tabindex="7">
                                        </div>
                                        <div class="clear"></div>
                                    </div>
                                    <div class="clear"></div>
        ...
        <p>
            ...
            if (count($market->recieving) > 0) {
                ...
                foreach ($market->recieving as $recieve) {
                    ...
                    echo "<img class=\"r1\" src=\"/assets/images/x.gif\" alt=\"Lumber\" title=\"Lumber\" /> " . $recieve['wood'] . " <img class=\"r2\" src=\"/assets/images/x.gif\" alt=\"Clay\" title=\"Clay\" /> " . $recieve['clay'] . " <img class=\"r3\" src=\"/assets/images/x.gif\" alt=\"Iron\" title=\"Iron\" /> " . $recieve['iron'] . " <img class=\"r4\" src=\"/assets/images/x.gif\" alt=\"Crop\" title=\"Crop\" /> " . $recieve['crop'] . "</td></tr></tbody>";
                    echo "</table>";
                    $timer += 1;
                }
            }
            if (count($market->sending) > 0) {
                ...
                foreach ($market->sending as $send) {
                    ...
                    echo "<img class=\"r1\" src=\"/assets/images/x.gif\" alt=\"Lumber\" title=\"Lumber\" /> " . $send['wood'] . " <img class=\"r2\" src=\"/assets/images/x.gif\" alt=\"Clay\" title=\"Clay\" /> " . $send['clay'] . " <img class=\"r3\" src=\"/assets/images/x.gif\" alt=\"Iron\" title=\"Iron\" /> " . $send['iron'] . " <img class=\"r4\" src=\"/assets/images/x.gif\" alt=\"Crop\" title=\"Crop\" /> " . $send['crop'] . "</td></tr></tbody>";
                    echo "</table>";
                    $timer += 1;
                }
            }
            if (count($market->return) > 0) {
                ...
                foreach ($market->return as $return) {
                    ...
                    echo $datetime[1] . "</div>";
                    echo "</td> </tr> <tr class=\"res\"> <th>" . RESOURCE . "</th><td>";
                    echo "<img class=\"r1\" src=\"/assets/images/x.gif\" alt=\"Lumber\" title=\"Lumber\" />" . $return['wood'] . " | <img class=\"r2\" src=\"/assets/images/x.gif\" alt=\"Clay\" title=\"Clay\" />" . $return['clay'] . " | <img class=\"r3\" src=\"/assets/images/x.gif\" alt=\"Iron\" title=\"Iron\" />" . $return['iron'] . " | <img class=\"r4\" src=\"/assets/images/x.gif\" alt=\"Crop\" title=\"Crop\" />" . $return['crop'] . "</td></tr></tbody>";
