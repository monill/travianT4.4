                                    ...
                                    <table class="transparent" cellpadding="1" cellspacing="1" id="links">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="addLine templateElement insertElement">
                                                <td class="nr">
                                                    <input class="text" type="text" name="nr[]" value="<?php echo $number; ?>" size="1" maxlength="3" />
                                                </td>
                                                <td class="nam">
                                                ...
                                                <td class="add">
                                                    <button type="button" class="removeLine removeElement hide" title="delete" onclick="this.up('tr').hide().down('.link input').value = '';"></button>
