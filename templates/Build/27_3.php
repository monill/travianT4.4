...
<div id="build" class="gid27">
    <div class="build_desc">
        <a href="#" onClick="return Travian.Game.iPopup(27,4);" class="build_logo">
            <img class="building big white g27" src="/assets/images/x.gif" alt="<?php echo B27; ?>" title="<?php echo B27; ?>">
        </a>
        <?php echo B27_DESC; ?>
    </div>
    <?php
    ...
    include("27_menu.php");
    ?>
    <h4 class="round"><?php echo ART_BIGARTES; ?></h4>
    <table id="show_artefacts" cellpadding="1" cellspacing="1">
        ...
        if (count($artefacts) == 0) {
            echo '<td colspan="4" class="none">' . ART_NOBIGARTES . '</td>';
        } else {
            $curtype = 0;
            foreach ($artefacts as $artefact) {
                ...
                echo '<tr>';
                echo '<td class="icon"><img class="artefact_icon_' . $artefact['type'] . '" src="/assets/images/x.gif" alt="" title=""></td>';
                echo '<td class="nam">';
