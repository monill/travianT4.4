...
<div class="build_desc">
    <a href="#" onclick="return Travian.Game.iPopup(27,4);" class="build_logo">
        <img class="building big white g27" src="/assets/images/x.gif" alt="<?php echo B27; ?>">
    </a>
...
<div id="contract" class="contract contractNew contractWrapper">
    ...
    <div class="contractLink">
        ...
        <span class="buildingCondition"><a href="#"
                                           onclick="return Travian.Game.iPopup(15,4, 'gid');"><?php echo B15; ?></a> <span><?php echo BL_LVL; ?> 10</span></span>,<span
                class="buildingCondition"><a href="#"
                                             onClick="return Travian.Game.iPopup(40,4, 'gid');"><strike><?php echo B40; ?></strike></a></span>
    </div>
    <div class="clear"></div>
</div>
<div class="clear"></div>
