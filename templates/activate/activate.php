...
?>
    ...
    <form action="activate.php" method="post">
        <div class="code">
            <b><?php echo ACTCODE; ?>:</b>
        </div>
        <div>
            <input class="text" type="text" name="id" maxlength="10" />
            <button type="submit" value="<?php echo CONFIRM; ?>" name="s1" id="btn_send" class="green sendActivation">
    ...
    <div class="no_mail">
        ...
        <br>
        <?php echo EMAILINSPAM; ?>
        <a href="activate.php?id=<?php echo $_GET['id']; ?>&amp;c=<?php echo $generator->encodeStr($email, 5); ?>"><?php echo JR_HERE; ?></a>!
    </div>
...
<?php } else { ?>
    ...
    <div id="activation">
        <form action="activate.php" method="post">
            ...
            <input class="text" type="text" name="id" maxlength="10" />
            <button type="submit" value="Request password" name="s2" id="s2" class="green " onclick="document.snd.w.value=screen.width+':'+screen.height;">
                <div class="button-container addHoverClick">
                    <div class="button-background">
                        <div class="buttonStart">
                            <div class="buttonEnd">
