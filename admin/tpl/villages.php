<style>
    .del {
        width: 12px;
        height: 12px;
        background-image: url(images/icon/deleteitems-icon.png);
    }
</style>
...
<table align="center" cellpadding="1" cellspacing="1" border="1" width="650">
    ...
    for ($i = 0; $i <= count($varray) - 1; $i++) {
        ...
        if ($varray[$i]['capital']) {
            $capital = ' - Capital';
            //$delLink = '<a href="#"><img src="/admin/images/admin/del_g.gif" class="del"></a>';
        } else {
            $capital = '';
            if ($_SESSION['access'] == ADMIN) {
                //$delLink = '<a href="?action=delVil&did='.$varray[$i]['wref'].'" onClick="return del(\'did\','.$varray[$i]['wref'].');"><img src="/admin/images/admin/del.gif" class="del"></a>';
        ...
        <td colspan="4">
            <form method="post" action="admin.php">
                ...
                <table id="member" style="width: 225px;" align="center">
                    ...
                    <tr>
                        <td colspan="2">
                            <center>Coordinates (<b>X</b>|<b>Y</b>)</center>
                        </td>
                    </tr>
                    <tr>
                        <td>X:</td>
                        <td>
                            <input name="x" class="fm" value="" type="input" <?php
                                                                                if ($_SESSION['access'] == ADMIN) {
                                                                                    echo '';
                                                                                } else if ($_SESSION['access'] == MULTIHUNTER) {
                    ...
                    <tr>
                        <td>Y:</td>
                        <td>
                            <input name="y" class="fm" value="" type="input" <?php
                                                                                if ($_SESSION['access'] == ADMIN) {
                                                                                    echo '';
                                                                                } else if ($_SESSION['access'] == MULTIHUNTER) {
                                                                                    echo 'disabled="disabled"';
                    ...
                    <tr>
                        <td colspan="2">
                            <center>
                                <input value="Add Village" type="submit" <?php
                                                                            if ($_SESSION['access'] == ADMIN) {
                                                                                echo '';
                                                                            } else if ($_SESSION['access'] == MULTIHUNTER) {
                                                                                echo 'disabled="disabled"';
