<h1 class="titleInHeader"><?php echo B10; ?> <span
...
<div id="build" class="gid10">
    <div class="build_desc">
        <a href="#" onclick="return Travian.Game.iPopup(10,4, 'gid');" class="build_logo">
            <img class="building big white g10" src="/assets/images/x.gif" alt="<?php echo B10; ?>" title="<?php echo B10; ?>">
        </a>
        <?php echo B10_DESC; ?>
    </div>
        ...
        if (!$building->isMax($village->resarray['f' . $id . 't'], $id)) {
            ...
            for ($nc = 1; $nc <= $ll; $nc++) {
                ...
                <tr <?php if ($nc < $nli) echo 'style="color:#F88C1F;"'; ?>>
                    ...
                    <td><b><?php echo $bid10[$village->resarray['f' . $id] + $nc]['attri'] * STORAGE_MULTIPLIER; ?></b>
                    </td>
                </tr>
                <?php
            }
