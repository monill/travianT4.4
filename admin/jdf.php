...
function jdate($type, $maket = "now")
{
    ...
    while ($i < strlen($type)) {
        ...
        switch ($subtype) {
            ...
            case "A":
                $result1 = date("a", $need);
                if ($result1 == "pm") $result .= "afternoon";
                else $result .= "Before noon";
                break;

            case "a":
                $result1 = date("a", $need);
                if ($result1 == "pm") $result .= "P.Z.";
                else $result .= "Am";
                break;
            case "d":
            ...
            case "D":
                $result1 = date("D", $need);
                if ($result1 == "Cs") $result1 = "P";
                else if ($result1 == "Szo") $result1 = "Sh";
                else if ($result1 == "V") $result1 = "Z";
                else if ($result1 == "H") $result1 = "Dr";
                else if ($result1 == "K") $result1 = "s";
                else if ($result1 == "Sze") $result1 = "CH";
                else if ($result1 == "Cs") $result1 = "P";
                else if ($result1 == "P") $result1 = "C";
                $result .= $result1;
                break;
            case"F":
            ...
            case "l":
                $result1 = date("l", $need);
                if ($result1 == "Saturday") $result1 = "Saturday";
                    else if ($result1 == "Sunday") $result1 = "Sunday";
                else if ($result1 == "Monday") $result1 = "Monday";
                else if ($result1 == "Tuesday") $result1 = "Tuesday";
                else if ($result1 == "Wednesday") $result1 = "Wednesday";
                else if ($result1 == "Thursday") $result1 = "Thursday";
                else if ($result1 == "Friday") $result1 = "Friday";
                $result .= $result1;
                break;
            case "m":
