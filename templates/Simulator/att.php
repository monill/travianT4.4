                            ...
                            <table cellpadding="1" cellspacing="1">
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="value">
                                            <input class="text" type="text" name="a_h_fs" value="<?php echo $form->getValue('a_h_fs') == "" ? 0 : $form->getValue('a_h_fs'); ?>" maxlength="6">
                                        </td>
                                        <td class="research"></td>
                                    </tr>
                                    <tr>
                                        <td class="ico">
                                            <img src="/assets/images/x.gif" class="unit uhero" title="<?php echo OB . ' ' . AL_POINTS; ?>">
                                        </td>
                                        <td class="desc"><?php echo OB . ' ' . AL_POINTS; ?></td>
                                        <td class="value">
                                            <input class="text" type="text" name="a_h_ob" value="<?php echo $form->getValue('a_h_ob') == "" ? 0 : $form->getValue('a_h_ob'); ?>" maxlength="6">
                                        </td>
                                        <td class="research"></td>
                                    </tr>
                                </tbody>
                            ...
                            <table cellpadding="1" cellspacing="1">
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="value">
                                            <input class="text" type="text" name="ew1" value="<?php echo $form->getValue('ew1') == "" ? 1 : $form->getValue('ew1'); ?>" maxlength="5">
                                        </td>
                                        <td class="research"></td>
                                    </tr>
                                    <tr>
                                        <td class="ico"><img src="/assets/images/x.gif" class="unit ucata" title="<?php echo WARSIM_CTAR1LVL; ?>"></td>
                                        <td class="desc"><?php echo WARSIM_CTAR1LVL; ?></td>
                                        <td class="value"><input class="text" type="text" name="ctar1" value="<?php echo $form->getValue('ctar1') == "" ? 0 : $form->getValue('ctar1'); ?>" maxlength="2"></td>
                                        <td class="research"></td>
                                    </tr>
                                </tbody>
                            </table>
