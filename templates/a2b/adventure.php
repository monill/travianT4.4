...
<form method="POST" action="build.php">
    ...
    <table class="troop_details" cellpadding="1" cellspacing="1">
        <thead>
            <tr>
                <td class="role">
                    <a href="karte.php?d=<?php echo $village->wid; ?>&c=<?php echo $generator->getMapCheck($_GET['id']); ?>">
                        <?php echo $village->vname; ?>
                    </a>
                </td>
                <td colspan="11">
                    <?php echo HS_ADVENTURE; ?>
        ...
        <tbody class="units">
            <tr>
                ...
                echo "<td><img src=\"/assets/images/x.gif\" class=\"unit uhero\" title=\"" . $technology->getUnitName(51) . "\" alt=\"" . $technology->getUnitName(51) . "\" /></td>";
                ?>
            </tr>
            <tr>
        ...
        <tbody class="infos">
            <tr>
                ...
                <td colspan="11">
                    <img class="clock" src="/assets/images/x.gif" alt="Duration" title="Duration" />
    ...
    if ($village->resarray['f39'] >= 1) {
        if ($herodetail['dead'] == 0) {
            ...
            <?php } else { ?>
                <button type="button" title="<?php echo HS_NOTINVIL; ?>" value="<?php echo HS_NOTINVIL; ?>" class="green build disabled">
                    <div class="button-container addHoverClick">
                        <div class="button-background">
                            <div class="buttonStart">
                                <div class="buttonEnd">
            ...
            <?php } ?>
        <?php } else { ?>
            <button type="button" title="<?php echo HS_HERODEAD; ?>" value="<?php echo HS_HERODEAD; ?>" class="green build disabled">
                <div class="button-container addHoverClick">
                    <div class="button-background">
                        <div class="buttonStart">
                            <div class="buttonEnd">
        ...
        ?>
        <button type="button" title="<?php echo AT_BUILDRALLYPOINTTORAID; ?>" value="<?php echo AT_BUILDRALLYPOINTTORAID; ?>" class="green build disabled">
            <div class="button-container addHoverClick">
                <div class="button-background">
                    <div class="buttonStart">
                        <div class="buttonEnd">
