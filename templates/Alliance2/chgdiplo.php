    ...
    <div class="option diplomacy">
        <table cellpadding="1" cellspacing="1" class="option transparent">
            <tbody>
                ...
                <tr>
                    <td></td>
                    <td><input class="radio" type="radio" id="dipl1" name="dipl" value="1"><label for="dipl1"><?php echo AL_OFFERCONF; ?></label></td>
                </tr>
                <tr>
                    <td></td>
                    <td><input class="radio" type="radio" id="dipl2" name="dipl" value="2"><label for="dipl2"><?php echo AL_OFFERNAP; ?></label></td>
                </tr>
                <tr>
                    <td></td>
                    <td><input class="radio" type="radio" id="dipl3" name="dipl" value="3"><label for="dipl3"><?php echo AL_DECLAREWAR; ?></label></td>
                </tr>
            </tbody>
        </table>
        <p class="option">
    ...
    <tbody>
        ...
        if (count($database->diplomacyOwnOffers($alliance))) {
            foreach ($database->diplomacyOwnOffers($alliance) as $key => $value) {
                ...
                echo "<tr><td class=\"abo\"><form method=\"post\" action=\"allianz.php\"><input type=\"hidden\" name=\"o\" value=\"101\"><input type=\"hidden\" name=\"id\" value=\"" . $value['id'] . "\"><button type=\"submit\" value=\"del\" class=\"icon\"><img src=\"/assets/images/x.gif\" class=\"del\" alt=\"Cancel\"></button></form></td>";
    ...
    <tbody>
        ...
        if (count($database->diplomacyInviteCheck($alliance))) {
            foreach ($database->diplomacyInviteCheck($alliance) as $key => $row) {
                ...
                echo '<td><form method="post" action="allianz.php"><input type="hidden" name="o" value="102"><input type="hidden" name="id" value="' . $row['id'] . '"><input type="hidden" name="alli1" value="' . $row['alli1'] . '"><button type="submit" value="del" class="icon"><img src="/assets/images/x.gif" class="del" alt="Decline"></button></form></td>';
    ...
    <tbody>
        ...
        if (count($database->diplomacyExistingRelationships($alliance))) {
            foreach ($database->diplomacyExistingRelationships($alliance) as $key => $row) {
                ...
                echo '<tr><td class="abo"><form method="post" action="allianz.php"><input type="hidden" name="o" value="104"><input type="hidden" name="id" value="' . $row['id'] . '"><input type="hidden" name="alli2" value="' . $row['alli2'] . '"><button type="submit" value="del" class="icon"><img src="/assets/images/x.gif" class="del" alt="' . AL_CANCEL . '"></button></form></td>';
            ...
            foreach ($database->diplomacyExistingRelationships2($alliance) as $key => $row) {
                ...
                echo '<tr><td class="abo"><form method="post" action="allianz.php"><input type="hidden" name="o" value="104"><input type="hidden" name="id" value="' . $row['id'] . '"><input type="hidden" name="alli2" value="' . $row['alli1'] . '"><button type="submit" value="del" class="icon"><img src="/assets/images/x.gif" class="del" alt="' . AL_CANCEL . '"></button></form></td>';
...
<div class="boxes boxesColor gray infos">
    ...
    <div class="boxes-contents">
        ...
        <div class="text">
            ...
            <span class="e">[war]</span><span class="e">[ally]</span><span class="e">[nap]</span><span class="e">[diplomatie]</span>
        </div>
    </div>
</div>