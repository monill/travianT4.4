<h1 class="titleInHeader"><?php echo sprintf(PL_TRAVIANBANK, 'PLUS'); ?> </font>
</h1>
<div class="contentNavi subNavi">
    ...
    <div title="" class="container <?php if (isset($_GET['id']) && $_GET['id'] == 2) {
        ...
        <div class="background-start">&nbsp;</div>
        <div class="background-end">&nbsp;</div>
        <div class="content"><a href="plus.php?id=2"><span class="tabItem"> <?php echo PL_ADVANTAGES; ?> </span></a>
        </div>
    </div>
