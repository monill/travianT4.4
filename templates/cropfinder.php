            ...
            <table class="transparent">
                <tbody>
                    ...
                    <tr>
                        <td>
                            <span class="type">
                                <input type="radio" class="radio" name="type" value="15" <?php if ($_GET['s'] == 1) {
                                                                                                print 'checked="checked"';
                                                                                            } ?> />15 <?php echo MP_CROPPER; ?>
                            </span>
                            <span class="type">
                                <input type="radio" class="radio" name="type" value="9" <?php if ($_GET['s'] == 2) {
                                                                                            print 'checked="checked"';
                                                                                        } ?> />9 <?php echo MP_CROPPER; ?>
                            </span>
                            <span class="type">
                                <input type="radio" class="radio" name="type" value="both" <?php if ($_GET['s'] == 3) {
                                                                                                print 'checked="checked"';
                                                                                            } ?> /> <?php echo MP_BOTH; ?>
                            </span>
                        </td>
...
if (isset($_GET['s'])) { ?>
    ...
    <table cellpadding="1" cellspacing="1" id="croplist">
        ...
        foreach ($rows as $row) {
            ...
            if ($showCropperOases) echo "<td class=\"oase\"><span><img class='r4' src='/assets/images/x.gif' title='wheat'>" . $oPercent . "%</span></td>";
            if ($row['occupied'] == 0) {
        ...
        if ($page == "1" && $lastPage == "1") {
            $paginationDisplay .= '<img alt="First page" src="/assets/images/x.gif" class="first disabled"> ';
            ...
            $paginationDisplay .= '<img alt="Last page" src="/assets/images/x.gif" class="last disabled">';
        } elseif ($lastPage == 0) {
            $paginationDisplay .= '<img alt="First page" src="/assets/images/x.gif" class="first disabled"> ';
            $paginationDisplay .= '<img alt="Previous page" src="/assets/images/x.gif" class="previous disabled">';
            $paginationDisplay .= $centerPages;
            ...
            $paginationDisplay .= '<img alt="Previous page" src="/assets/images/x.gif" class="previous disabled">';
            $paginationDisplay .= $centerPages;
            $paginationDisplay .= '<a class="next" href="?' . ($_GET['s'] ? 's=' . $_GET['s'] : '') . ($_GET['x'] ? '&x=' . $_GET['x'] : '') . ($_GET['y'] ? '&y=' . $_GET['y'] : '') . '&page=' . $nextPage . '"><img alt="" src="/assets/images/x.gif"></a> ';
            $paginationDisplay .= '<a class="last" href="?' . ($_GET['s'] ? 's=' . $_GET['s'] : '') . ($_GET['x'] ? '&x=' . $_GET['x'] : '') . ($_GET['y'] ? '&y=' . $_GET['y'] : '') . '&page=' . $lastPage . '"><img alt="l" src="/assets/images/x.gif"></a>';
        } elseif ($page != "1" && $page != $lastPage) {
            $paginationDisplay .= '<a class="first" href="?' . ($_GET['s'] ? 's=' . $_GET['s'] : '') . ($_GET['x'] ? '&x=' . $_GET['x'] : '') . ($_GET['y'] ? '&y=' . $_GET['y'] : '') . '&page=1"><img alt="" src="/assets/images/x.gif"></a> ';
            $paginationDisplay .= '<a class="previous" href="?' . ($_GET['s'] ? 's=' . $_GET['s'] : '') . ($_GET['x'] ? '&x=' . $_GET['x'] : '') . ($_GET['y'] ? '&y=' . $_GET['y'] : '') . '&page=' . $previous . '"><img alt="" src="/assets/images/x.gif"></a>';
            $paginationDisplay .= $centerPages;
            $paginationDisplay .= '<a class="next" href="?' . ($_GET['s'] ? 's=' . $_GET['s'] : '') . ($_GET['x'] ? '&x=' . $_GET['x'] : '') . ($_GET['y'] ? '&y=' . $_GET['y'] : '') . '&page=' . $nextPage . '"><img alt="" src="/assets/images/x.gif"></a> ';
            $paginationDisplay .= '<a class="last" href="?' . ($_GET['s'] ? 's=' . $_GET['s'] : '') . ($_GET['x'] ? '&x=' . $_GET['x'] : '') . ($_GET['y'] ? '&y=' . $_GET['y'] : '') . '&page=' . $lastPage . '"><img alt="" src="/assets/images/x.gif"></a>';
        } elseif ($page == $lastPage) {
            $paginationDisplay .= '<a class="first" href="?' . ($_GET['s'] ? 's=' . $_GET['s'] : '') . ($_GET['x'] ? '&x=' . $_GET['x'] : '') . ($_GET['y'] ? '&y=' . $_GET['y'] : '') . '&page=1"><img alt="" src="/assets/images/x.gif"></a> ';
            $paginationDisplay .= '<a class="previous" href="?' . ($_GET['s'] ? 's=' . $_GET['s'] : '') . ($_GET['x'] ? '&x=' . $_GET['x'] : '') . ($_GET['y'] ? '&y=' . $_GET['y'] : '') . '&page=' . $previous . '"><img alt="" src="/assets/images/x.gif"></a>';
            $paginationDisplay .= $centerPages;
            $paginationDisplay .= '<img alt="" src="/assets/images/x.gif" class="next disabled"> ';
            $paginationDisplay .= '<img alt="" src="/assets/images/x.gif" class="last disabled">';
        }
        ?>
    </table>
    <div id="search_navi">
