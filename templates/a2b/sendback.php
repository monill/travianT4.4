...
<form method="POST" name="snd" action="a2b.php">
    <table class="troop_details" cellpadding="1" cellspacing="1">
        <thead>
            <tr>
                <td class="role"><a href="karte.php?d=<?php echo $generator->getBaseID($fromcoor['x'], $fromcoor['y']); ?>&amp;c=<?php echo $generator->getMapCheck($generator->getBaseID($fromcoor['x'], $fromcoor['y'])); ?>"><?php echo $to['name']; ?></a>
                </td>
                <td colspan="<?php echo $colspan; ?>"><a href="spieler.php?uid=<?php echo $to['owner']; ?>"><?php echo $ownername; ?></a></td>
            </tr>
        </thead>
        <tbody class="units">
            <tr>
                ...
                <?php
                for ($i = $start; $i <= $end; $i++) {
                    echo '<td><img src="/assets/images/x.gif" class="unit u' . $i . '" title="' . $technology->unarray[$i] . '" alt="' . $technology->unarray[$i] . '"></td>';
                }
                if ($enforce['hero'] > 0) {
                    echo '<td><img src="/assets/images/x.gif" class="unit uhero" title="' . $technology->unarray[51] . '" alt="' . $technology->unarray[51] . '"></td>';
                }
                ?>
            </tr>
            <tr>
        ...
        <tbody class="infos">
            <tr>
                ...
                <td colspan="<?php echo $colspan; ?>">
                    ...
                    <div class="at"><?php echo AT_AT . ' '; ?><span id="tp2"><?php echo date("H:i:s", time() + $time) ?></span><span></span></div>
                    <div class="clear"></div>
                </td>
            </tr>
        </tbody>
    ...
    <p class="button">
        <button type="submit" value="ok" name="s1" id="btn_ok" class="green " onclick="if (this.disabled==false) {document.getElementsByTagName('form')[0].submit();} this.disabled=true;">
