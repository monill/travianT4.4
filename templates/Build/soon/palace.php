...
<div class="build_desc">
    <a href="#" onclick="return Travian.Game.iPopup(26,4);" class="build_logo">
        <img class="building big white g26" src="/assets/images/x.gif" alt="<?php echo B26; ?>">
    </a>
...
<div id="contract" class="contract contractNew contractWrapper">
    ...
    <a href="#"
       onclick="return Travian.Game.iPopup(18,4, 'gid');"><?php echo B18; ?></a> <span><?php echo BL_LVL; ?> 1</span></span>,
        ...
        <span class="buildingCondition"><a href="#"
                                           onclick="return Travian.Game.iPopup(25,4, 'gid');"><strike><?php echo B25; ?></strike></a></span>
    </div>
    <div class="clear"></div>
</div>
<div class="clear"></div>
