...
function medals()
{
    ...
    $time = time();
    $giveMedal = false;
    $q = "SELECT `lastgavemedal`,`medalinterval` FROM config";
    ...
    if ($giveMedal) {
        ...
        $q = "SELECT `week` FROM medal order by week DESC LIMIT 0, 1";
        $result = mysql_query($q);
        ...
        $q = "SELECT `week` FROM allimedal order by week DESC LIMIT 0, 1";
        $result = mysql_query($q);
        if (mysql_num_rows($result)) {
            $row = mysql_fetch_assoc($result);
            $allyweek = ($row['week'] + 1);
        ...
        //Aanvallers v/d Week
        $result = mysql_query("SELECT `id`,`ap` FROM users WHERE id > 3 ORDER BY ap DESC Limit 10");
        $i = 0;
        ...
        //Verdediger v/d Week
        $result = mysql_query("SELECT `id`,`dp` FROM users WHERE id > 3 ORDER BY dp DESC Limit 10");
        $i = 0;
        while ($row = mysql_fetch_array($result)) {
            $i++;
            $img = "t3_" . ($i) . "";
        ...
        while ($row = mysql_fetch_array($result)) {
            $i++;
            $img = "t1_" . ($i) . "";
            $quer = "insert into medal(userid, categorie, plaats, week, points, img) values('" . $row['userid'] . "', '10', '" . ($i) . "', '" . $week . "', '" . $row['top10popchange'] . "', '" . $img . "')";
            $resul = mysql_query($quer);
        }
        //Overvallers v/d Week
        $result = mysql_query("SELECT `id`,`RR` FROM users WHERE id > 3 ORDER BY RR DESC Limit 10");
        $i = 0;
        while ($row = mysql_fetch_array($result)) {
            $i++;
            $img = "t4_" . ($i) . "";
        ...
        $result = mysql_query("SELECT `id` FROM users WHERE id > 3 ORDER BY ap DESC Limit 10");
        while ($row = mysql_fetch_array($result)) {
            //Pak de top10 verdedigers
            $result2 = mysql_query("SELECT `id` FROM users WHERE id > 3 ORDER BY dp DESC Limit 10");
        ...
        $result = mysql_query("SELECT `id` FROM users WHERE id > 3 ORDER BY ap DESC Limit 10");
        while ($row = mysql_fetch_array($result)) {
            $query1 = "SELECT count(`id`) FROM medal WHERE userid='" . $row['id'] . "' AND categorie = 1 AND plaats<=3";
        ...
        $result = mysql_query("SELECT `id` FROM users WHERE id > 3 ORDER BY ap DESC Limit 10");
        while ($row = mysql_fetch_array($result)) {
            $query1 = "SELECT count(`id`) FROM medal WHERE userid='" . $row['id'] . "' AND categorie = 1 AND plaats<=10";
            $result1 = mysql_query($query1);
            $row1 = mysql_fetch_row($result1);
            //2x in gestaan, dit is 3e dus lintje (brons)
            if ($row1[0] == '3') {
        ...
        //Pak de top10 verdedigers
        $result = mysql_query("SELECT `id` FROM users WHERE id > 3 ORDER BY dp DESC Limit 10");
        while ($row = mysql_fetch_array($result)) {
            $query1 = "SELECT count(`id`) FROM medal WHERE userid='" . $row['id'] . "' AND categorie = 2 AND plaats<=3";
            $result1 = mysql_query($query1);
            $row1 = mysql_fetch_row($result1);
            //2x in gestaan, dit is 3e dus lintje (brons)
            if ($row1[0] == '3') {
        ...
        $result = mysql_query("SELECT `id` FROM users WHERE id > 3 ORDER BY dp DESC Limit 10");
        while ($row = mysql_fetch_array($result)) {
            $query1 = "SELECT count(`id`) FROM medal WHERE userid='" . $row['id'] . "' AND categorie = 2 AND plaats<=10";
            $result1 = mysql_query($query1);
            $row1 = mysql_fetch_row($result1);
            //2x in gestaan, dit is 3e dus lintje (brons)
            if ($row1[0] == '3') {
        ...
        // you are in the top 3 climbers for 3rd / 5th / 10th time
        // Grab the top10 climbers
        $result = mysql_query("SELECT `id` FROM users WHERE id > 3 ORDER BY Rc DESC Limit 10");
        while ($row = mysql_fetch_array($result)) {
            $query1 = "SELECT count(`id`) FROM medal WHERE userid='" . $row['id'] . "' AND categorie = 3 AND plaats<=3";
            $result1 = mysql_query($query1);
            $row1 = mysql_fetch_row($result1);
            // 2x stood in, this is 3rd so ribbon (bronze)
            if ($row1[0] == '3') {
                $img = "t100_1";
                $quer = "insert into medal(userid, categorie, plaats, week, points, img) values('" . $row['id'] . "', '8', '0', '" . $week . "', 'Three', '" . $img . "')";
                $resul = mysql_query($quer);
            }
            // 4x stood, this is 5th so ribbon (silver)
            if ($row1[0] == '5') {
                $img = "t101_1";
                $quer = "insert into medal(userid, categorie, plaats, week, points, img) values('" . $row['id'] . "', '8', '0', '" . $week . "', 'Five', '" . $img . "')";
                $resul = mysql_query($quer);
            }
            // 9 times, this is 10th so ribbon (gold)
            if ($row1[0] == '10') {
                $img = "t102_1";
        ...
        $result = mysql_query("SELECT `id` FROM users WHERE id > 3 ORDER BY Rc DESC Limit 10");
        while ($row = mysql_fetch_array($result)) {
            $query1 = "SELECT count(`id`) FROM medal WHERE userid='" . $row['id'] . "' AND categorie = 3 AND plaats<=10";
            $result1 = mysql_query($query1);
            $row1 = mysql_fetch_row($result1);
            //2x in gestaan, dit is 3e dus lintje (brons)
            if ($row1[0] == '3') {
        ...
        $result = $ranking->procUsersTop10PopRank(' Limit 10 ');
        while ($row = mysql_fetch_array($result)) {
            $query1 = "SELECT count(*) FROM medal WHERE userid='" . $row['userid'] . "' AND categorie = 10 AND plaats<=3";
            $result1 = mysql_query($query1);
            $row1 = mysql_fetch_row($result1);
            //2x in gestaan, dit is 3e dus lintje (brons)
            if ($row1[0] == '3') {
                $img = "t200_1";
                $quer = "insert into medal(userid, categorie, plaats, week, points, img) values('" . $row['userid'] . "', '11', '0', '" . $week . "', 'Three', '" . $img . "')";
                $resul = mysql_query($quer);
            }
            //4x in gestaan, dit is 5e dus lintje (zilver)
            if ($row1[0] == '5') {
                $img = "t201_1";
                $quer = "insert into medal(userid, categorie, plaats, week, points, img) values('" . $row['userid'] . "', '11', '0', '" . $week . "', 'Five', '" . $img . "')";
                $resul = mysql_query($quer);
            }
            //9x in gestaan, dit is 10e dus lintje (goud)
            if ($row1[0] == '10') {
                $img = "t202_1";
                $quer = "insert into medal(userid, categorie, plaats, week, points, img) values('" . $row['userid'] . "', '11', '0', '" . $week . "', 'Ten', '" . $img . "')";
                $resul = mysql_query($quer);
            }
        }
        ...
        $result = $ranking->procUsersTop10PopRank(' Limit 10 ');
        while ($row = mysql_fetch_array($result)) {
            $query1 = "SELECT count(`id`) FROM medal WHERE userid='" . $row['userid'] . "' AND categorie = 10 AND plaats<=10";
            $result1 = mysql_query($query1);
            $row1 = mysql_fetch_row($result1);
            //2x in gestaan, dit is 3e dus lintje (brons)
            if ($row1[0] == '3') {
                $img = "t210_1";
                $quer = "insert into medal(userid, categorie, plaats, week, points, img) values('" . $row['userid'] . "', '16', '0', '" . $week . "', 'Three', '" . $img . "')";
                $resul = mysql_query($quer);
            }
            //4x in gestaan, dit is 5e dus lintje (zilver)
            if ($row1[0] == '5') {
                $img = "t211_1";
                $quer = "insert into medal(userid, categorie, plaats, week, points, img) values('" . $row['userid'] . "', '16', '0', '" . $week . "', 'Five', '" . $img . "')";
                $resul = mysql_query($quer);
            }
            //9x in gestaan, dit is 10e dus lintje (goud)
            if ($row1[0] == '10') {
                $img = "t212_1";
                $quer = "insert into medal(userid, categorie, plaats, week, points, img) values('" . $row['userid'] . "', '16', '0', '" . $week . "', 'Ten', '" . $img . "')";
                $resul = mysql_query($quer);
            }
        }
        ...
        $result = mysql_query("SELECT `id` FROM users WHERE id > 3 ORDER BY RR DESC Limit 10");
        while ($row = mysql_fetch_array($result)) {
            $query1 = "SELECT count(`id`) FROM medal WHERE userid='" . $row['id'] . "' AND categorie = 4 AND plaats<=3";
            $result1 = mysql_query($query1);
            $row1 = mysql_fetch_row($result1);
            //2x in gestaan, dit is 3e dus lintje (brons)
            if ($row1[0] == '3') {
        ...
        $result = mysql_query("SELECT `id` FROM users WHERE id > 3 ORDER BY RR DESC Limit 10");
        while ($row = mysql_fetch_array($result)) {
            $query1 = "SELECT count(`id`) FROM medal WHERE userid='" . $row['id'] . "' AND categorie = 4 AND plaats<=10";
            $result1 = mysql_query($query1);
            $row1 = mysql_fetch_row($result1);
            //2x in gestaan, dit is 3e dus lintje (brons)
            if ($row1[0] == '3') {
        ...
        while ($row = mysql_fetch_array($result)) {
            $q = "UPDATE users SET ap=0, dp=0,Rc=0,clp=0, RR=0, oldrank=" . $row['totalpop'] . " WHERE id = " . $row['userid'];
            mysql_query($q);
        }

        //Start alliance Medals wooot
        //Attackers of the Week
        $result = mysql_query("SELECT `id`,`ap` FROM alidata ORDER BY ap DESC Limit 10");
        $i = 0;
        while ($row = mysql_fetch_array($result)) {
            $i++;
            $img = "a2_" . ($i) . "";
        ...
        //Verdediger v/d Week
        $result = mysql_query("SELECT `id`,`Dp` FROM alidata ORDER BY dp DESC Limit 10");
        $i = 0;
        while ($row = mysql_fetch_array($result)) {
            $i++;
            $img = "a3_" . ($i) . "";
        ...
        //Overvallers v/d Week
        $result = mysql_query("SELECT `id`,`RR` FROM alidata ORDER BY RR DESC Limit 10");
        $i = 0;
        while ($row = mysql_fetch_array($result)) {
            $i++;
            $img = "a4_" . ($i) . "";
        ...
        while ($row = mysql_fetch_array($result)) {
            $i++;
            $img = "a1_" . ($i) . "";
            $quer = "insert into allimedal(allyid, categorie, plaats, week, points, img) values('" . $row['id'] . "', '3', '" . ($i) . "', '" . $allyweek . "', '" . $row['top10popchange'] . "', '" . $img . "')";
            $resul = mysql_query($quer);
        }

        $result = $ranking->procAllianceRanking();
        for ($i = 0; $row = mysql_fetch_array($result); $i++) {
            $q = "UPDATE alidata SET ap=0, dp=0, RR=0, clp=0, oldrank=" . $row['totalpop'] . " WHERE id = " . $row['id'];
            mysql_query($q);
        }
