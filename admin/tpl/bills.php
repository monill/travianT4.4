...
$lastPage = ceil($queryCount / $itemsPerPage); // Number of items to display per page
?>
...
<table id="member" border="1" cellpadding="3" align="center" dir="ltr">
    ...
    if ($page == "1" && $lastPage == "1") {
        ...
        $paginationDisplay .= '<img alt="previous page" src="/assets/images/x.gif" class="previous disabled">';
        $paginationDisplay .= $centerPages;
        $paginationDisplay .= '<a class="next" href="index.php?p=bills&page=' . $nextPage . '"><img alt="next page" src="/assets/images/x.gif"></a> ';
        $paginationDisplay .= '<a class="last" href="index.php?p=bills&page=' . $lastPage . '"><img alt="The last page" src="/assets/images/x.gif"></a>';
    } elseif ($page != "1" && $page != $lastPage) {
        $paginationDisplay .= '<a class="first" href="index.php?p=bills&page=1"><img alt="Front Page" src="/assets/images/x.gif"></a> ';
        $paginationDisplay .= '<a class="previous" href="index.php?p=bills&page=' . $previous . '"><img alt="previous page" src="/assets/images/x.gif"></a>';
        $paginationDisplay .= $centerPages;
        $paginationDisplay .= '<a class="next" href="index.php?p=bills&page=' . $nextPage . '"><img alt="next page" src="/assets/images/x.gif"></a> ';
        $paginationDisplay .= '<a class="last" href="index.php?p=bills&page=' . $lastPage . '"><img alt="The last page" src="/assets/images/x.gif"></a>';
    ...
    if ($queryCount > 0) {
        ...
        echo '<tr><td colspan="10" align="center">No players registered</td></tr>';
    }
