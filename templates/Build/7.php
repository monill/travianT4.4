<h1 class="titleInHeader"><?php echo B7; ?> <span
...
<div id="build" class="gid7">
    <div class="build_desc">
        <a href="#" onClick="return Travian.Game.iPopup(7,4);" class="build_logo">
            <img class="building big white g7" src="/assets/images/x.gif" alt="<?php echo B7; ?>" title="<?php echo B7; ?>"/>
        </a>
    ...
    <table cellpadding="1" cellspacing="1" id="build_value">
        <tr>
            ...
            <td>
                <b><?php echo $bid7[$village->resarray['f' . $id]]['attri'] ? $bid7[$village->resarray['f' . $id]]['attri'] : '0'; ?></b>%
            </td>
        </tr>
        <?php
