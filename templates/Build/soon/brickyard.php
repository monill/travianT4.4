...
<div class="build_desc">
    <a href="#" onclick="return Travian.Game.iPopup(6,4);" class="build_logo">
        <img class="building big white g6" src="/assets/images/x.gif" alt="<?php echo B6; ?>">
    </a>
...
<div id="contract" class="contract contractNew contractWrapper">
    ...
    <a href="#"
       onclick="return Travian.Game.iPopup(3,4, 'gid');"><?php echo B3; ?></a> <span><?php echo BL_LVL; ?> 10</span></span>,
