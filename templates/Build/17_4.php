    ...
    <table id="npc" cellpadding="1" cellspacing="1">
        ...
        if (count($routes) == 0) {
            ...
            foreach ($routes as $route) {
                ...
                <tr>
                    <th>
                        <a href="build.php?action=delRoute&routeid=<?php echo $route['id']; ?>">
                            <img class="del" src="/assets/images/x.gif" alt="<?php echo MK_DELETE; ?>" title="<?php echo MK_DELETE; ?>">
                        </a>
                    </th>
                    <th>
                        <?php
                        ...
                        ?>
                        <img src="/assets/images/r/1.gif" alt="wood"
                             title="wood"> <?php echo $route['wood']; ?> <img
                                src="/assets/images/r/2.gif" alt="clay"
                                title="clay"> <?php echo $route['clay']; ?> <img
                                src="/assets/images/r/3.gif" alt="iron"
                                title="iron"> <?php echo $route['iron']; ?> <img
                                src="/assets/images/r/4.gif" alt="crop"
                    ...
                    <th>
                        <a href="build.php?id=<?php echo $id; ?>&t=4&action=editRoute&routeid=<?php echo $route['id']; ?>">»<?php echo MK_EDIT; ?></a>
                    </th>
                </tr>
            <?php }
        } ?>
            ...
            if ($('button5300d0c553036')) {
                $('button5300d0c553036').addEvent('click', function () {
                    window.fireEvent('buttonClicked', [this, {
                        ...
                        "value": "Gold club",
                        "name": "",
                        "id": "button5300d0c553036",
                        "class": "gold builder",
                        "title": "<?php echo MK_EVASIONDESC;?>",
                        "confirm": "",
                        "onclick": "",
                        "goldclubDialog": {
                            "featureKey": "troopEscape",
                            "infoIcon": "http:\/\/t4.answers.travian.ir\/index.php?aid=Travian Answers#go2answer"
                        }
                    }]);
                });
            }
