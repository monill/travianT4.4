...
<form action="activate.php" method="post">
    ...
    <div class="boxes activation boxesColor gray">
    ...
    <div class="clear"></div>
    <button type="submit" value="delete" name="delreports" id="btn_delete" onclick="document.snd.w.value=screen.width+':'+screen.height;">
