...
?>
<h4><a href="allianz.php?s=2&pid=<?php echo $arr['alliance']; ?>"><?php AL_ALLIANCE; ?></a> <a class="arrowForum" href="allianz.php?s=2&pid=<?php echo $arr['alliance']; ?>&fid=<?php echo $arr['cat']; ?>"><?php echo $CatName; ?></a>
</h4>
...
<table cellpadding="1" cellspacing="1" id="posts">
    ...
    <tbody>
        <tr>
            <td class="pinfo"><a class="name" href="spieler.php?uid=<?php echo $arr['owner']; ?>"><?php echo $owner['username']; ?></a><br /><a href="allianz.php?aid=<?php echo $allianceinfo['id']; ?>"><?php echo $allianceinfo['tag']; ?></a><br />
            ...
            <td class="pcontent">
                ...
                if ($database->CheckEditRes($aid) == "1") {
                    echo '<div class="admin"><a class="edit" href="allianz.php?s=2&pid=' . $arr['alliance'] . '&idf=' . $arr['cat'] . '&idt=' . $arr['id'] . '&admin=editans"><img src="/assets/images/x.gif" title="ویرایش" alt="ویرایش" /></a><a class="fdel" href="?s=2&pid=' . $arr['alliance'] . '&tid=' . $arr['id'] . '&admin=deltopic" onClick="return confirm(\'آیا مطمئن هستی؟\');"><img src="/assets/images/x.gif" title="حذف" alt="حذف" /></a></div><br />';
                }
                ?>
		...
		<td class="pcontent"><div class="posted">ساخته شده در: ' . $date . '</div>';
            if ($database->CheckEditRes($aid) == "1") {
                echo '<div class="admin"><a class="edit" href="allianz.php?s=2&pid=' . $arr['alliance'] . '&idt=' . $_GET['tid'] . '&pod=' . $po['id'] . '&admin=editpost"><img src="/assets/images/x.gif" title="ویرایش" alt="ویرایش" /></a><a class="fdel" href="?s=2&pid=' . $arr['alliance'] . '&pod=' . $po['id'] . '&tid=' . $_GET['tid'] . '&admin=delpost" onClick="return confirm(\'آیا مطمئن هستی؟\');"><img src="/assets/images/x.gif" title="حذف" alt="حذف" /></a></div><br />';
            }
