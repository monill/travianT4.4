...
<form method="POST" action="build.php">
    ...
    <table class="troop_details" cellpadding="1" cellspacing="1">
        <thead>
            <tr>
                <td class="role">
                    <a href="karte.php?d=<?php echo $village->wid; ?>&c=<?php echo $generator->getMapCheck($village->wid); ?>">
                        <?php echo $database->getUserField($session->uid, 'username', 0); ?>
                    </a>
                </td>
                <td colspan="10">
                    <a href="karte.php?d=<?php echo $newvillage['id']; ?>&c=<?php echo $generator->getMapCheck($newvillage['0']) ?>">
                        <?php echo AT_NEWVILLAGE; ?>
                        (<?php echo $newvillage['x']; ?>|<?php echo $newvillage['y']; ?>)
                    </a>
                </td>
            </tr>
        </thead>
        ...
        <tbody class="infos">
            <tr>
                ...
                <td colspan="10">
                    <img class="clock" src="/assets/images/x.gif" alt="<?php echo AT_DURATION; ?>" title="<?php echo AT_DURATION; ?>" />
        ...
        <tbody class="infos">
            <tr>
                ...
                <td colspan="10">
                    <img class="r1" src="/assets/images/x.gif" alt="<?php echo VL_WOOD; ?>" title="<?php echo VL_WOOD; ?>" /> 750 |
                    <img class="r2" src="/assets/images/x.gif" alt="<?php echo VL_CLAY; ?>" title="<?php echo VL_CLAY; ?>" /> 750 |
                    <img class="r3" src="/assets/images/x.gif" alt="<?php echo VL_IRON; ?>" title="<?php echo VL_IRON; ?>" /> 750 |
                    <img class="r4" src="/assets/images/x.gif" alt="<?php echo VL_CROP; ?>" title="<?php echo VL_CROP; ?>" /> 750
                </td>
            </tr>
        </tbody>
    </table>
