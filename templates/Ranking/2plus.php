...
<div class='graph' style="background-image:url('stats.php?form=2');">
    <div class='legende'>
        ...
        <div class='box' style='background-color:#0061FF;'></div><?php echo AT_REINFORCEMENT; ?>
    </div>
</div>
...
<div class='graph' style="background-image:url('stats.php?form=3');">
    <div class='legende'>
        ...
        <div class='box' style='background-color:#FFDF00;'></div><?php echo PF_INHABITANTS; ?>
    </div>
</div>
...
<div class='graph' style="background-image:url('stats.php?form=1');">
    <div class='legende'>
        ...
        <div class='box' style='background-color:#FF0000;'></div><?php echo MV_ATTACK; ?>
    </div>
</div>