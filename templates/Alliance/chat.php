...
<body onload="start_it()">
    <form name="form1" onSubmit="send_data()" action="allianz.php?s=6" method="POST" id="Form1">
        <div id="TitleName" class="chatHeader">
            ...
            <div style="text-align: center">Ally-Chat</div>
        </div>
        <div id="chatContainer" style="position: relative; top: 0px; left: 0px; height: 260px; overflow-x: hidden; overflow-y: hidden; background-color: rgb(255, 255, 255); border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px; border-top-style: solid; border-right-style: solid; border-bottom-style: solid; border-left-style: solid; border-top-color: rgb(192, 192, 192); border-right-color: rgb(192, 192, 192); border-bottom-color: rgb(192, 192, 192); border-left-color: rgb(192, 192, 192); display: block; ">
            <span dir="ltr">
                <div id="chat" style="position:absolute; top:10px; right:5px; width:530px; background-color: #FFF;text-align:left; ">
                    <center><img src="/assets/images/loadingshetab.gif" style="position: absolute;top: 100px;left:245px;">
                </div>
                <div id="scrollbarbackground2" style="position: absolute; top: 0; left: 531px; width: 17px; height: 238px;"></div>
                <div id="scrollbarbackground" style="position: absolute; top: 0; left: 539px; width: 1px; height: 238px; border-width: 1px; border-style: solid; border-color: #71D000; background-color: #FFF;">
                </div>
                <div id="scrollbar" style="position: absolute; left: 531px; width: 17px; border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px; border-top-style: solid; border-right-style: solid; border-bottom-style: solid; border-left-style: solid; border-top-color: rgb(113, 208, 0); border-right-color: rgb(113, 208, 0); border-bottom-color: rgb(113, 208, 0); border-left-color: rgb(113, 208, 0); background-color: rgb(240, 255, 240); height: 238px; top: 0px; ">
                </div>
                <input id="scrollCheckbox" class="fm" checked="checked" disabled type="checkbox" style="position: absolute; top: 240px; left: 531px;">
        </div>
            ...
            <table cellpadding="1" cellspacing="1" id="chat_input">
                <tr>
                    <td>
                        ...
                        <input type="button" src="x.gif" id="btn_ok" style="border: 0px; float:left; height:0px; width:0px;" alt="ok" onClick="send_data()" />
                    </td>
...
<div id="rooms">
    <span id="room429280664" name="-2" class="roomselectorActive">
        <span style="float:left;">
            <a href="" onclick="submitform2()">
                <span id="channelName429280664">Ally-Chat</span>
            </a>
        </span>
        <span id="userCount429280664" style="float:left;"></span></span>
</div>
