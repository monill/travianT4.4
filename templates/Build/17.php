    ...
    if (isset($_POST['ft']) == 'check' && $allres != 0 && $allres <= $market->maxcarry * $market->merchantAvail() && $checkexist){
        ...
        <form method="POST" name="snd" action="build.php">
            ...
            <table id="send_select" class="send_res" cellpadding="1" cellspacing="1">
                <tr>
                    <td class="ico"><img class="r1" src="/assets/images/x.gif" alt="<?php echo VL_LUMBER; ?>"
                ...
                <tr>
                    <td class="ico"><img class="r2" src="/assets/images/x.gif" alt="<?php echo VL_CLAY; ?>"
                ...
                <tr>
                    <td class="ico"><img class="r3" src="/assets/images/x.gif" alt="<?php echo VL_IRON; ?>"
                ...
                <tr>
                    <td class="ico"><img class="r4" src="/assets/images/x.gif" alt="<?php echo VL_CROP; ?>"
    ...
    <form method="POST" name="snd" action="build.php">
        ...
        <table id="send_select" class="send_res" cellpadding="1" cellspacing="1">
            ...
            <tr>
                ...
                <td class="ico">
                    <a href="#" onMouseUp="add_res(1);" onClick="return Lumberlse;"><img class="r1" src="/assets/images/x.gif"
                                ...
                                <div class="coordinatesInput">
                                    <div class="xCoord">
                                        ...
                                        <input class="text coordinates x " type="text" name="x" id="xCoordInput"
                                               ...
                                               onkeypress="$('enterVillageName').value=''">
                                    </div>
                                    <div class="yCoord">
    ...
    <p>
        ...
        if (count($market->recieving) > 0) {
            ...
            foreach ($market->recieving as $recieve) {
                ...
                echo "<img class=\"r1\" src=\"/assets/images/x.gif\" alt=\"Lumber\" title=\"" . VL_LUMBER . "\" /> " . $recieve['wood'] . " <img class=\"r2\" src=\"/assets/images/x.gif\" alt=\"Clay\" title=\"" . VL_CLAY . "\" /> " . $recieve['clay'] . " <img class=\"r3\" src=\"/assets/images/x.gif\" alt=\"Iron\" title=\"" . VL_IRON . "\" /> " . $recieve['iron'] . " <img class=\"r4\" src=\"/assets/images/x.gif\" alt=\"Crop\" title=\"" . VL_CROP . "\" /> " . $recieve['crop'] . "</td></tr></tbody>";
                echo "</table>";
                $timer += 1;
            }
        }
        if (count($market->sending) > 0) {
            ...
            foreach ($market->sending as $send) {
                ...
                echo "<img class=\"r1\" src=\"/assets/images/x.gif\" alt=\"Lumber\" title=\"" . VL_LUMBER . "\" /> " . $send['wood'] . " <img class=\"r2\" src=\"/assets/images/x.gif\" alt=\"Clay\" title=\"" . VL_CLAY . "\" /> " . $send['clay'] . " <img class=\"r3\" src=\"/assets/images/x.gif\" alt=\"Iron\" title=\"" . VL_IRON . "\" /> " . $send['iron'] . " <img class=\"r4\" src=\"/assets/images/x.gif\" alt=\"Crop\" title=\"" . VL_CROP . "\" /> " . $send['crop'] . "</td></tr></tbody>";
                echo "</table>";
                $timer += 1;
            }
        }
        if (count($market->return) > 0) {
            ...
            foreach ($market->return as $return) {
                ...
                echo $datetime[1] . "</div>";
                echo "</td> </tr> <tr class=\"res\"> <th>" . VL_RESOURCE . "</th><td>";
                echo "<img class=\"r1\" src=\"/assets/images/x.gif\" alt=\"Lumber\" title=\"" . VL_LUMBER . "\" />" . $return['wood'] . " | <img class=\"r2\" src=\"/assets/images/x.gif\" alt=\"Clay\" title=\"" . VL_CLAY . "\" />" . $return['clay'] . " | <img class=\"r3\" src=\"/assets/images/x.gif\" alt=\"Iron\" title=\"" . VL_IRON . "\" />" . $return['iron'] . " | <img class=\"r4\" src=\"/assets/images/x.gif\" alt=\"Crop\" title=\"" . VL_CROP . "\" />" . $return['crop'] . "</td></tr></tbody>";
                echo "</tbody></table>";
                $timer += 1;
            }
        }
