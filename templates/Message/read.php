                    ...
                    <div class="toolList">
                        ...
                        <div id="deleteMessage">
                            <form method="post" action="nachrichten.php">
                                ...
                                ?>
                                        <a href="#" id="reportSpam" class="a arrow" onclick='Travian.Game.ReportSpamMessagesDialog.reportSpam(
                                                   "<?php echo $_GET['id']; ?>",
                                ...
                                ?>
                                <button type="submit" name="delmsg" title="<?php echo AL_DELETE; ?>" id="delmsg" class="icon hover" onclick="return (function(){
                                        ...
                                        return false;
                                        })()"><img src="/assets/images/x.gif" class="Delete delete" alt="Delete"></button>
