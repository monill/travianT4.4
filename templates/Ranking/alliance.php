...
if (isset($_POST['name']) && $_POST['name'] != '') {
    ...
    $myrank = $ranking->getAllianceRank($mydata['id']);
    ...
    $myrank = $_POST['rank'];
    $mr = $ranking->procAllianceRanking();
    $i = 0;
...
<div class="contentNavi tabNavi">
    ...
    <div class="container normal">
        <div class="background-start">&nbsp;</div>
        <div class="background-end">&nbsp;</div>
        <div class="content"><a href="statistiken.php?tid=41"><span class="tabItem"><?php echo REPORT_ATTACKER; ?></span></a></div>
    </div>
    <div class="container normal">
        <div class="background-start">&nbsp;</div>
        <div class="background-end">&nbsp;</div>
        <div class="content"><a href="statistiken.php?tid=42"><span class="tabItem"><?php echo REPORT_DEFENDER; ?></span></a></div>
    </div>
    <div class="container normal">
        <div class="background-start">&nbsp;</div>
        <div class="background-end">&nbsp;</div>
...
<h4 class="round"><?php echo AL_ALLIANCE; ?></h4>
...
<table cellpadding="1" cellspacing="1" id="alliance" class="row_table_data">
    ...
    <tbody>
        ...
        if ($page == "1" && $lastPage == "1") {
            ...
            $paginationDisplay .= '<img alt="' . PREVPAGE . '" src="/assets/images/x.gif" class="previous disabled">';
            $paginationDisplay .= $centerPages;
            $paginationDisplay .= '<a class="next" href="?tid=4&page=' . $nextPage . '"><img alt="' . NEXTPAGE . '" src="/assets/images/x.gif"></a> ';
            $paginationDisplay .= '<a class="last" href="?tid=4&page=' . $lastPage . '"><img alt="' . LASTPAGE . '" src="/assets/images/x.gif"></a>';
        } elseif ($page != "1" && $page != $lastPage) {
            $paginationDisplay .= '<a class="first" href="?tid=4&page=1"><img alt="' . FIRSTPAGE . '" src="/assets/images/x.gif"></a> ';
            $paginationDisplay .= '<a class="previous" href="?tid=4&page=' . $previous . '"><img alt="' . PREVPAGE . '" src="/assets/images/x.gif"></a>';
            $paginationDisplay .= $centerPages;
            $paginationDisplay .= '<a class="next" href="?tid=4&page=' . $nextPage . '"><img alt="' . NEXTPAGE . '" src="/assets/images/x.gif"></a> ';
            $paginationDisplay .= '<a class="last" href="?tid=4&page=' . $lastPage . '"><img alt="' . LASTPAGE . '" src="/assets/images/x.gif"></a>';
        ...
        $ar = $ranking->procAllianceRanking($limit);
        ...
        if ($ar) {
            while ($row = mysql_fetch_array($ar)) {
                if ($row['memcount'] > 0) {
                    ...
                    echo "<td class=\"av \">" . round(($row['totalpop']) / $row['memcount']) . "</td>";
            ...
            <div class="boxes-contents w292">
                <table class="transparent">
                    <tbody>
                        <tr>
                            <td>
                                <span><?php echo AL_RANK; ?>: <input type="text" class="text ra" maxlength="5" name="rank" value="" /></span>
                            </td>
                            <td>
                                <span><?php echo AL_NAME; ?>: <input type="text" class="text name" maxlength="20" name="name" value="" /></span>
                            </td>
                            <td>
                                ...
                                <button type="submit" value="submit" name="submit" id="btn_ok" class="green ">
                                    <div class="button-container addHoverClick">
                                        ...
                                        <div class="button-content"><?php echo PF_SEARCH; ?></div>
                                    </div>
                                </button>
                            </td>
                        </tr>
