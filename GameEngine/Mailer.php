...
class Mailer
{
    ...
    {
        $message = '<div class="body undoreset">Hello ' . $username . ',<br><br>Thank you for registering your Travian account!<br><br>You signed up for Travian world com1. To activate your account please click the<br>following link:<br><br><a rel="nofollow" target="_blank" href="' . HOMEPAGE . '/?code=' . $act . '&sv=' . $server . '#activation">' . HOMEPAGE . '/?code=' . $act . '&sv=' . $server . '#activation</a><br><br>---------------------------------------------------------------------------------------------------------------------------------<br><br>Your access data:<br><br>Player name:&nbsp; ' . $username . '<br>Email address: <a ymailto="mailto:' . $email . '" href="mailto:' . $email . '">' . $email . '</a><br>Password: ' . $pass . '<br>Game world: ' . $server . '<br><br>Activation code: ' . $act . '<br>Server Link: ' . HOMEPAGE . '/' . $server . '<br><br>---------------------------------------------------------------------------------------------------------------------------------<br><br>Game hints:<br>In our Travian Answers <a href="# " target="_blank"># </a>you will find answers for<br>many questions concerning Travian. You may also visit our forums at<br><a href="#" target="_blank">travian</a>for relevant news and to communicate with other<br>players.<br><br>Have a good time and many glorious battles.<br><br>Your Travian Team<br><br>Impressum:<br>Travian Games GmbH, Wilhelm-Wagenfeld-Str. 22, 80807 M�nchen, Deutschland<br>Tel: +49 (0)89 3249150, Fax: +49 (0)89 324915970, www.traviangames.de<br>CEO: Siegfried M�ller<br>commercial court: Amtsgericht M�nchen, HRB 173511, <br>tax number: DE 246258085<br><br></div>';
