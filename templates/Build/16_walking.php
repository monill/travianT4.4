    ...
    if ($total_for > 0) {
        foreach ($units as $tu) {
            ...
            <table class="troop_details <?php echo $style; ?>" cellpadding="1" cellspacing="1">
                ...
                echo "<td><img src=\"/assets/images/x.gif\" class=\"unit uhero\" title=\"" . $technology->getUnitName(51) . "\" alt=\"" . $technology->getUnitName(51) . "\" /></td></tr>";
                        ...
                        if ((time() - $tu['starttime']) <= (max(20, floor(90 / pow(INCREASE_SPEED, 1 / 3))))) {
                            ...
                            <div class="abort"><a
                                        href="build.php?id=39&a=4&aa=<?php echo $tu['moveid']; ?>"><img
                                            src="/assets/images/x.gif" class="del" title="<?php echo AT_CANCEL; ?>"
                                            alt="Annuleren"/></a>
                            </div>
                        <?php } ?>
                    ...
                    <td colspan="10">
                        ...
                        <div class="abort"><a
                                    href="build.php?id=39&a=4&aa=<?php echo $settlers[$y]['moveid']; ?>"><img
                                        src="/assets/images/x.gif" class="del" title="Annuleren" alt="Annuleren"/></a><?php } ?>
                        </div>
                    </td>
                </tr>
                </tbody>
