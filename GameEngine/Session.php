...
if (file_exists(dirname(__FILE__) . '/config.php')) {
    ...
    die('Server configuration is not completed, generate the config file.');
}
...
class Session
{
    var $checker, $mchecker, $villages = array(), $bonus = 0, $bonus1 = 0, $bonus2 = 0, $bonus3 = 0, $bonus4 = 0, $username, $uid, $access, $plus, $tribe, $isAdmin, $alliance, $gold, $oldrank, $gpack, $referrer, $url, $logged_in = FALSE, $is_sitter;
    var $goldclub;
