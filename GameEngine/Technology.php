...
class Technology
{
    ...
    function Technology()
    {
        ...
        if (isset($session) && !empty($session)) {
            foreach ($this->unarray as $k => $v) $this->unarray[$k] = constant($v);
        }
    }
    ...
    public function maxTrap()
    {
        ...
        for ($count = 19; $count < 40; $count++) {
            ...
            if (($village->resarray['f' . $count . 't']) == '36') {
                $max += $bid36[$village->resarray['f' . $count]]['trapcount'];
            }
        }
        ...
        $maxtrap = max(0, min($woodcalc, $claycalc, $ironcalc, $cropcalc, ($max) - ($village->unitarray['u199'] + $ut)));
        return $maxtrap;
    }
    ...
    public function meetRRequirement($tech)
    {
        ...
        switch ($tech) {
            case 2:
                if ($building->getTypeLevel(22) >= 1 && $building->getTypeLevel(12) >= 1) {
                    return true;
                } else {
                    return false;
                }
                break;
            case 3:
                if ($building->getTypeLevel(22) >= 5 && $building->getTypeLevel(12) >= 1) {
                    return true;
                } else {
                    return false;
                }
            ...
            case 4:
            case 23:
                if ($building->getTypeLevel(22) >= 5 && $building->getTypeLevel(20) >= 1) {
                    return true;
                } else {
                    return false;
                }
            ...
            case 5:
            case 25:
                if ($building->getTypeLevel(22) >= 5 && $building->getTypeLevel(20) >= 5) {
                    return true;
                } else {
                    return false;
                }
                break;
            case 6:
                if ($building->getTypeLevel(22) >= 5 && $building->getTypeLevel(20) >= 10) {
                    return true;
                } else {
                    return false;
                }
            ...
            case 9:
            case 29:
                if ($building->getTypeLevel(22) >= 20 && $building->getTypeLevel(16) >= 10) {
                    return true;
                } else {
                    return false;
                }
            ...
            case 32:
            case 42:
                if ($building->getTypeLevel(22) >= 1 && $building->getTypeLevel(19) >= 3) {
                    return true;
                } else {
                    return false;
                }
            ...
            case 33:
            case 43:
                if ($building->getTypeLevel(22) >= 3 && $building->getTypeLevel(11) >= 1) {
                    return true;
                } else {
                    return false;
                }
            ...
            case 34:
            case 44:
                if ($building->getTypeLevel(22) >= 1 && $building->getTypeLevel(15) >= 5) {
                    return true;
                } else {
                    return false;
                }
            ...
            case 35:
            case 45:
                if ($building->getTypeLevel(22) >= 1 && $building->getTypeLevel(20) >= 3) {
                    return true;
                } else {
                    return false;
                }
            ...
            case 36:
            case 46:
                if ($building->getTypeLevel(22) >= 15 && $building->getTypeLevel(20) >= 10) {
                    return true;
                } else {
                    return false;
                }
            ...
            case 37:
            case 47:
                if ($building->getTypeLevel(22) >= 10 && $building->getTypeLevel(21) >= 1) {
                    return true;
                } else {
                    return false;
                }
            ...
            case 38:
            case 48:
                if ($building->getTypeLevel(22) >= 15 && $building->getTypeLevel(21) >= 10) {
                    return true;
                } else {
                    return false;
                }
            ...
            case 39:
            case 49:
                if ($building->getTypeLevel(22) >= 20 && $building->getTypeLevel(16) >= 5) {
                    return true;
                } else {
                    return false;
                }
                break;
            case 22:
                if ($building->getTypeLevel(22) >= 3 && $building->getTypeLevel(12) >= 1) {
                    return true;
                } else {
                    return false;
                }
                break;
            case 24:
                if ($building->getTypeLevel(22) >= 5 && $building->getTypeLevel(20) >= 3) {
                    return true;
                } else {
                    return false;
                }
    ...
    public function meetTRequirement($unit)
    {
        ...
        switch ($unit) {
            ...
            case 7:
            case 8:
                if ($this->getTech($unit) && $session->tribe == 1) {
                    return true;
                } else {
                    return false;
                }
            ...
            case 17:
            case 18:
                if ($session->tribe == 2 && $this->getTech($unit)) {
                    return true;
                } else {
                    return false;
                }
            ...
            case 27:
            case 28:
                if ($session->tribe == 3 && $this->getTech($unit)) {
                    return true;
                } else {
                    return false;
                }
            ...
            case 37:
            case 38:
                if ($session->tribe == 4 && $this->getTech($unit)) {
                    return true;
                } else {
                    return false;
                }
            ...
            case 47:
            case 48:
                if ($session->tribe == 5 && $this->getTech($unit)) {
                    return true;
                } else {
                    return false;
                }
