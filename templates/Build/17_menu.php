<div class="contentNavi subNavi ">
    ...
    <div <?php if (isset($_GET['t']) && $_GET['t'] == 1) {
        echo "class=\"container active\"";
    } else {
        echo "class=\"container normal\"";
    } ?>>
    ...
    <div <?php if (isset($_GET['t']) && $_GET['t'] == 4) {
        echo "class=\"container if($session->goldclub){echo '';}else{echo 'gold';} active\"";
    } else {
        echo "class=\"container if($session->goldclub){echo '';}else{echo 'gold';} normal\"";
    } ?>>
        <div class="background-start">&nbsp;</div>
        <div class="background-end">&nbsp;</div>
        <div class="content favor favorKey99">
            <a id="button5300d0c550a3c2" href="<?php if ($session->goldclub) {
                echo 'build.php?id=' . $id . '&t=4';
            } else {
                echo '#';
            } ?>" class="tabItem"><?php echo MK_TROUTE; ?>
            </a>
        </div>
    </div>
        ...
        if ($('button5300d0c550a3c2')) {
            $('button5300d0c550a3c2').addEvent('click', function () {
                window.fireEvent('tabClicked', [this, {
                    "class": "gold normal",
                    "title": "<?php echo MK_TRADEROUTEDESC;?>",
                    "target": false,
                    "id": "button5300d0c550a3c2",
                    "href": "#",
                    "onclick": false,
                    "enabled": true,
                    "text": "Farm List",
                    ...
                    "buttonIdentifier": "button5300d0c550a3c2"
                }]);
            });
        }
    </script>
