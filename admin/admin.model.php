...
if (file_exists(dirname(__FILE__) . '/../GameEngine/Database.php')) {
    include(dirname(__FILE__) . "/../GameEngine/Database.php");
} else {
    die('GameEngine/Database.php not found');
}
if (file_exists(dirname(__FILE__) . '/../GameEngine/Data/buidata.php')) {
    include(dirname(__FILE__) . "/../GameEngine/Data/buidata.php");
} else {
    die('GameEngine/Data/buidata.php not found');
}
if (file_exists(dirname(__FILE__) . '/../GameEngine/Lang/en.php')) {
    include(dirname(__FILE__) . "/../GameEngine/Lang/en.php");
} else {
    die('GameEngine/Lang/en.php not found');
}
