...
<div class="build_desc">
    <a href="#" onclick="return Travian.Game.iPopup(19,4);" class="build_logo">
        <img class="building big white g19" src="/assets/images/x.gif" alt="<?php echo B19; ?>">
    </a>
...
<div id="contract" class="contract contractNew contractWrapper">
    ...
    <a href="#"
       onclick="return Travian.Game.iPopup(14,4, 'gid');"><?php echo B14; ?></a> <span><?php echo BL_LVL; ?> 1</span></span>,
