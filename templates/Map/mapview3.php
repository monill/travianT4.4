                        ...
                        <div class="mc">
                            <div class="contents">
                                ...
                                <div class="iconButton <?php if (!$session->plus) {
                                    ...
                                    <?php } else { ?>
                                        <div class="iconButton " title="<?php echo MP_LARGMAPDESC; ?>"></div>
                                    <?php } ?>
                                </div>
                                <div class="iconButton <?php if (!$session->goldclub) {
                                    ...
                                    <?php if (!$session->goldclub) { ?>
                                        <div class="iconButton linkCropfinder" title="<?php echo MP_CROPFINDER; ?>"></div>
                                    <?php } else { ?>
                                        <div class="iconButton " title="<?php echo MP_CROPFINDER; ?>"></div>
                                    <?php } ?>
                                </div>
                                <div class="separator"></div>
                                <div class="text"><?php echo MP_FILTER; ?></div>
                                <div class="iconButton filterMy checked" title="<?php echo MP_SHOWMARKS; ?>"></div>
                                <div class="iconButton filterAlliance checked" title="<?php echo MP_SHOWALLYMARK; ?>">
                                </div>
                                <div class="clear"></div>
                            </div>
                        </div>
                            ...
                            <div class="contents">
                                <div class="coordinatesInput">
                                    <div class="xCoord">
                                        ...
                                        <input maxlength="4" value="<?php echo $coorproc['x']; ?>" name="x" id="xCoordInputMap" class="text coordinates x " />
                                    </div>
                                    <div class="yCoord">
                                        <label for="yCoordInputMap">Y:</label>
                                        <input maxlength="4" value="<?php echo $coorproc['y']; ?>" name="y" id="yCoordInputMap" class="text coordinates y " />
                                    </div>
                                    <div class="clear"></div>
                                </div>
            ...
            var fnDelayMe = function() {
                ...
                var fnInit = function() {
                    ...
                    Travian.Game.Map.Tips.tooltipHtml =
                        '<span class=\"coordinates coordinatesWithText\"><span class=\"coordinatesWrapper\"><span class=\"coordinateX\">{x})<\/span><span class=\"coordinatePipe\">|<\/span><span class=\"coordinateY\">({y}<\/span><\/span><\/span>';

                    Travian.Game.Map.Options.Default.block.tooltipHtml =
                        '<span class=\"coordinates coordinatesWithText\"><span class=\"coordinatesWrapper\"><span class=\"coordinateX\">({x}<\/span><span class=\"coordinatePipe\">|<\/span><span class=\"coordinateY\">{y})<\/span><\/span><\/span><br />{k.loadingData}';
