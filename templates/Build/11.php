<h1 class="titleInHeader"><?php echo B11; ?> <span
...
<div id="build" class="gid11">
    <div class="build_desc">
        <a href="#" onClick="return Travian.Game.iPopup(11,4);" class="build_logo">
            <img class="building big white g11" src="/assets/images/x.gif" alt="<?php echo B11; ?>" title="<?php echo B11; ?>"/>
        </a>
        ...
        if (!$building->isMax($village->resarray['f' . $id . 't'], $id)) {
            ...
            for ($nc = 1; $nc <= $ll; $nc++) {
                ...
                <tr <?php if ($nc < $nli) echo 'style="color:#F88C1F;"'; ?>>
                    <th><?php echo NEXT_CAP;
                        echo $village->resarray['f' . $id] + $nc; ?>:
                    </th>
                    <td><b><?php echo $bid11[$village->resarray['f' . $id] + $nc]['attri'] * STORAGE_MULTIPLIER; ?></b>
                    </td>
                </tr>
                <?php
            }
