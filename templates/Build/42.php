<h1 class="titleInHeader"><?php echo B42; ?> <span class="level">
        <?php echo BL_LVL . ' ' . $village->resarray['f' . $id]; ?></span></h1>
<div id="build" class="gid42">
    <div class="build_desc">
        <a href="#" onClick="return Travian.Game.iPopup(42,4);" class="build_logo">
            <img class="building big white g42" src="/assets/images/x.gif" alt="<?php echo B42; ?>" title="<?php echo B42; ?>" />
        </a>
        <?php echo B42_DESC; ?>
    </div>
    <?php
