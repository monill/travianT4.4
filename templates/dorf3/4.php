...
<table id="culture_points" cellpadding="1" cellspacing="1">
    <thead>
        <tr>
            ...
            <td> <?php echo BL_CULTUREPOINTS; ?>/Day</td>
            <td> <?php echo BL_CELEBRATE; ?> </td>
            <td> <?php echo UNITS; ?> </td>
            <td> <?php echo BD_SLOTS; ?> </td>
        </tr>
    </thead>
    <tbody>
        <?php
        ...
        foreach ($varray as $vil) {
            ...
            $siedlerp = '<img src="/assets/images/un/u/' . ($tribe * 10) . '.gif" title="' . BD_COUNT . ': ' . $gessied . '" />';
            $senator = $unit['u' . (($tribe - 1) * 10 + 9)];
            $senatorp = '<img src="/assets/images/un/u/' . (($tribe - 1) * 10 + 9) . '.gif" title="' . BD_COUNT . ': ' . $gessen . '" />';
            $i = 1;
            while ($i <= $siedler) {
                echo $siedlerp;
                $i++;
        ...
        <tr class="sum">
            <th class="vil"><?php echo BL_TOTAL; ?></th>
