...
<div class="build_desc">
    <a href="#" onclick="return Travian.Game.iPopup(5,4);" class="build_logo">
        <img class="building big white g5" src="/assets/images/x.gif" alt="<?php echo B5; ?>">
    </a>
...
<div id="contract" class="contract contractNew contractWrapper">
    ...
    <a href="#"
       onclick="return Travian.Game.iPopup(1,4, 'gid');"><?php echo B1; ?></a> <span><?php echo BL_LVL; ?> 10</span></span>,
