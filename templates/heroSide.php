    ...
    <div class="sidebarBoxInnerBox">
        <div class="innerBox header ">
            ...
            <div class="playerName">
                <img src="/assets/images/x.gif" class="nation nation<?php echo $session->tribe; ?>">
        ...
        <div class="innerBox content">
            <div class="heroStatusMessage">
                <img alt="The hero is completely healthy." src="/assets/images/x.gif" class="heroStatus<?php echo $image; ?>"><?php echo $statusInfoText; ?>
            </div>

            <div class="progressBars">
                <div class="heroHealthBarBox alive" title="<?php echo HS_HEROHEALTH . round($hero['health']); ?>%">
                    <img src="/assets/images/x.gif" class="injury" alt="Health">
