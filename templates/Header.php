...
<div id="header">
    ...
    <ul id="navigation">
        ...
        <li id="n7" class="gold">
            <a href="#" title="<?php echo HDR_BUYGOLD; ?>" accesskey="7" onclick="window.fireEvent('startPaymentWizard', {}); this.blur(); return false;" class=""></a>
        </li>
    </ul>
    ...
    <div id="goldSilver">
        <div class="gold">
            <img src="/assets/images/x.gif" alt="<?php echo HDR_GOLD; ?>" title="<?php echo HDR_GOLD; ?>" class="gold" onclick="window.fireEvent('startPaymentWizard', {data:{activeTab: 'pros'}}); return false;" />
            <span class="ajaxReplaceableGoldAmount"><?php echo $session->gold; ?></span>
        </div>
        <div class="silver">
            <a href="hero_auction.php"><img src="/assets/images/x.gif" alt="<?php echo HDR_SILVER; ?>" title="<?php echo HDR_SILVER; ?>" class="silver" /></a>
    ...
    <ul id="outOfGame" class="LTR">
        <li class="profile">
            <a href="spieler.php?uid=<?php echo $session->uid; ?>" title="<?php echo HDR_PROFILE; ?>">
                <img src="/assets/images/x.gif" alt="<?php echo HDR_PROFILE2; ?>" />
            </a>
        </li>
        <li class="options">
            <a href="options.php" title="<?php echo HDR_OPTION; ?>">
                <img src="/assets/images/x.gif" alt="<?php echo HDR_OPTION2; ?>" />
            </a>
        </li>
        <li class="forum">
            <a target="_blank" href="#" title="<?php echo HDR_FORUM; ?>">
                <img src="/assets/images/x.gif" alt="<?php echo HDR_FORUM2; ?>" />
            </a>
        </li>
        <li class="chat">
            <a target="_blank" href="#" title="<?php echo HDR_CHAT; ?>">
                <img src="/assets/images/x.gif" alt="<?php echo HDR_CHAT2; ?>" />
            </a>
        </li>
        <li class="help">
            <a href="help.php" title="<?php echo HDR_HELP; ?>">
                <img src="/assets/images/x.gif" alt="<?php echo HDR_HELP2; ?>" />
            </a>
        </li>
        <li class="logout ">
            <a href="logout.php" title="<?php echo HDR_LOGOUT; ?>">
                <img src="/assets/images/x.gif" alt="<?php echo HDR_LOGOUT2; ?>" />
            </a>
        </li>
        <li class="clear"></li>
    </ul>
