...
if ($pageref == 'karte.php') {
    ...
    if (isset($_GET['x']) && isset($_GET['y'])) {
        ...
        if ($database->getVilWref($_GET['x'], $_GET['y'])) {
            ...
            include('templates/Map/mapview.php');
        }
    } else {
                            ...
                            <div id="content" class="positionDetails">
                                ...
                                <div id="tileDetails" class="village <?php echo ($basearray['fieldtype'] == 0) ? 'oasis-' . $basearray['oasistype'] : 'village-' . $basearray['fieldtype'] ?>">
                                    <div class="detailImage">
                                        <div id="options">
                                            <div class="option"><a href="karte.php?x=<?php echo $basearray['x']; ?>&y=<?php echo $basearray['y']; ?>" class="a arrow"><?php echo MP_CENTERMAP; ?></a>
                                                <?php
                                            ...
                                            <table cellpadding="0" cellspacing="0" id="village_info" class="transparent">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="karte.php?z=<?php echo $basearray['wref']; ?>"><?php echo $vilowner['name']; ?></a>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table><Br />
