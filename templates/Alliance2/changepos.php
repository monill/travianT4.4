    ...
    <table cellpadding="1" cellspacing="1" id="memberAdministration">
        <thead>
            <tr>
                ...
                <th><img src="/assets/images/x.gif" class="allyRight allyRightPosition" alt="<?php echo AL_ASSIGNPOS; ?>" title="<?php echo AL_ASSIGNPOS; ?>"></th>
                <th><img src="/assets/images/x.gif" class="allyRight allyRightDisband" alt="<?php echo AL_KICK; ?>" title="<?php echo AL_KICK; ?>"></th>
                <th><img src="/assets/images/x.gif" class="allyRight allyRightDescription" alt="<?php echo AL_CHANGEDESC; ?>" title="<?php echo AL_CHANGEDESC; ?>"></th>
                <th><img src="/assets/images/x.gif" class="allyRight allyRightDiplomacy" alt="<?php echo AL_ALLIDIPLO; ?>" title="<?php echo AL_ALLIDIPLO; ?>"></th>
                <th><img src="/assets/images/x.gif" class="allyRight allyRightMessage" alt="<?php echo AL_ALLIIGMS; ?>" title="<?php echo AL_ALLIIGMS; ?>"></th>
                <th><img src="/assets/images/x.gif" class="allyRight allyRightInvite" alt="<?php echo AL_ALLIINV; ?>" title="<?php echo AL_ALLIINV; ?>"></th>
                <th><img src="/assets/images/x.gif" class="allyRight allyRightForum" alt="<?php echo FT_FORUM; ?>" title="<?php echo FT_FORUM; ?>"></th>
                <th>Position Name</th>
            </tr>
        </thead>
        <tbody>
