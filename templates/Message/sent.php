...
if ($page <= 1 && $lastPage <= 1) {
    ...
    $centerPages .= '<a class="number" href="' . $_SERVER['PHP_SELF'] . '?t=2&page=2">2</a>';
} elseif ($page == 1 && $lastPage == 3) {
    $centerPages .= '<span class="number currentPage">' . $page . '</span> ';
    $centerPages .= '<a class="number" href="' . $_SERVER['PHP_SELF'] . '?t=2&page=2">2</a> ';
    $centerPages .= '<a class="number" href="' . $_SERVER['PHP_SELF'] . '?t=2&page=3">3</a>';
} elseif ($page == 1) {
    $centerPages .= '<span class="number currentPage">' . $page . '</span> ';
    $centerPages .= '<a class="number" href="' . $_SERVER['PHP_SELF'] . '?t=2&page=' . $add1 . '">' . $add1 . '</a> ';
    $centerPages .= '<a class="number" href="' . $_SERVER['PHP_SELF'] . '?t=2&page=' . $add2 . '">' . $add2 . '</a> ... ';
    $centerPages .= '<a class="number" href="' . $_SERVER['PHP_SELF'] . '?t=2&page=' . $lastPage . '">' . $lastPage . '</a>';
} else if ($page == $lastPage && $lastPage == 2) {
    $centerPages .= '<a class="number" href="' . $_SERVER['PHP_SELF'] . '?t=2&page=1">1</a> ';
    $centerPages .= '<span class="number currentPage">' . $page . '</span>';
    ...
    $centerPages .= '<a class="number" href="' . $_SERVER['PHP_SELF'] . '?t=2&page=1">1</a> ... ';
    $centerPages .= '<a class="number" href="' . $_SERVER['PHP_SELF'] . '?t=2&page=' . $sub2 . '">' . $sub2 . '</a> ';
    $centerPages .= '<a class="number" href="' . $_SERVER['PHP_SELF'] . '?t=2&page=' . $sub1 . '">' . $sub1 . '</a> ';
    $centerPages .= '<span class="number currentPage">' . $page . '</span>';
...
$sql2 = mysql_query("SELECT * FROM $prefix WHERE owner = $session->uid AND archived = 0 AND delowner = 0 ORDER BY time DESC $limit");
$paginationDisplay = "";
...
if ($page == "1" && $lastPage == "1") {
    ...
    $paginationDisplay .= '<img alt="' . PREVPAGE . '" src="/assets/images/x.gif" class="previous disabled">';
    $paginationDisplay .= $centerPages;
    $paginationDisplay .= '<a class="next" href="' . $_SERVER['PHP_SELF'] . '?t=2&page=' . $nextPage . '"><img alt="' . NEXTPAGE . '" src="/assets/images/x.gif"></a> ';
    $paginationDisplay .= '<a class="last" href="' . $_SERVER['PHP_SELF'] . '?t=2&page=' . $lastPage . '"><img alt="' . LASTPAGE . '" src="/assets/images/x.gif"></a>';
} elseif ($page != "1" && $page != $lastPage) {
    $paginationDisplay .= '<a class="first" href="' . $_SERVER['PHP_SELF'] . '?t=2&page=1"><img alt="' . FIRSTPAGE . '" src="/assets/images/x.gif"></a> ';
    $paginationDisplay .= '<a class="previous" href="' . $_SERVER['PHP_SELF'] . '?t=2&page=' . $previous . '"><img alt="' . PREVPAGE . '" src="/assets/images/x.gif"></a>';
    $paginationDisplay .= $centerPages;
    $paginationDisplay .= '<a class="next" href="' . $_SERVER['PHP_SELF'] . '?t=2&page=' . $nextPage . '"><img alt="' . NEXTPAGE . '" src="/assets/images/x.gif"></a> ';
    $paginationDisplay .= '<a class="last" href="' . $_SERVER['PHP_SELF'] . '?t=2&page=' . $lastPage . '"><img alt="' . LASTPAGE . '" src="/assets/images/x.gif"></a>';
...
if ($query == 0) {
    ...
    while ($row = mysql_fetch_array($sql2)) {
        ...
        $outputList .= "<img src=\"/assets/images/x.gif\" class=\"messageStatus messageStatus" . $viewedclass . "\" alt=\"" . $viewed . "\">
...
<form method="post" action="nachrichten.php?t=2" name="msg">
    ...
    <table cellpadding="1" cellspacing="1" id="overview" class="inbox">
        <thead>
            <tr>
                ...
                <th class="send"><?php echo MS_RECEIVER; ?></th>
    ...
    <p>
        ...
        <?php if (!$session->is_sitter) { ?>
            <button type="submit" value="Delete" name="delmsg" id="del" class="green ">
