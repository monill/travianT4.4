...
if (isset($_GET['gid']) && $_GET['gid'] == 37 && isset($_GET['del'])) {
    ...
    $q = mysql_query("SELECT owner from odata WHERE wref = '" . $_GET['del'] . "' LIMIT 1");
    $isUserVillage = FALSE;
                ...
                <tr>
                    <td class="type">
                        <a onclick="return (function(){('<?php echo AL_AREYOUSURE; ?>').dialog({onOkay: function(dialog, contentElement){window.location.href = 'build.php?gid=37&amp;c=<?php echo $generator->getMapCheck($wref); ?>&amp;del=<?php echo $wref; ?>'}});return false;})()">
                            <img class="del" src="/assets/images/x.gif" alt="Delete">
                        </a>
                        <?php
                        switch ($type) {
                            case 1:
                    ...
                    <td class="coords">
                        ...
                        switch ($type) {
                            case 1:
                                $tt = "<span><img class='r1' src='/assets/images/x.gif' title=" . VL_WOOD . "> 25%</span>";
                                break;
                            case 2:
                                $tt = "<span><img class='r1' src='/assets/images/x.gif' title=" . VL_WOOD . "> 50%</span>";
                                break;
                            case 3:
                                $tt = "<span><img class='r1' src='/assets/images/x.gif' title=" . VL_WOOD . "> 25%</span><span><img class='r4' src='/assets/images/x.gif' title=" . VL_CROP . "> 25%</span>";
                                break;
                            case 4:
                                $tt = "<span><img class='r2' src='/assets/images/x.gif' title=" . VL_CLAY . "> 25%</span>";
                                break;
                            case 5:
                                $tt = "<span><img class='r2' src='/assets/images/x.gif' title=" . VL_CLAY . "> 50%</span>";
                                break;
                            case 6:
                                $tt = "<span><img class='r2' src='/assets/images/x.gif' title=" . VL_CLAY . "> 25%</span><span><img class='r4' src='/assets/images/x.gif' title=" . VL_CROP . "> 25%</span>";
                                break;
                            case 7:
                                $tt = "<span><img class='r3' src='/assets/images/x.gif' title=" . VL_IRON . "> 25%</span>";
                                break;
                            case 8:
                                $tt = "<span><img class='r3' src='/assets/images/x.gif' title=" . VL_IRON . "> 50%</span>";
                                break;
                            case 9:
                                $tt = "<span><img class='r3' src='/assets/images/x.gif' title=" . VL_IRON . "> 25%</span><span><img class='r4' src='/assets/images/x.gif' title=" . VL_CROP . "> 25%</span>";
                                break;
                            case 10:
                            case 11:
                                $tt = "<span><img class='r4' src='/assets/images/x.gif' title=" . VL_CROP . "> 25%</span>";
                                break;
                            case 12:
                                $tt = "<span><img class='r4' src='/assets/images/x.gif' title=" . VL_CROP . "> 50%</span>";
                                break;
                        }
                        ?>
    ...
    <tbody>
        ...
        foreach ($rows as $row) {
            if ($row['distance'] <= 4.949747468305832670805910534733) {
                ...
                switch ($row['type']) {
                    case 1:
                        $ttt = "<span><img class='r1' src='/assets/images/x.gif' title=" . VL_WOOD . "> 25%</span>";
                        break;
                    case 2:
                        $ttt = "<span><img class='r1' src='/assets/images/x.gif' title=" . VL_WOOD . "> 50%</span>";
                        break;
                    case 3:
                        $ttt = "<span><img class='r1' src='/assets/images/x.gif' title=" . VL_WOOD . "> 25%</span><span><img class='r4' src='/assets/images/x.gif' title=" . VL_CROP . "> 25%</span>";
                        break;
                    case 4:
                        $ttt = "<span><img class='r2' src='/assets/images/x.gif' title=" . VL_CLAY . "> 25%</span>";
                        break;
                    case 5:
                        $ttt = "<span><img class='r2' src='/assets/images/x.gif' title=" . VL_CLAY . "> 50%</span>";
                        break;
                    case 6:
                        $ttt = "<span><img class='r2' src='/assets/images/x.gif' title=" . VL_CLAY . "> 25%</span><span><img class='r4' src='/assets/images/x.gif' title=" . VL_CROP . "> 25%</span>";
                        break;
                    case 7:
                        $ttt = "<span><img class='r3' src='/assets/images/x.gif' title=" . VL_IRON . "> 25%</span>";
                        break;
                    case 8:
                        $ttt = "<span><img class='r3' src='/assets/images/x.gif' title=" . VL_IRON . "> 50%</span>";
                        break;
                    case 9:
                        $ttt = "<span><img class='r3' src='/assets/images/x.gif' title=" . VL_IRON . "> 25%</span><span><img class='r4' src='/assets/images/x.gif' title=" . VL_CROP . "> 25%</span>";
                        break;
                    case 10:
                    case 11:
                        $ttt = "<span><img class='r4' src='/assets/images/x.gif' title=" . VL_CROP . "> 25%</span>";
                        break;
                    case 12:
                        $ttt = "<span><img class='r4' src='/assets/images/x.gif' title=" . VL_CROP . "> 50%</span>";
                        break;
                }
