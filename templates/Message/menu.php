<div class="contentNavi subNavi">
    ...
    <?php if ($session->goldclub) { ?>
        <div class="<?php if (isset($_GET['t']) && $_GET['t'] == 3) {
            ...
            <div class="background-start">&nbsp;</div>
            <div class="background-end">&nbsp;</div>
            <div class="content"><a href="nachrichten.php?t=3"><span class="tabItem"><?php echo MS_ARCHIVE; ?></span></a>
            </div>
        </div>
    <?php } else { ?>
        <div class="container gold normal">
            ...
            <div class="background-end">&nbsp;</div>
            <div class="content">
                <a id="button5290832f16f3f" href="#"><span class="tabItem"><?php echo MS_ARCHIVE; ?></span></a>
            </div>
        </div>
            ...
            if ($('button5290832f16f3f')) {
                $('button5290832f16f3f').addEvent('click', function() {
                    window.fireEvent('tabClicked', [this, {
                        "class": "gold normal",
                        "title": "<?php echo MS_ARCHIVEDESC; ?>",
                        "target": false,
                        "id": "button5290832f16f3f",
                        "href": "#",
                        "onclick": false,
                        "enabled": true,
                        "text": "Archive",
                        ...
                        "containerId": "",
                        "buttonIdentifier": "button5290832f16f3f"
                    }]);
                });
            }
        </script>
    ...
    <div class="<?php if (isset($_GET['t']) && $_GET['t'] == 5) {
        ...
        <div class="background-start">&nbsp;</div>
        <div class="background-end">&nbsp;</div>
        <div class="content"><a href="nachrichten.php?t=5"><span class="tabItem" title="Ignored Player(s)"><?php echo MS_IGNOREP; ?></span></a>
        </div>
    </div>
