                ...
                <div id="contentOuterContainer">
                    ...
                    <div class="contentContainer">
                        <div id="content" class="hero_editor">
                            ...
                            $gstr = $herodetail['gender'] == 0 ? 'male' : 'female';
                                        ...
                                        <div class="boxes-contents cf">
                                            <div class="container cf" id="attributesContainer">
                                                ...
                                                <div class="info" id="hairColor">
                                                    <div class="headline switchClosed">
                                                        <a href="#" class="title">hair color</a>
                                                        <div class="clear"></div>
                                                    </div>
                                                    <div class="details">
                                                ...
                                                <div class="info" id="hairStyle">
                                                    <div class="headline switchClosed">
                                                        <a href="#" class="title">hairstyle</a>
                                                        <div class="clear"></div>
                                                    </div>
                                                    <div class="details">
                                                ...
                                                <div class="info" id="eyes">
                                                    ...
                                                    <div class="details">
                                                        ...
                                                        <?php if ($herodetail['gender'] == 1) { ?>
                                                            <img id="attribute_button_5" class="attribute" onclick='$("HeroEditorForm").HeroEye.value="5";' src="<?php echo "/assets/images/hero/" . $gstr; ?>/thumb/head/eye/eye5.png" alt="" />
                                                            <img id="attribute_button_6" class="attribute" onclick='$("HeroEditorForm").HeroEye.value="6";' src="<?php echo "/assets/images/hero/" . $gstr; ?>/thumb/head/eye/eye6.png" alt="" />
                                                            <img id="attribute_button_7" class="attribute" onclick='$("HeroEditorForm").HeroEye.value="7";' src="<?php echo "/assets/images/hero/" . $gstr; ?>/thumb/head/eye/eye7.png" alt="" />
                                                            <img id="attribute_button_8" class="attribute" onclick='$("HeroEditorForm").HeroEye.value="8";' src="<?php echo "/assets/images/hero/" . $gstr; ?>/thumb/head/eye/eye8.png" alt="" />
                                                            <img id="attribute_button_9" class="attribute" onclick='$("HeroEditorForm").HeroEye.value="9";' src="<?php echo "/assets/images/hero/" . $gstr; ?>/thumb/head/eye/eye9.png" alt="" />
                                                        <?php } ?>
                                                        <div class="clear"></div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="info" id="nose">
                                                    <div class="headline switchClosed">
                                                        <a href="#" class="title">nose</a>
                                                        <div class="clear"></div>
                                                    </div>
                                                    <div class="details">
                                                        <img id="attribute_button_0" class="attribute" onclick='$("HeroEditorForm").HeroNose.value="0";' src="<?php echo "/assets/images/hero/" . $gstr; ?>/thumb/head/nose/nose0.png" alt="" />
                                                        <img id="attribute_button_1" class="attribute" onclick='$("HeroEditorForm").HeroNose.value="1";' src="<?php echo "/assets/images/hero/" . $gstr; ?>/thumb/head/nose/nose1.png" alt="" />
                                                        <img id="attribute_button_2" class="attribute" onclick='$("HeroEditorForm").HeroNose.value="2";' src="<?php echo "/assets/images/hero/" . $gstr; ?>/thumb/head/nose/nose2.png" alt="" />
                                                        <img id="attribute_button_3" class="attribute" onclick='$("HeroEditorForm").HeroNose.value="3";' src="<?php echo "/assets/images/hero/" . $gstr; ?>/thumb/head/nose/nose3.png" alt="" />
                                                        <img id="attribute_button_4" class="attribute" onclick='$("HeroEditorForm").HeroNose.value="4";' src="<?php echo "/assets/images/hero/" . $gstr; ?>/thumb/head/nose/nose4.png" alt="" />
                                                        <?php if ($herodetail['gender'] == 1) { ?>
                                                            <img id="attribute_button_5" class="attribute" onclick='$("HeroEditorForm").HeroNose.value="5";' src="<?php echo "/assets/images/hero/" . $gstr; ?>/thumb/head/nose/nose5.png" alt="" />
                                                            <img id="attribute_button_6" class="attribute" onclick='$("HeroEditorForm").HeroNose.value="6";' src="<?php echo "/assets/images/hero/" . $gstr; ?>/thumb/head/nose/nose6.png" alt="" />
                                                            <img id="attribute_button_7" class="attribute" onclick='$("HeroEditorForm").HeroNose.value="7";' src="<?php echo "/assets/images/hero/" . $gstr; ?>/thumb/head/nose/nose7.png" alt="" />
                                                        <?php } ?>
                                                        <div class="clear"></div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="info" id="mouth">
                                                    <div class="headline switchClosed">
                                                        <a href="#" class="title">Mouth</a>
                                                        <div class="clear"></div>
                                                    </div>
                                                    <div class="details">
                                                        <img id="attribute_button_0" class="attribute" onclick='$("HeroEditorForm").HeroMouth.value="0";' src="<?php echo "/assets/images/hero/" . $gstr; ?>/thumb/head/mouth/mouth0.png" alt="" />
                                                        <img id="attribute_button_1" class="attribute" onclick='$("HeroEditorForm").HeroMouth.value="1";' src="<?php echo "/assets/images/hero/" . $gstr; ?>/thumb/head/mouth/mouth1.png" alt="" />
                                                        <img id="attribute_button_2" class="attribute" onclick='$("HeroEditorForm").HeroMouth.value="2";' src="<?php echo "/assets/images/hero/" . $gstr; ?>/thumb/head/mouth/mouth2.png" alt="" />
                                                        <img id="attribute_button_3" class="attribute" onclick='$("HeroEditorForm").HeroMouth.value="3";' src="<?php echo "/assets/images/hero/" . $gstr; ?>/thumb/head/mouth/mouth3.png" alt="" />
                                                        <?php if ($herodetail['gender'] == 1) { ?>
                                                            <img id="attribute_button_4" class="attribute" onclick='$("HeroEditorForm").HeroMouth.value="4";' src="<?php echo "/assets/images/hero/" . $gstr; ?>/thumb/head/mouth/mouth4.png" alt="" />
                                                            <img id="attribute_button_5" class="attribute" onclick='$("HeroEditorForm").HeroMouth.value="5";' src="<?php echo "/assets/images/hero/" . $gstr; ?>/thumb/head/mouth/mouth5.png" alt="" />
                                                            <img id="attribute_button_6" class="attribute" onclick='$("HeroEditorForm").HeroMouth.value="6";' src="<?php echo "/assets/images/hero/" . $gstr; ?>/thumb/head/mouth/mouth6.png" alt="" />
                                                            <img id="attribute_button_7" class="attribute" onclick='$("HeroEditorForm").HeroMouth.value="7";' src="<?php echo "/assets/images/hero/" . $gstr; ?>/thumb/head/mouth/mouth7.png" alt="" />
                                                            <img id="attribute_button_8" class="attribute" onclick='$("HeroEditorForm").HeroMouth.value="8";' src="<?php echo "/assets/images/hero/" . $gstr; ?>/thumb/head/mouth/mouth8.png" alt="" />
                                                        <?php } ?>
                                                        <div class="clear"></div>
                                                    </div>
                                                </div>
                                                <?php if ($herodetail['gender'] == 0) { ?>
                                                    ...
                                                    <div class="info" id="beard">
                                                        <div class="headline switchClosed">
                                                            <a href="#" class="title">Beard</a>
                                                            <div class="clear"></div>
                                                        </div>
                                                        <div class="details">
                                                            <img id="attribute_button_5000" class="attribute" onclick='$("HeroEditorForm").HeroBeard.value="0";' src="<?php echo "/assets/images/hero/" . $gstr; ?>/thumb/head/beard/beard0.png" alt="" />
                                                            <img id="attribute_button_5001" class="attribute" onclick='$("HeroEditorForm").HeroBeard.value="1";' src="<?php echo "/assets/images/hero/" . $gstr; ?>/thumb/head/beard/beard1.png" alt="" />
                                                            <img id="attribute_button_5002" class="attribute" onclick='$("HeroEditorForm").HeroBeard.value="2";' src="<?php echo "/assets/images/hero/" . $gstr; ?>/thumb/head/beard/beard2.png" alt="" />
                                                            <img id="attribute_button_5003" class="attribute" onclick='$("HeroEditorForm").HeroBeard.value="3";' src="<?php echo "/assets/images/hero/" . $gstr; ?>/thumb/head/beard/beard3.png" alt="" />
                                                            <img id="attribute_button_5004" class="attribute" onclick='$("HeroEditorForm").HeroBeard.value="4";' src="<?php echo "/assets/images/hero/" . $gstr; ?>/thumb/head/beard/beard4.png" alt="" />
                                                            <img id="attribute_button_5999" class="attribute" onclick='$("HeroEditorForm").HeroBeard.value="5";' src="<?php echo "/assets/images/hero/" . $gstr; ?>/thumb/head/beard/beardNone.png" alt="" />
                                                            <div class="clear"></div>
                                                        </div>
                                                    </div>
                                                <?php } ?>
                                        ...
                                        <form id="HeroEditorForm" method="post">
                                            <button type="button" value="" name="" id="btn_login" style="float:right;" class="green " onClick="window.location='hero.php?genRand=yes'">
                                                <div class="button-container addHoverClick">
                                                    ...
                                                    <div class="button-content">by accident</div>
                                                </div>
                                            </button>
                                            ...
                                            <button type="submit" value="save" name="save" id="btn_login" style="float:left;" class="green " onClick="document.snd.attributes.value=screen.width+':'+screen.height;">
                                                <div class="button-container addHoverClick">
                                                    ...
                                                    <div class="button-content">to save</div>
                                                </div>
                                            </button>
