    ...
    <div class="boxes boxesColor gray">
        ...
        <div class="boxes-contents cf">
            ...
            <table cellpadding="1" cellspacing="1" id="npc" class="transparent">
                <thead>
                <tr>
                    <th colspan="2"><?php echo MK_CREATROUTE; ?></th>
                </tr>
                </thead>
                <tbody>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <img src="/assets/images/r/1.gif" alt="Wood" title="<?php echo VL_WOOD; ?>"> <input
                                class="text"
                                type="text"
                                name="r1" id="r1"
                                value=""
                                ...
                                tabindex="1"
                                style="width:50px;">
                        <img src="/assets/images/r/2.gif" alt="Clay" title="<?php echo VL_CLAY; ?>"> <input
                                class="text"
                                type="text"
                                name="r2" id="r2"
                                value=""
                                ...
                                tabindex="1"
                                style="width:50px;">
                        <img src="/assets/images/r/3.gif" alt="Iron" title="<?php echo VL_IRON; ?>"> <input
                                class="text"
                                type="text"
                                name="r3" id="r3"
                                value=""
                                ...
                                tabindex="1"
                                style="width:50px;">
                        <img src="/assets/images/r/4.gif" alt="Crop" title="<?php echo VL_CROP; ?>">
                        <input class="text"
                               type="text"
                               name="r4"
                               id="r4"
