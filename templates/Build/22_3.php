...
if ($fail > 0) {
    ...
    for ($uc = 22; $uc <= 29; $uc++) {
        if (!$technology->meetRRequirement($uc) && !$technology->getTech($uc)) {
            echo "<div class=\"research\"><div class=\"bigUnitSection\"><a href=\"#\" onclick=\"return Travian.Game.iPopup(" . $uc . ",1);\"><img class=\"unitSection u" . $uc . "Section\" src=\"/assets/images/x.gif\" alt=\"" . constant('U' . $uc) . "\"></a><a href=\"#\" class=\"zoom\" onclick=\"return Travian.Game.unitZoom(" . $uc . ");\"><img class=\"zoom\" src=\"/assets/images/x.gif\" alt=\"zoom in\"></a></div><div class=\"information\"><div class=\"title\"><a href=\"#\" onclick=\"return Travian.Game.iPopup(" . $uc . ",1);\"><img class=\"unit u" . $uc . "\" src=\"/assets/images/x.gif\" alt=\"" . constant('U' . $uc) . "\"></a><a href=\"#\" onclick=\"return Travian.Game.iPopup(" . $uc . ",1);\">" . constant('U' . $uc) . "</a></div><div class=\"costs\"><div class=\"showCosts\"><span class=\"resources r1 little_res\"><img class=\"r1\" src=\"/assets/images/x.gif\" alt=\"" . WOOD . "\">" . ${'r' . $uc}['wood'] . "</span><span class=\"resources r2 little_res\"><img class=\"r2\" src=\"/assets/images/x.gif\" alt=\"" . CLAY . "\">" . ${'r' . $uc}['clay'] . "</span><span class=\"resources r3 little_res\"><img class=\"r3\" src=\"/assets/images/x.gif\" alt=\"" . IRON . "\">" . ${'r' . $uc}['iron'] . "</span><span class=\"resources r4 little_res\"><img class=\"r4\" src=\"/assets/images/x.gif\" alt=\"" . CROP . "\">" . ${'r' . $uc}['crop'] . "</span><div class=\"clear\"></div><span class=\"clocks\"><img class=\"clock\" src=\"/assets/images/x.gif\" alt=\"" . HRS . "\">";
            ...
            switch ($uc) {
                ...
                case 23:
                    ...
                    break;
                case 24:
                    echo "</span><div class=\"clear\"></div></div></div><div class=\"contractLink\"><a href=\"#\">" . B22 . "</a><span class=\"level\"> " . BL_LVL . " 5</span>, <a href=\"#\"> " . B20 . " </a><span class=\"level\"> " . BL_LVL . " 3</span></div></div><div class=\"clear\"></div></div><hr>";
                    break;
                case 25:
