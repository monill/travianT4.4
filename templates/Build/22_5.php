    ...
    for ($i = 42; $i <= 49; $i++) {
        if ($technology->meetRRequirement($i) && !$technology->getTech($i) && !$technology->isResearch($i, 1)) {
            echo "<tr><td class=\"desc\">
					<div class=\"tit\">
						<img class=\"unit u" . $i . "\" src=\"/assets/images/x.gif\" alt=\"" . $technology->getUnitName($i) . "\" title=\"" . $technology->getUnitName($i) . "\" />
						<a href=\"#\" onClick=\"return Popup(" . $i . ",1);\">" . $technology->getUnitName($i) . "</a>
					</div>
					<div class=\"details\"><img class=\"r1\" src=\"/assets/images/x.gif\" alt=\"Fa\" title=\"Fa\" />" . ${'r' . $i}['wood'] . "|<img class=\"r2\" src=\"/assets/images/x.gif\" alt=\"Agyag\" title=\"Agyag\" />" . ${'r' . $i}['clay'] . "|<img class=\"r3\" src=\"/assets/images/x.gif\" alt=\"Vasércbánya\" title=\"Vasércbánya\" />" . ${'r' . $i}['iron'] . "|<img class=\"r4\" src=\"/assets/images/x.gif\" alt=\"Búzafarm\" title=\"Búzafarm\" />" . ${'r' . $i}['crop'] . "|<img class=\"clock\" src=\"/assets/images/x.gif\" alt=\"duration\" title=\"duration\" />";
            echo $generator->getTimeFormat(round(${'r' . $i}['time'] * ($bid22[$village->resarray['f' . $id]]['attri'] / 100) / SPEED));
            if ($session->userinfo['gold'] >= 3 && $building->getTypeLevel(17) > 1) {
                echo "|<a href=\"build.php?gid=17&t=3&r1=" . ${'r' . $i}['wood'] . "&r2=" . ${'r' . $i}['clay'] . "&r3=" . ${'r' . $i}['iron'] . "&r4=" . ${'r' . $i}['crop'] . "\" title=\"NPC kereskedelem\"><img class=\"npc\" src=\"/assets/images/x.gif\" alt=\"NPC kereskedelem\" title=\"NPC trade\" /></a>";
            }
...
<?php if ($fail > 0) {
    ...
    for ($uc = 43; $uc <= 49; $uc++) {
        if (!$technology->meetRRequirement($uc) && !$technology->getTech($uc)) {
            echo "<div class=\"research\"><div class=\"bigUnitSection\"><a href=\"#\" onclick=\"return Travian.Game.iPopup(" . $uc . ",1);\"><img class=\"unitSection u" . $uc . "Section\" src=\"/assets/images/x.gif\" alt=\"Testőrség\"></a><a href=\"#\" class=\"zoom\" onclick=\"return Travian.Game.unitZoom(" . $uc . ");\"><img class=\"zoom\" src=\"/assets/images/x.gif\" alt=\"zoom in\"></a></div><div class=\"information\"><div class=\"title\"><a href=\"#\" onclick=\"return Travian.Game.iPopup(" . $uc . ",1);\"><img class=\"unit u" . $uc . "\" src=\"/assets/images/x.gif\" alt=\"" . constant('U' . $uc) . "\"></a><a href=\"#\" onclick=\"return Travian.Game.iPopup(" . $uc . ",1);\">" . constant('U' . $uc) . "</a></div><div class=\"costs\"><div class=\"showCosts\"><span class=\"resources r1 little_res\"><img class=\"r1\" src=\"/assets/images/x.gif\" alt=\"" . WOOD . "\">" . ${r . $uc}['wood'] . "</span><span class=\"resources r2 little_res\"><img class=\"r2\" src=\"/assets/images/x.gif\" alt=\"Agyag\">" . ${r . $uc}['clay'] . "</span><span class=\"resources r3 little_res\"><img class=\"r3\" src=\"/assets/images/x.gif\" alt=\"Vasérc\">" . ${r . $uc}['iron'] . "</span><span class=\"resources r4 little_res\"><img class=\"r4\" src=\"/assets/images/x.gif\" alt=\"Búza\">" . ${r . $uc}['crop'] . "</span><div class=\"clear\"></div><span class=\"clocks\"><img class=\"clock\" src=\"/assets/images/x.gif\" alt=\"" . HRS . "\">";
