    ...
    <table class="transparent set" cellpadding="1" cellspacing="1" id="timeSettings">
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <label>
                        <input class="radio" type="radio" name="tformat" value="0"> UE - dd.mm.yy
                        24h</label>
                    <label>
                        <input class="radio" type="radio" name="tformat" value="1"> US - mm/dd/yy
                        12h</label>
                    <label>
                        <input class="radio" type="radio" name="tformat" value="2"> UK - dd/mm/yy
                        12h</label>
                    <label>
