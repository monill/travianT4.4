<h1 class="titleInHeader"><?php echo B3; ?> <span
...
<div id="build" class="gid3">
    <div class="build_desc">
        <a href="#" onClick="return Travian.Game.iPopup(3,4);" class="build_logo">
            <img class="building big white g3" src="/assets/images/x.gif" alt="<?php echo B3; ?>" title="<?php echo B3; ?>"/>
        </a>
        ...
        if (!$building->isMax($village->resarray['f' . $id . 't'], $id)) {
            ...
            for ($nc = 1; $nc <= $ll; $nc++) {
                ...
                <tr <?php if ($nc < $nli) echo 'style="color:#F88C1F;"'; ?>>
                    ...
                    <td>
                        <b><?php echo $bid3[$village->resarray['f' . $id] + $nc]['prod'] * SPEED; ?></b> <?php echo PER_HR; ?>
                    </td>
                </tr>
                <?php
            }
