...
define("WARSIM_COMBAT_MODEL", "Combat Model");
define("WARSIM_NORMAL", "Normal attack");
define("WARSIM_RAID", "Raid");
define('WARSIM_SCOUT', 'Scout');
define("WARSIM_ATTACKCONFIG", "Attack configuration");
define("WARSIM_SIMULATE", "Simulate");
