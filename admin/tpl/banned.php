...
<table id="member" cellpadding="1" cellspacing="1">
    ...
    <tr>
        ...
        <td class="on"><a href="?action=delBan&uid=' . $bannedUsers[$i]['uid'] . '&id=' . $bannedUsers[$i]['id'] . '" onClick="return del(\'unban\',\'' . $name . '\')"><img src="/admin/images/admin/del.gif" class="del" title="cancel" alt="cancel"></a></td>           
