<h1 class="titleInHeader"><?php echo B1; ?> <span class="level">
    <?php echo BL_LVL . ' ' . $village->resarray['f' . $id]; ?></span>
</h1>
<div id="build" class="gid1">
    <div class="build_desc">
        <a href="#" onClick="return Travian.Game.iPopup(1,4);" class="build_logo">
            <img class="building big white g1" src="/assets/images/x.gif" alt="<?php echo B1; ?>" title="<?php echo B1; ?>" />
        </a>
        <?php echo B1_DESC; ?>
    </div>
