    ...
    <tbody>
        ...
        foreach ($forumcat as $arr) {
            ...
            if ($database->CheckEditRes($aid) == "1") {
                echo '<a class="up_arr" href="allianz.php?s=2&fid=' . $arr['id'] . '&bid=0&admin=pos&res=-1" title="' . AL_TOTOP . '"><img src="/assets/images/x.gif" /></a>
    <a class="edit" href="allianz.php?s=2&idf=' . $arr['id'] . '&admin=editforum" title="' . AL_EDIT . '"><img src="/assets/images/x.gif" /></a>
    <br />
    <a class="down_arr" href="allianz.php?s=2&fid=' . $arr['id'] . '&bid=0&admin=pos&res=1" title="' . AL_TOBOTT . '"><img src="/assets/images/x.gif" /></a>
    <a class="fdel" href="allianz.php?s=2&idf=' . $arr['id'] . '&admin=delforum" onClick="return confirm(\'' . AL_AREYOUSURE . '\');" title="' . AL_DELETE . '"><img src="/assets/images/x.gif" /></a>';
            } else {
			...
			<td class="last">' . $lpost . '</span><span><br /><a href="spieler.php?uid=' . $owner['id'] . '">' . $owner['username'] . '</a> <img class="latest_reply" src="/assets/images/x.gif" alt="' . AL_SHOWLASTPOST . '" title="' . AL_SHOWLASTPOST . '" /></td>
		</tr>';
        }
        ?>
    </tbody>
