...
<div id="internInfo1" class="internInfo">
    ...
    <table class="barChart oneDir" cellpadding="1" cellspacing="1">
        <tbody>
            <tr>
                <td>
                    <center><?php echo date("j/m"); ?>
                </td>
                <td>
                    <center><?php echo date("j/m", time() - (86400 * 1)); ?>
                </td>
                <td>
                    <center><?php echo date("j/m", time() - (86400 * 2)); ?>
                </td>
                <td>
                    <center><?php echo date("j/m", time() - (86400 * 3)); ?>
                </td>
                <td>
                    <center><?php echo date("j/m", time() - (86400 * 4)); ?>
                </td>
                <td>
                    <center><?php echo date("j/m", time() - (86400 * 5)); ?>
                </td>
                <td>
                    <center><?php echo date("j/m", time() - (86400 * 6)); ?>
                </td>
            </tr>
            <tr>
        ...
        <ul>
            <h4 class="chartHeadline">
                ...
                if ($page == "1" && $lastPage == "1") {
                    ...
                    $paginationDisplay .= '<img alt="Previous Page" src="/assets/images/x.gif" class="previous disabled">';
                    $paginationDisplay .= $centerPages;
                    $paginationDisplay .= '<a class="next" href="?s=4&page=' . $nextPage . '"><img alt="Next Page" src="/assets/images/x.gif"></a> ';
                    $paginationDisplay .= '<a class="last" href="?s=4&page=' . $lastPage . '"><img alt="Last page" src="/assets/images/x.gif"></a>';
                } elseif ($page != "1" && $page != $lastPage) {
                    $paginationDisplay .= '<a class="first" href="?s=4&page=1"><img alt="First page" src="/assets/images/x.gif"></a> ';
                    $paginationDisplay .= '<a class="previous" href="?s=4&page=' . $previous . '"><img alt="Previous Page" src="/assets/images/x.gif"></a>';
                    $paginationDisplay .= $centerPages;
                    $paginationDisplay .= '<a class="next" href="?s=4&page=' . $nextPage . '"><img alt="Next Page" src="/assets/images/x.gif"></a> ';
                    $paginationDisplay .= '<a class="last" href="?s=4&page=' . $lastPage . '"><img alt="Last page" src="/assets/images/x.gif"></a>';
                } elseif ($page == $lastPage) {
