...
<div id="build" class="gid17">
    ...
    <?php } else { ?>
        ...
        <p><?php echo MARKETRESREDISTDESC; ?></p>
        ...
        <script language="JavaScript">
            ...
            function testSum() {
                if (document.getElementById("remain").innerHTML != 0) {
                    document.getElementById("submitText").innerHTML = "<p id='submitText' style='display: block; '><button type='submit' value='<?php echo TRADERESOURCES;?> (1/2)' id='npc_market_button' class='green build' onclick='javascript:portionOut();'><div class='button-container addHoverClick'><div class='button-background'><div class='buttonStart'><div class='buttonEnd'><div class='buttonMiddle'></div></div></div></div><div class='button-content'><?php echo REDISTRIBUTERESOURCES;?> (1/2)</div></div></button></p>";
        ...
        <form method="post" name="snd" action="build.php">
            ...
            <table id="npc" cellpadding="1" cellspacing="1">
                ...
                <tr>
                    ...
                    <td class="all">
                        <a href="javascript:fillup(0);"><img class="r1" src="/assets/images/x.gif" alt="Wood" title="Wood"/></a>
                        <span id="org0"><?php echo floor($village->awood); ?></span>
                    </td>

                    <td class="all">
                        <a href="javascript:fillup(1);"><img class="r2" src="/assets/images/x.gif" alt="Clay" title="Clay"/></a>
                        <span id="org1"><?php echo floor($village->aclay); ?></span>
                    </td>

                    <td class="all">
                        <a href="javascript:fillup(2);"><img class="r3" src="/assets/images/x.gif" alt="Iron" title="Iron"/></a>
                        <span id="org2"><?php echo floor($village->airon); ?></span>
                    </td>

                    <td class="all">
                        <a href="javascript:fillup(3);"><img class="r4" src="/assets/images/x.gif" alt="Crop" title="Crop"/></a>
                        <span id="org3"><?php echo floor($village->acrop); ?></span>
                    </td>

                    <td class="sum"><?php echo TOTAL; ?>:&nbsp;<span
                ...
                <tr>
                    ...
                    <td class="sum"><?php echo REMINDERS; ?>:&nbsp;<span id="remain">
            ...
            <p id="submitButton" style="display: block; ">
                ...
                <button type="submit" value="<?php echo TRADERESOURCES; ?> (2/2)" id="npc_market_button"
                        class="green build"
                    ...
                    <div class="button-container addHoverClick">
                        ...
                        <div class="button-content"><?php echo TRADERESOURCES; ?> (2/2)
                        </div>
                    </div>
                </button>
                <span class="npc_price"><b>3</b><img src="/assets/images/x.gif" class="gold"/> <?php echo GOLD; ?></span></p>
            <?php } else {
                echo "<a href=\"plus.php\"><span class=\"none\">" . NOTENOUGHGOLD . "</span></a>";
            } ?></p>
            <p id="submitText"></p>
        </form>
        <script>
