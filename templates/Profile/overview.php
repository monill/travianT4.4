...
<?php
if ($_GET['uid'] == 2) {
    echo '<img src="/assets/images/t/t10_2.jpg" border="0">';
} else {
...
<table cellpadding="1" cellspacing="1" id="details" class="transparent">
    <tr>
        <th>
            <img src="/assets/images/icon/Rank.png"><b><?php echo PF_RANK; ?>
        </th>
    ...
    <tr>
        <th>
            <img src="/assets/images/icon/Tribe.png"><b><?php echo TRIBE; ?>
        </th>
        <td>
            <?php
    ...
    <tr>
        <th>
            <img src="/assets/images/icon/Ally.png"><b><?php echo AL_ALLIANCE; ?>
        </th>
        <td>
            <?php
    ...
    <tr>
        <th>
            <img src="/assets/images/icon/Home.png"><b><?php echo VILLAGES; ?>
        </th>
        <td><?php echo count($varray); ?></td>
    </tr>
    <tr>
        <th>
            <img src="/assets/images/icon/Populations.png"><b>Population
        </th>
    ...
    if (isset($displayarray['birthday']) && $displayarray['birthday'] != 0) {
        ...
        echo "<tr><th>
        <img src='/assets/images/icon/Brithday.png'><b>" . PF_BIRTHDAY . "</th><td>$age</td></tr></b>";
    }
    //Gender
    if (isset($displayarray['gender']) && $displayarray['gender'] != 0) {
        ...
        echo "<tr>
			        <th>
        <img src='/assets/images/icon/Gender.png'><b>" . Gender . "</th><td>" . $gender . "</td></tr></b>";
    }
    //Location
    if ($displayarray['location'] != "") {
        echo "<tr><th>
        <img src='/assets/images/icon/location.png'><b>" . AT_LOCATION . ":</th><td>" . $displayarray['location'] . "</td></tr></b>";
    }
    ?>
    <tr>
        <?php
        ...
        foreach ($varray as $vil) {
            ...
            while ($row = mysql_fetch_array($sql2)) {
                ...
                switch ($type) {
                    case 1:
                    case 2:
                        echo "<img class='r1' src='/assets/images/x.gif' title='" . VL_WOOD . "'>";
                        break;
                    case 3:
                        echo "<img class='r1' src='/assets/images/x.gif' title='" . VL_WOOD . "'> <img class='r4' src='/assets/images/x.gif' title='" . VL_CROP . "'>";
                        break;
                    case 4:
                    case 5:
                        echo "<img class='r2' src='/assets/images/x.gif' title='" . VL_CLAY . "'>";
                        break;
                    case 6:
                        echo "<img class='r2' src='/assets/images/x.gif' title='" . VL_CLAY . "'> <img class='r4' src='/assets/images/x.gif' title='" . VL_CROP . "'>";
                        break;
                    case 7:
                    case 8:
                        echo "<img class='r3' src='/assets/images/x.gif' title='" . VL_IRON . "'>";
                        break;
                    case 9:
                        echo "<img class='r3' src='/assets/images/x.gif' title='" . VL_IRON . "'> <img class='r4' src='/assets/images/x.gif' title='" . VL_CROP . "'>";
                        break;
                    case 10:
                    case 11:
                    case 12:
                        echo "<img class='r4' src='/assets/images/x.gif' title='" . VL_CROP . "'>";
                        break;
                }
            }
            echo "</td>";
...
<script type="text/javascript">
    window.addEvent('domready', function() {
        ...
        var renderPlayerMessageIgnoreButtons = function() {
            var targetPlayer = '<?php echo (int)$_GET['
        uid ']; ?>';
            Travian.ajax({
                data: {
                    cmd: 'ignoreList',
        ...
        $$('#player_message-ignore-buttons-block').addEvent("click:relay('a#ignore-player-button')", function(
            event) {
