<h1 class="titleInHeader"><?php echo B28; ?> <span
    ...
    <div class="build_desc">
        <a href="#" onClick="return Travian.Game.iPopup(28,4);" class="build_logo">
            <img class="building big white g28" src="/assets/images/x.gif" alt="<?php echo B28; ?>"
                 title="<?php echo B28; ?>"/></a>
        <?php echo B28_DESC; ?></div>


    <table cellpadding="1" cellspacing="1" id="build_value">
        <tr>
            <th><?php echo MK_MERCHSHIPCAP; ?>:</th>
        ...
        if (!$building->isMax($village->resarray['f' . $id . 't'], $id)) {
            ...
            for ($nc = 1; $nc <= $ll; $nc++) {
                ...
                <tr <?php if ($nc < $nli) echo 'style="color:#F88C1F;"'; ?>>
                    <th><?php echo BL_MERCHSHIPCAP . ' ' . ($village->resarray['f' . $id] + $nc); ?>:</th>
                    <td><b><?php echo $bid28[$village->resarray['f' . $id] + $nc]['attri']; ?>%</b></td>
                </tr>
                <?php
            }
        }
