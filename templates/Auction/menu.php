            ...
            <div class="exchangeLine">
                <form method="post" action="#">
                    <div class="directionButtons">
                        <button class="directionButton GoldToSilver active"><img src="/assets/images/x.gif" class="gold" alt="Gold"><img src="/assets/images/x.gif" class="arrow" alt=""><img src="/assets/images/x.gif" class="silver" alt="Silver"></button>
                        <button class="directionButton SilverToGold"><img src="/assets/images/x.gif" class="silver" alt="Silver"><img src="/assets/images/x.gif" class="arrow" alt=""><img src="/assets/images/x.gif" class="gold" alt="Gold"></button>
                    </div>
                    <div class="exchangeTypeGoldToSilver exchangeType active">
                        <button type="button" value="GoldToSilver" id="button53089fa729927" class="gold " coins="1">
                            <div class="button-container addHoverClick">
                                ...
                                <div class="button-content"><?php echo HR_EXCHANGE; ?><img src="/assets/images/x.gif" class="goldIcon" alt=""><span class="goldValue">1</span></div>
                            </div>
                        </button>
                                ...
                                if ($('button53089fa729927')) {
                                    $('button53089fa729927').addEvent('click', function() {
                                        window.fireEvent('buttonClicked', [this, {
                                            ...
                                            "value": "GoldToSilver",
                                            "name": "",
                                            "id": "button53089fa729927",
                                            "class": "gold ",
                                            "title": "<?php echo HR_CONVERTNOW; ?>",
                                            "confirm": "",
                                            "onclick": "",
                                            "coins": "1",
                                            "wayOfPayment": {
                        ...
                        <div class="exchangeItem formularDirectionLTR">
                            <span class="silverExchangeFormularTerm"><img src="/assets/images/x.gif" class="gold" alt="Gold"></span>
                            ...
                            <span class="silverExchangeFormularTerm">=</span>
                            <span class="silverExchangeFormularTerm resultTerm"><img src="/assets/images/x.gif" class="silver" alt="Silver"><span class="silverResult">100</span></span>
                        </div>
                    ...
                    <div class="exchangeTypeSilverToGold exchangeType">
                                ...
                                if ($('button53089fa729ae2')) {
                                    $('button53089fa729ae2').addEvent('click', function() {
                                        window.fireEvent('buttonClicked', [this, {
                                            ...
                                            "value": "SilverToGold",
                                            "name": "",
                                            "id": "button53089fa729ae2",
                                            "class": "green ",
                                            "title": "<?php echo HR_EXSILVERTOGOLD; ?>",
                                            "confirm": "",
                                            "onclick": ""
                                        }]);
                                    });
                        ...
                        <div class="exchangeItem formularDirection formularDirectionLTR">
                            <span class="silverExchangeFormularTerm"><img src="/assets/images/x.gif" class="silver" alt="Silver"></span>
                            <span class="silverExchangeFormularTerm"><input id="exchangeSilverToGoldInput" class="silverInput text" value="200" type="text"></span>
                            <span class="silverExchangeFormularTerm">÷</span>
                            <span class="silverExchangeFormularTerm">200</span>
                            <span class="silverExchangeFormularTerm">=</span>
                            <span class="silverExchangeFormularTerm resultTerm"><img src="/assets/images/x.gif" class="gold" alt="Gold"><span class="goldResult">1</span></span>
                        </div>
            ...
            window.addEvent('domready', function() {
                ...
                var goldToSilverExchange = new Travian.Game.Hero.SilverExchange({
                    exchangeOptions: {
                        ...
                        resultValueElements: [{
                            setType: 'html',
                            element: $$('#silverExchange .exchangeTypeGoldToSilver .silverResult')[
                                0]
                        }],
                        inputValueElements: [{
                                setType: 'html',
                                element: $$(
                                    '#silverExchange .exchangeTypeGoldToSilver button.gold .goldValue'
                                )[0]
                            },
                            {
                                setType: 'coins',
                    ...
                    messages: {
                        ...
                        autoCorrect: {
                            type: 'notice',
                            message: "<?php echo HR_EXERROR2; ?>"
                        },
                        disabledSubmitTooltip: {
                            type: 'tooltip',
                            message: "<?php echo HR_EXERROR3; ?>"
                        },
                        enabledSubmitTooltip: {
                            type: 'tooltip',
                            message: "<?php echo HR_EXCHANGE; ?>"
                        },
                        maxAmountTooltip: {
                            type: 'tooltip',
                            message: "<?php echo HR_EXERROR4; ?>"
                        }
                    }
                });
                ...
                window.showFinishedExchangeGoldToSilver = function(options, context) {
                    ...
                    goldToSilverExchange.overrideGoldAndSilver(options.oldGold, options.oldSilver, options
                        .newGold, options.newSilver);
...
<div class="contentNavi tabNavi">
    <div class="container <?php if (isset($_GET['action']) && $_GET['action'] == 'buy') {
        ...
        <div class="content"><a href="hero_auction.php?action=buy"><span class="tabItem"><?php echo 'buy'; ?></span></a>
        </div>
    </div>
