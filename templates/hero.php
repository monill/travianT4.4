                            ...
                            <div class='boxes-contents'>
                                <div class='attribute'>
                                    <?php if ($database->getHeroData2($session->uid)) {
                                        echo "<img class=\"heroStatus100\" src=\"/assets/images/x.gif\" title=\"" . HERO_STATUS . "\" />";
                                    } else if (!$checkT) {
                                        echo "<img class=\"heroStatus101\" src=\"/assets/images/x.gif\" title=\"" . HERO_ALREADYDEAD . "\" />";
                                    } else if ($checkT) {
                                        echo "<img class=\"heroStatus100\" src=\"/assets/images/x.gif\" title=\"" . HERO_INREVIVE . "\" />";
                                    }
                                ...
                                <?php if ($hero['dead'] == 0) { ?>
                                    <div class="attribute health tooltip">
                                        ...
                                        <div class="element current powervalue"><span class="value">‎‭‭<?php echo round($hero['health']); ?></span>%
                                        </div>
                                        <div class="element progress">
                                            <div class="bar-bg">
                                                ...
                                                ?>
                                                <div class="bar" style="width:<?php echo $hero['health']; ?>%;background-color:<?php echo $color; ?>">
                                                </div>
                                                <div class="clear"></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="regenerateCosts">
                                            <div class="showCosts">
                                                ...
                                                <?php if (round($village->awood) < $hero_t[$hero['level']]['wood'] || round($village->aclay) < $hero_t[$hero['level']]['clay'] || round($village->airon) < $hero_t[$hero['level']]['iron'] || round($village->acrop) < $hero_t[$hero['level']]['crop']) { ?>
                                                    <span class="clock">
                                                        <img class="clock" src="/assets/images/x.gif" title="Time">
                                                        <?php echo $generator->getTimeFormat(round(($hero_t[$hero['level']]['time'] / SPEED * 1.5))); ?>
                                                    </span>
                                                    <button type="button" value="" class="icon" onclick="window.location.href = 'build.php?gid=17&amp;t=3&amp;r1=<?php echo $hero_t[$hero['level']]['wood']; ?>&amp;r2=<?php echo $hero_t[$hero['level']]['clay']; ?>&amp;r3=<?php echo $hero_t[$hero['level']]['iron']; ?>&amp;r4=<?php echo $hero_t[$hero['level']]['crop']; ?>'; return false;">
                                ...
                                <div class="attribute experience tooltip">
                                    ...
                                    <div class="element current powervalue experience points">
                                        <?php echo $hero['experience']; ?></div>
                                    <div class="element progress">
                                        <div class="bar-bg">
                                ...
                                <div class="clear"></div>
                                <div class="attribute">
                                    <div class="speed tooltip" title="<?php echo HERO_SPEED; ?>&lt;br /&gt;&lt;span class=&quot;heroAttributeInformation&quot;&gt;<?php echo HERO_SPEED2 . ":" . $hero['speed'] . HERO_HPERH; ?>&lt;/span&gt;">
                                        <div class="element attribName"><?php echo HERO_SPEED2; ?>:</div>
                                        <div class="element powervalue">
                                            <span class="current"><?php echo $hero['speed']; ?></span>
                                            <?php echo HERO_HPERH2; ?>
                                        </div>
                                    </div>
                                    <div class="production tooltip" title="<?php echo HERO_HEROPRODDESC; ?>&lt;br /&gt;&lt;span class=&quot;heroAttributeInformation&quot;&gt;Hero&acute;s production&lt;img title=&quot;<?php echo HERO_ALLRES; ?>&quot; class=&quot;r0&quot; src=&quot;/assets/images/x.gif&quot; /&gt;12 &lrm;&amp;#x202d;&amp;#x202d;0&amp;#x202c;&amp;#x202c;&lrm;6&lt;/span&gt;">
                                        <span>

                                            <?php
                                            echo HERO_HEROPRODTITLE;
                                            if ($hero['r0'] != 0) {
                                            ?>
                                                <label for="resourceHero0">
                                                    <img title="all resources" class="r0" src="/assets/images/x.gif">
                                                    <span class="value"> <?php echo $rp; ?></span>
                                                </label>
                                            <?php } else if ($hero['r1'] != 0) { ?>
                                                <label for="resourceHero1">
                                                    <img title="wood" class="r1" src="/assets/images/x.gif">
                                                    <span class="current">
                                                        <?php echo $hero['product'] * 10 * SPEED; ?></span>
                                                </label>
                                            <?php } else if ($hero['r2'] != 0) { ?>
                                                <label for="resourceHero2">
                                                    <img title="clay" class="r2" src="/assets/images/x.gif">
                                                    <span class="current">
                                                        <?php echo $hero['product'] * 10 * SPEED; ?></span>
                                                </label>
                                            <?php } else if ($hero['r3'] != 0) { ?>
                                                <label for="resourceHero3">
                                                    <img title="iron" class="r3" src="/assets/images/x.gif">
                                                    <span class="current">
                                                        <?php echo $hero['product'] * 10 * SPEED; ?></span>
                                                </label>
                                            <?php } else if ($hero['r4'] != 0) { ?>
                                                <label for="resourceHero4">
                                                    <img title="crop" class="r4" src="/assets/images/x.gif">
                                                    <span class="current">
                                                        <?php echo $hero['product'] * 10 * SPEED; ?></span>
                                                </label>
                                            <?php } ?>

                                            + <img alt="Crop" class="r4" src="/assets/images/x.gif"><span class="current">6</span>
                                        </span>
                                    </div>
                                    <div class="clear"></div>
                                </div>
                                ...
                                <br><br>
                                <button type="submit" value="ok" name="s1" id="btn_ok" class="green " title="<?php echo HERO_KILLHERO; ?>" onclick="window.location.href = 'hero_inventory.php?kill=him'; return false;">
                                    <div class="button-container addHoverClick">
                                        <div class="button-background">
                                            <div class="buttonStart">
                                                <div class="buttonEnd">
    ...
    <div class="boxes attr boxesColor gray">
        ...
        <div class="boxes-contents cf">
            <div class="openCloseSwitchBar">
                <img alt="Attributes" src="/assets/images/x.gif" class="openedClosedSwitch switchOpened">
            ...
            <div class="heroPropertiesContent ">
                <div class="attribute res" id="setResource">
                    ...
                    <div class="resource r0">
                        ...
                        <label for="resourceHero0">
                            <img alt="all resources" class="r0" src="/assets/images/x.gif"><span class="current"><?php echo $rp; ?></span>
                        </label>
                    </div>
                    <div class="resource r1">
                        ...
                        <label for="resourceHero1">
                            <img alt="wood" class="r1" src="/assets/images/x.gif"><span class="current"><?php echo $hero['product'] * 10 * SPEED; ?></span>
                        </label>
                    </div>
                    <div class="resource r2">
                        ...
                        <label for="resourceHero2">
                            <img alt="clay" class="r2" src="/assets/images/x.gif"><span class="current"><?php echo $hero['product'] * 10 * SPEED; ?></span>
                        </label>
                    </div>
                    <div class="resource r3">
                        ...
                        <label for="resourceHero3">
                            <img alt="iron" class="r3" src="/assets/images/x.gif"><span class="current"><?php echo $hero['product'] * 10 * SPEED; ?></span>
                        </label>
                    </div>
                    <div class="resource r4">
                        ...
                        <label for="resourceHero4">
                            <img alt="crop" class="r4" src="/assets/images/x.gif"><span class="current"><?php echo $hero['product'] * 10 * SPEED; ?></span>
                        </label>
                    </div>
                    <span>
                        + <img alt="crop" class="r4" src="/assets/images/x.gif"><span class="current">6</span>
                ...
                <div class="attribute attackBehaviour">
                    ...
                    <div class="options">
                        <input class="radio" id="attackBehaviourHide" name="attackBehaviour" value="hide" <?php if ($hero['hide'] == 1) {
                                                                                                                echo 'checked="checked"';
                                                                                                            } ?> type="radio"><label for="attackBehaviourHide"><?php echo HERO_WILLHIDE; ?></label>
                        <br><input class="radio" id="attackBehaviourFight" name="attackBehaviour" value="fight" <?php if ($hero['hide'] == 0) {
                                                                                                                    echo 'checked="checked"';
                                                                                                                } ?> type="radio"><label for="attackBehaviourFight"><?php echo HERO_WILLREMAIN; ?></label>
                    </div>
                </div>
                <div class="clear"></div>
                <table id="attributesOfHero" class="transparent attributes <?php if ($hero['points'] == 0) echo 'no'; ?>PointsToSet" cellpadding="0" cellspacing="0">
                    <thead>
                        <tr>
                            <th class="headline">
                                <?php echo HERO_ATTR; ?>
                    ...
                    <tbody>
                        <tr id="attributepower" class="attribute power">
                            ...
                            <td class="element current powervalue tooltip">
                                <span class="value">
                                    <?php echo 100 + $hero['fsperpoint'] * $hero['power'] + $hero['itemfs']; ?>
                                </span>
                            </td>
                ...
                <div class="saveHeroAttributes">
                    <button disabled="" type="button" value="<?php echo HERO_SAVECHANGE2; ?>" name="saveHeroAttributes" id="saveHeroAttributes" class="green disabled">
                        <div class="button-container addHoverClick">
                            <div class="button-background">
                                <div class="buttonStart">
                                    <div class="buttonEnd">
                            ...
                            if ($('saveHeroAttributes')) {
                                $('saveHeroAttributes').addEvent('click', function() {
                                    window.fireEvent('buttonClicked', [this, {
                                        "type": "button",
                                        "value": "<?php echo HERO_SAVECHANGE2; ?>",
            ...
            <script type="text/javascript">
                window.addEvent('domready', function() {
                    $$('.hero_inventory #attributes .openCloseSwitchBar').addEvent('click', function(e) {
                        Travian.toggleSwitch($$('.hero_inventory #attributes .heroPropertiesContent'), $$(
                            '.hero_inventory #attributes .openCloseSwitchBar .openedClosedSwitch'));
                        $$('.hero_inventory #attributes .openCloseSwitchBar .availablePoints').toggleClass(
                            'hide');
                    });
