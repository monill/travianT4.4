<div id='village_map'>
    ...
    if (DIRECTION == 'ltr') {
        ...
        $coords = array(
            19 => "518,135,496,120,496,121,468,122,449,136,449,151,470,163,500,163,519,149",
    ...
    if ($village->resarray['f40'] == 0) {
        if ($building->walling()) {
            $wtitle = $building->procResType($building->walling()) . " Level " . $village->resarray['f40'];
            echo "<img src=\"/assets/images/x.gif\" class=\"wall g3" . $session->tribe . "Top \" alt=\"$wtitle level " . $village->resarray['f40'] . "\">";
            echo "<img src=\"/assets/images/x.gif\" class=\"wall g3" . $session->tribe . "bBottom \" alt=\"$wtitle level " . $village->resarray['f40'] . "\">";
        }
    } else {
        $wtitle = $building->procResType($building->walling()) . " Level " . $village->resarray['f40'];
        echo "<img src=\"/assets/images/x.gif\" class=\"wall g3" . $session->tribe . "Top \" alt=\"$wtitle level " . $village->resarray['f40'] . "\">";
        echo "<img src=\"/assets/images/x.gif\" class=\"wall g3" . $session->tribe . "Bottom \" alt=\"$wtitle level " . $village->resarray['f40'] . "\">";
    }
    echo "</map>";
    for ($i = 1; $i <= 20; $i++) {
        if (($village->resarray['f99t'] == 40 and ($i + 18) == '26') or ($village->resarray['f99t'] == 40 and ($i + 18) == '30') or ($village->resarray['f99t'] == 40 and ($i + 18) == '31') or ($village->resarray['f99t'] == 40 and ($i + 18) == '32')) {
            ...
            echo "<img style='" . $style[$i] . "' src=\"/assets/images/x.gif\" class=\"building d$i $img\" alt=\"$text\" />";
            //set event last quest firework..hooooray!!
            if ($_SESSION['qst'] == 38) {
                if ($i < 8) {
                    $dte = array("rocket_green", "rocket_red", "rocket_purp", "rocket_yell", "rocket_oran", "rocket_tur", "", "");
                    $im = $dte[$i];
                    echo "<img src=\"/assets/images/x.gif\" class=\"building d$i rocket $im\" alt=\"$text\" />";
                }
            }
        }
    }
    ...
    if ($village->resarray['f39'] == 0) {
        if ($building->rallying()) {
            if ($village->resarray['f99t'] == 40) {
                echo "<img src=\"/assets/images/x.gif\" class=\"building g16b_ww\" alt=\"Rally point Level " . $village->resarray['f39'] . "\" />";
            } else {
                echo "<img src=\"/assets/images/x.gif\" class=\"building g16b\" alt=\"Rally point Level " . $village->resarray['f39'] . "\" />";
            }
        } else {
            if ($village->resarray['f99t'] == 40) {
                echo "<img src=\"/assets/images/x.gif\" class=\"building g16e_ww\" alt=\"building site\" />";
            } else {
                echo "<img src=\"/assets/images/x.gif\" class=\"building g16e\" alt=\"building site\" />";
            }
        }
    } else {
        if ($village->resarray['f99t'] == 40) {
            echo "<img src=\"/assets/images/x.gif\" class=\"building g16_ww\" alt=\"Rally point Level " . $village->resarray['f39'] . "\" />";
        } else {
            echo "<img src=\"/assets/images/x.gif\" class=\"building g16\" alt=\"Rally point Level " . $village->resarray['f39'] . "\" />";
        }
    }

    if ($village->resarray['f99t'] == 40) {
        if ($village->resarray['f99'] >= 0 && $village->resarray['f99'] <= 9) {
            echo '<img class="ww g40 g40_0" src="/assets/images/x.gif" alt="Wonder">';
        } elseif ($village->resarray['f99'] >= 10 && $village->resarray['f99'] <= 19) {
            echo '<img class="ww g40 g40_1" src="/assets/images/x.gif" alt="Wonder">';
        } elseif ($village->resarray['f99'] >= 20 && $village->resarray['f99'] <= 29) {
            echo '<img class="ww g40 g40_2" src="/assets/images/x.gif" alt="Wonder">';
        } elseif ($village->resarray['f99'] >= 30 && $village->resarray['f99'] <= 39) {
            echo '<img class="ww g40 g40_3" src="/assets/images/x.gif" alt="Wonder">';
        } elseif ($village->resarray['f99'] >= 40 && $village->resarray['f99'] <= 49) {
            echo '<img class="ww g40 g40_4" src="/assets/images/x.gif" alt="Wonder">';
        } elseif ($village->resarray['f99'] >= 50 && $village->resarray['f99'] <= 59) {
            echo '<img class="ww g40 g40_5" src="/assets/images/x.gif" alt="Wonder">';
        } elseif ($village->resarray['f99'] >= 60 && $village->resarray['f99'] <= 69) {
            echo '<img class="ww g40 g40_6" src="/assets/images/x.gif" alt="Wonder">';
        } elseif ($village->resarray['f99'] >= 70 && $village->resarray['f99'] <= 79) {
            echo '<img class="ww g40 g40_7" src="/assets/images/x.gif" alt="Wonder">';
        } elseif ($village->resarray['f99'] >= 80 && $village->resarray['f99'] <= 89) {
            echo '<img class="ww g40 g40_8" src="/assets/images/x.gif" alt="Wonder">';
        } elseif ($village->resarray['f99'] >= 90 && $village->resarray['f99'] <= 94) {
            echo '<img class="ww g40 g40_9" src="/assets/images/x.gif" alt="Wonder">';
        } elseif ($village->resarray['f99'] >= 95 && $village->resarray['f99'] <= 99) {
            echo '<img class="ww g40 g40_10" src="/assets/images/x.gif" alt="Wonder">';
        } elseif ($village->resarray['f99'] == 100) {
            echo '<img class="ww g40 g40_11" src="/assets/images/x.gif" alt="Wonder">';
        }
    }
    ...
    <div id="levels" <?php if (isset($_COOKIE['t4level'])) {
        ...
        <img src="/assets/images/x.gif" id="fswitch" <?php if (isset($_COOKIE['fsbuilder'])) {
...
" />
        ...
        <img src="/assets/images/x.gif" id="lswitch" <?php if (isset($_COOKIE['t4level'])) {
...
" />
        <img class='clickareas' usemap='#clickareas' src='/assets/images/x.gif' alt='' />
    </div>