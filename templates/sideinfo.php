            ...
            if ($('button5229e5254faf9')) {
                $('button5229e5254faf9').addEvent('click', function() {
                    window.fireEvent('buttonClicked', [this, {
                        ...
                        "speechBubble": "",
                        "class": "",
                        "id": "button5229e5254ffa5",
                        "redirectUrl": "<?php if ($x4 != 0 && $session->plus) {
                                            echo 'build.php?id=' . $x4;
                                        } ?>",
                        "redirectUrlExternal": ""
                        <?php if (!$session->plus) {
                            echo ',"plusDialog":{"featureKey":"directLinks","infoIcon":"#"}';
                        } ?>
                    }]);
                });
            }
            ...
            if ($('button5229e5254fc5c')) {
                $('button5229e5254fc5c').addEvent('click', function() {
                    window.fireEvent('buttonClicked', [this, {
                        ...
                        "class": "",
                        "id": "button5229e5254ffa5",
                        "redirectUrl": "<?php if ($x3 != 0 && $session->plus) {
                                            echo 'build.php?id=' . $x3;
                                        } ?>",
                        "redirectUrlExternal": ""
                        <?php if (!$session->plus) {
                            echo ',"plusDialog":{"featureKey":"directLinks","infoIcon":"#"}';
            ...
            if ($('button5229e5254fe6f')) {
                $('button5229e5254fe6f').addEvent('click', function() {
                    window.fireEvent('buttonClicked', [this, {
                        ...
                        "class": "",
                        "id": "button5229e5254ffa5",
                        "redirectUrl": "<?php if ($x2 != 0 && $session->plus) {
                                            echo 'build.php?id=' . $x2;
                                        } ?>",
                        "redirectUrlExternal": ""
                        <?php if (!$session->plus) {
                            echo ',"plusDialog":{"featureKey":"directLinks","infoIcon":"#"}';
            ...
            if ($('button5229e5254ffa6')) {
                $('button5229e5254ffa6').addEvent('click', function() {
                    window.fireEvent('buttonClicked', [this, {
                        ...
                        "speechBubble": "",
                        "class": "",
                        "id": "button5229e5254ffa6",
                        "redirectUrl": "<?php if ($x != 0 && $session->plus) {
                                            echo 'build.php?id=' . $x;
                                        } ?>",
                        "redirectUrlExternal": ""
                        <?php if (!$session->plus) {
            ...
            if ($('button5229e5255021d')) {
                $('button5229e5255021d').addEvent('click', function() {
                    window.fireEvent('buttonClicked', [this, {
                        ...
                        "villageDialog": {
                            "title": "<?php echo SI_CHANGEVILNAME; ?>",
                            "description": "<?php echo SI_NEWVILNAME; ?>",
                            "saveText": "<?php echo SI_SAVE; ?>",
