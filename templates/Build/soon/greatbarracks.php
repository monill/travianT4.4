...
<div class="build_desc">
    <a href="#" onclick="return Travian.Game.iPopup(29,4);" class="build_logo">
        <img class="building big white g29" src="/assets/images/x.gif" alt="<?php echo B29; ?>">
    </a>
...
<div id="contract" class="contract contractNew contractWrapper">
    ...
    <a href="#"
       onclick="return Travian.Game.iPopup(19,4, 'gid');"><?php echo B19; ?></a> <span><?php echo BL_LVL; ?> 20</span></span>
    </div>
    <div class="clear"></div>
</div>
<div class="clear"></div>
