...
class Natars
{
    ...
    {
        global $database;
        $myFile = dirname(__FILE__) . "/../templates/text.php";
        $fh = fopen($myFile, 'w');
        $text = file_get_contents(dirname(__FILE__) . "/../templates/text_format.php");
    ...
    private function releaseArchitects()
    {
        ...
        $aoe = 1;
        for ($i = 1; $i <= 6; $i++) {
            $this->createArtefactVillage(2, $type, 1, $arttitle, $vname, $desc, $effecttype, $effect, $aoe, 'type2.gif');
        }
        ...
        $aoe = 2;
        for ($i = 1; $i <= 4; $i++) {
            $this->createArtefactVillage(2, $type, 2, $arttitle, $vname, $desc, $effecttype, $effect, $aoe, 'type2.gif');
        }
        ...
        $aoe = 3;
        for ($i = 1; $i <= 1; $i++) {
            $this->createArtefactVillage(2, $type, 3, $arttitle, $vname, $desc, $effecttype, $effect, $aoe, 'type2.gif');
        }
    }
    ...
    private function releaseMilitaryHaste()
    {
        ...
        $aoe = 1;
        for ($i = 1; $i <= 6; $i++) {
            $this->createArtefactVillage(2, $type, 1, $arttitle, $vname, $desc, $effecttype, $effect, $aoe, 'type4.gif');
        }
        ...
        $aoe = 2;
        for ($i = 1; $i <= 4; $i++) {
            $this->createArtefactVillage(2, $type, 2, $arttitle, $vname, $desc, $effecttype, $effect, $aoe, 'type4.gif');
        }
        ...
        $aoe = 3;
        for ($i = 1; $i <= 1; $i++) {
            $this->createArtefactVillage(2, $type, 3, $arttitle, $vname, $desc, $effecttype, $effect, $aoe, 'type4.gif');
        }
    }
    ...
    private function releaseHawksEyesight()
    {
        ...
        $aoe = 1;
        for ($i = 1; $i <= 5; $i++) {
            $this->createArtefactVillage(2, $type, 1, $arttitle, $vname, $desc, $effecttype, $effect, $aoe, 'type5.gif');
        }
        ...
        $aoe = 2;
        for ($i = 1; $i <= 4; $i++) {
            $this->createArtefactVillage(2, $type, 2, $arttitle, $vname, $desc, $effecttype, $effect, $aoe, 'type5.gif');
        }
        ...
        $aoe = 3;
        for ($i = 1; $i <= 1; $i++) {
            $this->createArtefactVillage(2, $type, 3, $arttitle, $vname, $desc, $effecttype, $effect, $aoe, 'type5.gif');
        }
    }
    ...
    private function releaseTheDiet()
    {
        ...
        $aoe = 1;
        for ($i = 1; $i <= 6; $i++) {
            $this->createArtefactVillage(2, $type, 1, $arttitle, $vname, $desc, $effecttype, $effect, $aoe, 'type6.gif');
        }
        ...
        $aoe = 2;
        for ($i = 1; $i <= 4; $i++) {
            $this->createArtefactVillage(2, $type, 2, $arttitle, $vname, $desc, $effecttype, $effect, $aoe, 'type6.gif');
        }
        ...
        $aoe = 3;
        for ($i = 1; $i <= 4; $i++) {
            $this->createArtefactVillage(2, $type, 3, $arttitle, $vname, $desc, $effecttype, $effect, $aoe, 'type6.gif');
        }
    }
    ...
    private function releaseAcademicAdvancement()
    {
        ...
        $aoe = 1;
        for ($i = 1; $i <= 6; $i++) {
            $this->createArtefactVillage(2, $type, 1, $arttitle, $vname, $desc, $effecttype, $effect, $aoe, 'type8.gif');
        }
        ...
        $aoe = 2;
        for ($i = 1; $i <= 4; $i++) {
            $this->createArtefactVillage(2, $type, 2, $arttitle, $vname, $desc, $effecttype, $effect, $aoe, 'type8.gif');
        }
        ...
        $aoe = 3;
        for ($i = 1; $i <= 1; $i++) {
            $this->createArtefactVillage(2, $type, 3, $arttitle, $vname, $desc, $effecttype, $effect, $aoe, 'type8.gif');
        }
    }
    ...
    private function releaseRivalsConfusion()
    {
        ...
        $aoe = 1;
        for ($i = 1; $i <= 6; $i++) {
            $this->createArtefactVillage(2, $type, 1, $arttitle, $vname, $desc, $effecttype, $effect, $aoe, 'type7.gif');
        }
        ...
        $aoe = 2;
        for ($i = 1; $i <= 4; $i++) {
            $this->createArtefactVillage(2, $type, 2, $arttitle, $vname, $desc, $effecttype, $effect, $aoe, 'type7.gif');
        }
        ...
        $aoe = 3;
        for ($i = 1; $i <= 1; $i++) {
            $this->createArtefactVillage(2, $type, 3, $arttitle, $vname, $desc, $effecttype, $effect, $aoe, 'type7.gif');
        }
    }
    ...
    private function releaseStorageMasterPlan()
    {
        ...
        $aoe = 1;
        for ($i = 1; $i <= 6; $i++) {
            $this->createArtefactVillage(2, $type, 1, $arttitle, $vname, $desc, $effecttype, $effect, $aoe, 'type9.gif');
        }
        ...
        $aoe = 2;
        for ($i = 1; $i <= 4; $i++) {
            $this->createArtefactVillage(2, $type, 2, $arttitle, $vname, $desc, $effecttype, $effect, $aoe, 'type9.gif');
        }
    }
    ...
    private function releaseArtefactOfTheFool()
    {
        ...
        $aoe = 1;
        for ($i = 1; $i <= 6; $i++) {
            $this->createArtefactVillage(2, $type, 1, $arttitle, $vname, $desc, $effecttype, $effect, $aoe, 'type3.gif');
        }
        ...
        $aoe = 1;
        for ($i = 1; $i <= 1; $i++) {
            $this->createArtefactVillage(2, $type, 3, $arttitle, $vname, $desc, $effecttype, $effect, $aoe, 'type3.gif');
        }
    }
    ...
    public function checkGrayAreaInvasion($id)
    {
        ...
        if ($wdataState == true) {
            ...
            if ($distance <= NATARS_MAX) {
                ...
                $data = array();
                for ($i = 1; $i <= 3; $i++) {
                    $data['u1'] = rand(10000, 12000);
                    $data['u2'] = rand(20000, 30000);
                    $data['u3'] = 10000;
                    $data['u4'] = rand(50, 100);
                    $data['u5'] = rand(6000, 8000);
                    $data['u6'] = rand(5000, 10000);
                    $data['u7'] = rand(1000, 1500);
                    $data['u8'] = rand(100, 150);
                    $data['u9'] = 0;
                    $data['u10'] = 9;
                    $data['u11'] = 0;
        ...
        if ($wref) {
            ...
            if (!$upCatched) {
                ...
                if ($mainbuilding <= 0) {
                    ...
                    $ft = $f . 't';
                    $upCatched = true;
                } elseif ($mainbuilding < 5) {
                    $f = 'f26';
                    $fv = 5;
                    $ft = $f . 't';
                    $upCatched = true;
                } elseif ($mainbuilding < 10) {
                    $f = 'f26';
                    $fv = 10;
                    $ft = $f . 't';
                    $ftv = 15;
