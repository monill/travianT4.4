    ...
    <table id="short_info" cellpadding="1" cellspacing="1">
        <tbody>
            <tr>
                ...
                <td>
                    <a href="position_details.php?x=<?php echo $coor['x']; ?>&y=<?php echo $coor['y']; ?>">
                        <?php
        ...
        <tbody class="units">
            <tr>
                ...
                if (!isset($process['t11']) || $process['t11'] == '' || $process['t11'] == 0 || $process['t11'] == '0') {
                    ...
                    echo "<td><img src=\"/assets/images/x.gif\" class=\"unit uhero\" title=\"Hero\" alt=\"Hero\" /></td>";
                } ?>
            </tr>
            <tr>
                <th><?php echo UNITS; ?></th>
                <td <?php if (!isset($process['t1']) || $process['t1'] == '' || $process['t1'] == 0 || $process['t1'] == '0') {
                        echo "class=\"none\">0";
                    } else {
                        echo ">" . $process['t1'];
                    } ?></td>
                <td <?php if (!isset($process['t2']) || $process['t2'] == '' || $process['t2'] == 0 || $process['t2'] == '0') {
                        echo "class=\"none\">0";
                    } else {
                        echo ">" . $process['t2'];
                    } ?></td>
                <td <?php if (!isset($process['t3']) || $process['t3'] == '' || $process['t3'] == 0 || $process['t3'] == '0') {
                        echo "class=\"none\">0";
                    } else {
                        echo ">" . $process['t3'];
                    } ?></td>
                <td <?php if (!isset($process['t4']) || $process['t4'] == '' || $process['t4'] == 0 || $process['t4'] == '0') {
                        echo "class=\"none\">0";
                    } else {
                        echo ">" . $process['t4'];
                    } ?></td>
                <td <?php if (!isset($process['t5']) || $process['t5'] == '' || $process['t5'] == 0 || $process['t5'] == '0') {
                        echo "class=\"none\">0";
                    } else {
                        echo ">" . $process['t5'];
                    } ?></td>
                <td <?php if (!isset($process['t6']) || $process['t6'] == '' || $process['t6'] == 0 || $process['t6'] == '0') {
                        echo "class=\"none\">0";
                    } else {
                        echo ">" . $process['t6'];
                    } ?></td>
                <td <?php if (!isset($process['t7']) || $process['t7'] == '' || $process['t7'] == 0 || $process['t7'] == '0') {
                        echo "class=\"none\">0";
                    } else {
                        echo ">" . $process['t7'];
                    } ?></td>
                <td <?php if (!isset($process['t8']) || $process['t8'] == '' || $process['t8'] == 0 || $process['t8'] == '0') {
                        echo "class=\"none\">0";
                        $kata = '0';
                    } else {
                        $kata = '1';
                ...
                <td <?php if (!isset($process['t9']) || $process['t9'] == '' || $process['t9'] == 0 || $process['t9'] == '0') {
                        echo "class=\"none\">0";
                    } else {
                        echo ">" . $process['t9'];
                    } ?></td>
                <td <?php if (!isset($process['t10']) || $process['t10'] == '' || $process['t10'] == 0 || $process['t10'] == '0') {
                        echo "class=\"none\">0";
                    } else {
                        echo ">" . $process['t10'];
                    } ?></td>
