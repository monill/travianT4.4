...
<div id="gtour">
    ...
    <div class="col2row">
        <div class="col1"><img src="/assets/images/x.gif" class="slide slide2_1" alt="" border="0" /></div>
        <div class="col2"><img src="/assets/images/x.gif" class="slide slide2_2" alt="" border="0" /></div>
    </div>
    <div class="col2row">
        <div class="col1round">
            <div class="grlt"></div>
    ...
    <div class="col2row-text">
        ...
        <br /><br />
        Before you expand your village's buildings, you should develop some resource fields to increase your resource
        production.
    </div>
