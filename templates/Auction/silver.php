    ...
    <tbody>
        ...
        ?>
            <td colspan="2" style="background-color:#edeceb;">
                <a onClick="$('setResource').showOrHide('arrow');$('hidehero').showOrHide('arrow');$('exp').showOrHide('arrow');" class="showPWForgottenLink">
                    <img class="open2" id="arrow" src="/assets/images/x.gif">
                    <font color=black> <?php echo HR_DEALING; ?> </font>
                </a>
                <br />
                <br /></div>
            </td>
