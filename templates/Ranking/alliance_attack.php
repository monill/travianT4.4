...
if (isset($_POST['name']) && $_POST['name'] != '') {
    ...
    $myrank = $ranking->getAllianceAttRank($mydata['id']);
    ...
    $myrank = $_POST['rank'];
    $mr = $ranking->procAllianceAttRanking();
    $i = 0;
...
<h4 class="round"><?php echo PF_TOPATTACKINGALLIANCES; ?></h4>
...
<table cellpadding="1" cellspacing="1" id="alliance" class="row_table_data">
    ...
    <tbody>
        ...
        if ($page == "1" && $lastPage == "1") {
            ...
            $paginationDisplay .= '<img alt="' . PREVPAGE . '" src="/assets/images/x.gif" class="previous disabled">';
            $paginationDisplay .= $centerPages;
            $paginationDisplay .= '<a class="next" href="?tid=41&page=' . $nextPage . '"><img alt="' . NEXTPAGE . '" src="/assets/images/x.gif"></a> ';
            $paginationDisplay .= '<a class="last" href="?tid=41&page=' . $lastPage . '"><img alt="' . LASTPAGE . '" src="/assets/images/x.gif"></a>';
        } elseif ($page != "1" && $page != $lastPage) {
            $paginationDisplay .= '<a class="first" href="?tid=41&page=1"><img alt="' . FIRSTPAGE . '" src="/assets/images/x.gif"></a> ';
            $paginationDisplay .= '<a class="previous" href="?tid=41&page=' . $previous . '"><img alt="' . PREVPAGE . '" src="/assets/images/x.gif"></a>';
            $paginationDisplay .= $centerPages;
            $paginationDisplay .= '<a class="next" href="?tid=41&page=' . $nextPage . '"><img alt="' . NEXTPAGE . '" src="/assets/images/x.gif"></a> ';
            $paginationDisplay .= '<a class="last" href="?tid=41&page=' . $lastPage . '"><img alt="' . LASTPAGE . '" src="/assets/images/x.gif"></a>';
        ...
        $ar = $ranking->procAllianceAttRanking($limit);
        ...
        if ($ar) {
            while ($row = mysql_fetch_array($ar)) {
                if ($row['memcount'] > 0) {
                    ...
                    echo "<td class=\"po lc\">" . $row['Aap'] . "</td></tr>";
                    $rank++;
                }
            }
        }
