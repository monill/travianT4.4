                        ...
                        <div class="mc">
                            <div class="contents">
                                ...
                                <div class="iconButton iconRequireGold" id="iconCropfinder">
                                    <a href="cropfinder.php">
                                        <div class="iconButton linkCropfinder" title="<?= CROPFINDER ?>"></div>
                                    </a>
                                </div>
            ...
            var fnDelayMe = function() {
                ...
                var fnInit = function() {
                    ...
                    Travian.Game.Map.Tips.tooltipHtml =
                        '<span class=\"coordinates coordinatesWrapper\"><span class=\"coordinateX\">({x}<\/span><span class=\"coordinatePipe\">|<\/span><span class=\"coordinateY\">{y})<\/span><\/span>';
                    Travian.Game.Map.Options.Default.block.tooltipHtml =
                        '<span class=\"coordinates coordinatesWrapper\"><span class=\"coordinateX\">({x}<\/span><span class=\"coordinatePipe\">|<\/span><span class=\"coordinateY\">{y})<\/span><\/span><br />{k.loadingData}';
