    ...
    if ($technology->getTech($i)) {
        echo "<div class=\"action first\">
					...
					<div class=\"details\">
                        ...
                        <div class=\"showCosts\">
                        <span class=\"resources r1\"><img class=\"r1\" src=\"/assets/images/x.gif\" alt=\"" . VL_WOOD . "\">" . (${'u' . $i}['wood'] * 3) . "</span>
                        <span class=\"resources r2\"><img class=\"r2\" src=\"/assets/images/x.gif\" alt=\"" . VL_CLAY . "\">" . (${'u' . $i}['clay'] * 3) . "</span>
                        <span class=\"resources r3\"><img class=\"r3\" src=\"/assets/images/x.gif\" alt=\"" . VL_IRON . "\">" . (${'u' . $i}['iron'] * 3) . "</span>
                        <span class=\"resources r4\"><img class=\"r4\" src=\"/assets/images/x.gif\" alt=\"" . VL_CROP . "\">" . (${'u' . $i}['crop'] * 3) . "</span>
                        <span class=\"resources r5\"><img class=\"r5\" src=\"/assets/images/x.gif\" alt=\"" . VL_UPKEEP . "\">" . ${'u' . $i}['pop'] . "</span>
                        <div class=\"clear\"></div>
                        <span class=\"clocks\"><img class=\"clock\" src=\"/assets/images/x.gif\" alt=\"" . AT_HRS . "\">";
        $each = $bid30[$village->resarray['f' . $id]]['attri'] * ($building->getTypeLevel(41) >= 1 ? (1 / $bid41[$building->getTypeLevel(41)]['attri']) : 1);
