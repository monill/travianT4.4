<h1 class="titleInHeader"><?php echo B2; ?>
    <span class="level">
        <?php echo BL_LVL . ' ' . $village->resarray['f' . $id]; ?>
    </span>
</h1>
<div id="build" class="gid2">
    <div class="build_desc">
        <a href="#" onClick="return Travian.Game.iPopup(2,4);" class="build_logo">
            <img class="building big white g2" src="/assets/images/x.gif" alt="<?php echo B2; ?>" title="<?php echo B2; ?>" />
        </a>
        <?php echo B2_DESC; ?>
    </div>
    ...
    <table cellpadding="1" cellspacing="1" id="build_value">
        ...
        <tr <?php if ($nc < $nli) echo 'style="color:#F88C1F;"'; ?>>
            ...
            <td>
                <b><?php echo $bid2[$village->resarray['f' . $id] + $nc]['prod'] * SPEED; ?></b> <?php echo PER_HR; ?>
            </td>
        </tr>
        <?php
            }
