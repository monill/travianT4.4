...
?>
    ...
    <h4><a href="allianz.php?s=2&pid=<?php echo $arr['alliance']; ?>"><?php echo AL_ALLIANCE; ?></a> -> <a href="allianz.php?s=2&pid=<?php echo $arr['alliance']; ?>&fid=<?php echo $arr['cat']; ?>"><?php echo $CatName; ?></a>
    </h4>
    <table cellpadding="1" cellspacing="1" id="posts">
            ...
            ?>
                ...
                <tr>
                    <td colspan="2" class="poll">
                        <form action="allianz.php?s=2&fid2=<?php echo $_GET['fid2']; ?>&pid=<?php echo $_GET['pid']; ?>&tid=<?php echo $_GET['tid']; ?>" method="post" id="Form1">
                                ...
                                <tbody>
                                    <tr>
                                        <?php if ($q['p1_name'] != '') { ?>
                                            ...
                                            <td class="stat">
                                                <input class="radio" type="radio" name="vote_option" value="306" />
                                            </td>
                                            ...
                                            <td style="position:absolute;left:100px">
                                                <img class="poll" src="/assets/images/x.gif" width='<?php echo round($q['p1'], 2); ?>' height='15'>
                                    ...
                                    <?php }
                                        ...
                                        <td class="stat">
                                            <input class="radio" type="radio" name="vote_option" value="307" />
                                        </td>
                                        <!--<td class="count"><?php if (isset($_GET['resolt']) || $yes == 1) {
                                                                    echo $q['p2'];
                                                                } else {
                                        ...
                                        <td style="position:absolute;left:100px">
                                            <img class="poll" src="/assets/images/x.gif" width='<?php echo round($q['p2'], 2); ?>' height='15'>
                                    ...
                                    <?php }
                                        ...
                                        <td class="stat">
                                            <input class="radio" type="radio" name="vote_option" value="308" />
                                        </td>
                                        <!--<td class="count"><?php if (isset($_GET['resolt']) || $yes == 1) {
                                                                    echo $q['p3'];
                                                                } else {
                                        ...
                                        <td style="position:absolute;left:100px">
                                            <img class="poll" src="/assets/images/x.gif" width='<?php echo round($q['p3'], 2); ?>' height='15'>
                                    ...
                                    <?php }
                                        ...
                                        <td class="stat">
                                            <input class="radio" type="radio" name="vote_option" value="309" />
                                        </td>
                                        <!--<td class="count"><?php if (isset($_GET['resolt']) || $yes == 1) {
                                                                    echo $q['p4'];
                                                                } else {
                                        ...
                                        <td style="position:absolute;left:100px">
                                            <img class="poll" src="/assets/images/x.gif" width='<?php echo round($q['p4'], 2); ?>' height='15'>
                                        ...
                                        <button type="submit" value="1" name="vote" id="fbtn_vote" class="green ">
                                            ...
                                            if ($yes != 1) {
                                                if (!isset($_GET['resolt'])) {
                                                    if (empty($arr['close'])) {
                                            ?>
                                                        <button type="button" value="vote" class="build" onclick="submitform1();">
                                                    ...
                                                    <button type="button" value="To vote" class="build" onclick="window.location.href = 'allianz.php?s=2&fid2=<?php echo $_GET['fid2']; ?>&pid=<?php echo $_GET['pid']; ?>&tid=<?php echo $_GET['tid']; ?>'">
                                                        <div class="button-container">
                                                            <div class="button-position">
                                                                <div class="btl">
                                                                    <div class="btr">
                                            ...
                                            <?php if (!isset($_GET['resolt']) && $yes != 1) { ?>
                                                <button type="button" value="Result" class="build" onclick="window.location.href = 'allianz.php?s=2&fid2=<?php echo $_GET['fid2']; ?>&pid=<?php echo $_GET['pid']; ?>&tid=<?php echo $_GET['tid']; ?>&resolt'">
                                                    <div class="button-container">
                                                        <div class="button-position">
                                                            <div class="btl">
                                                                <div class="btr">
        ...
        <tbody>
            <tr>
                <td class="pinfo"><a class="name" href="spieler.php?uid=<?php echo $arr['owner']; ?>"><?php echo $owner['username']; ?></a><br /><img class="avatarHead" title="<?php echo $owner['username']; ?>" alt="<?php echo $owner['username']; ?>" src="hero_image.php?uid=<?php echo $arr['owner']; ?>&amp;size=forum" border="0" /><br /><a href="allianz.php?aid=<?php echo $allianceinfo['id']; ?>"><?php echo $allianceinfo['tag']; ?></a><br />
                ...
                <td class="pcontent">
                    ...
                    if ($database->CheckEditRes($aid) == "1") {
                        echo '<div class="admin"><a class="edit" href="allianz.php?s=2&pid=' . $arr['alliance'] . '&idf=' . $arr['cat'] . '&idt=' . $arr['id'] . '&admin=editans"><img src="/assets/images/x.gif" title="Edit" alt="Edit" /></a><a class="fdel" href="?s=2&pid=' . $arr['alliance'] . '&tid=' . $arr['id'] . '&admin=deltopic" onClick="return confirm(\'confirm delete?\');"><img src="/assets/images/x.gif" title="delete" alt="delete" /></a></div><br />';
                    }
                    ?>
		...
		<td class="pcontent"><div class="posted">created:  ' . $date . '</div>';
                if ($database->CheckEditRes($aid) == "1") {
                    echo '<div class="admin"><a class="edit" href="allianz.php?s=2&pid=' . $arr['alliance'] . '&idt=' . $_GET['tid'] . '&pod=' . $po['id'] . '&admin=editpost"><img src="/assets/images/x.gif" title="Edit" alt="Edit" /></a><a class="fdel" href="?s=2&pid=' . $arr['alliance'] . '&tid=' . $arr['id'] . '&admin=deltopic" onClick="return confirm(\'confirm delete?\');"><img src="/assets/images/x.gif" title="delete" alt="delete" /></a></div><br />';
                }
    ...
    <div style="margin-top: 15px;">
        ...
        ?>
            <div class="buttonBox">
                <button type="button" value="reply" id="fbtn_reply" class="green " onclick="window.location.href = 'allianz.php?s=2&pid=<?php echo $arr['alliance']; ?>&tid=<?php echo $arr['id']; ?>&ac=newpost'; return false;">
        ...
        if ($opt['opt5'] == 1) {
        ?>
            <div class="buttonBox"><a href="allianz.php?s=2&pid=<?php echo $aid; ?>&tid=<?php echo $arr['id']; ?>&admin=switch_admin" title="Toggle Admin mode"><img class="switch_admin dynamic_img" src="/assets/images/x.gif" alt="Toggle Admin mode" /></a></div>
    <?php
        }
