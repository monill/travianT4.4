...
<div align="center">
    <ul class="tabs">
        <center>
            <li>All players (<?php echo $query; ?>)</li>
        </center>
    </ul>
</div>
<table id="member" border="1" cellpadding="3" align="center" dir="ltr">
    ...
    if ($page <= 1 && $lastPage <= 1) {
        ...
        $centerPages .= '<a class="number" href="index.php?p=players&page=2">2</a>';
    } elseif ($page == 1 && $lastPage == 3) {
        $centerPages .= '<span class="number currentPage">' . $page . '</span> ';
        $centerPages .= '<a class="number" href="index.php?p=players&page=2">2</a> ';
        $centerPages .= '<a class="number" href="index.php?p=players&page=3">3</a>';
    } elseif ($page == 1) {
        $centerPages .= '<span class="number currentPage">' . $page . '</span> ';
        $centerPages .= '<a class="number" href="index.php?p=players&page=' . $add1 . '">' . $add1 . '</a> ';
        $centerPages .= '<a class="number" href="index.php?p=players&page=' . $add2 . '">' . $add2 . '</a> ... ';
        $centerPages .= '<a class="number" href="index.php?p=players&page=' . $lastPage . '">' . $lastPage . '</a>';
    } else if ($page == $lastPage && $lastPage == 2) {
        $centerPages .= '<a class="number" href="index.php?p=players&page=1">1</a> ';
        $centerPages .= '<span class="number currentPage">' . $page . '</span>';
        ...
        $centerPages .= '<a class="number" href="index.php?p=players&page=1">1</a> ... ';
        $centerPages .= '<a class="number" href="index.php?p=players&page=' . $sub2 . '">' . $sub2 . '</a> ';
        $centerPages .= '<a class="number" href="index.php?p=players&page=' . $sub1 . '">' . $sub1 . '</a> ';
        $centerPages .= '<span class="number currentPage">' . $page . '</span>';
    ...
    if ($page == "1" && $lastPage == "1") {
        ...
        $paginationDisplay .= '<img alt="previous page" src="..//assets/images/x.gif" class="previous disabled">';
        $paginationDisplay .= $centerPages;
        $paginationDisplay .= '<a class="next" href="index.php?p=players&page=' . $nextPage . '"><img alt="next page" src="..//assets/images/x.gif"></a> ';
        $paginationDisplay .= '<a class="last" href="index.php?p=players&page=' . $lastPage . '"><img alt="The last page" src="..//assets/images/x.gif"></a>';
    } elseif ($page != "1" && $page != $lastPage) {
        $paginationDisplay .= '<a class="first" href="index.php?p=players&page=1"><img alt="Front Page" src="..//assets/images/x.gif"></a> ';
        $paginationDisplay .= '<a class="previous" href="index.php?p=players&page=' . $previous . '"><img alt="previous page" src="..//assets/images/x.gif"></a>';
        $paginationDisplay .= $centerPages;
        $paginationDisplay .= '<a class="next" href="index.php?p=players&page=' . $nextPage . '"><img alt="next page" src="..//assets/images/x.gif"></a> ';
        $paginationDisplay .= '<a class="last" href="index.php?p=players&page=' . $lastPage . '"><img alt="The last page" src="..//assets/images/x.gif"></a>';
    ...
    if ($query > 0) {
        while ($row = mysql_fetch_array($sql2)) {
            ...
            echo '
				<tr>
					...
					<td>' . $totalpop . '</td>
					<td>' . count($vil) . '</td>
					<td><img src="/admin/images/gold.gif" class="gold" alt="Gold" title="This player' . $row['gold'] . ' طلا دارد"/> ' . $row['gold'] . '</td>
        ...
        echo '<tr><td colspan="8" align="center">No players registered</td></tr>';
    }
