...
<div class="contentNavi tabNavi">
    ...
    <div class="container active">
        <div class="background-start">&nbsp;</div>
        <div class="background-end">&nbsp;</div>
        <div class="content"><a href="dorf3.php?s=6"><span class="tabItem"><?php echo AT_TROOPSINVILLAGES; ?></span></a>
        </div>
    </div>
    <div class="clear"></div>
</div>
            ...
            foreach ($varray as $vil) {
                ...
                for ($i = 1; $i <= 50; $i++) {
                    if ($unit['u' . $i] != 0) {
                        ...
                        echo '<td><img class="unit u' . $i . '" src="/assets/images/x.gif"></td>';
                    }
                }
            }
            echo '<td><img class="unit uhero" src="/assets/images/x.gif"></td>';
            ?>
        </tr>
    </thead>
    <tbody>
