...
?>
            ...
            <p>
                <button type="submit" value="ok" name="s1" id="btn_ok" class="green " title="<?php echo AL_NEWFORUM; ?>" onclick="window.location.href = 'banned.php'; return false;">
        ...
        ?>
            <p class="error"><?php echo AL_FORUMNTCREATED; ?></p>
            <p>
                <button type="submit" value="ok" name="s1" id="btn_ok" class="green " title="<?php echo AL_NEWFORUM; ?>" onclick="window.location.href = 'allianz.php?s=2&admin=newforum'; return false;">
                    <div class="button-container addHoverClick">
                        <div class="button-background">
                            <div class="buttonStart">
                                <div class="buttonEnd">
