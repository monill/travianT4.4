    ...
    for ($i = 32; $i <= 39; $i++) {
        if ($technology->meetRRequirement($i) && !$technology->getTech($i) && !$technology->isResearch($i, 1)) {
            echo "<tr><td class=\"desc\">
					...
					<div class=\"details\"><img class=\"r1\" src=\"/assets/images/x.gif\" alt=\"Fa\" title=\"" . VL_WOOD . "\" />" . ${'r' . $i}['wood'] . "|<img class=\"r2\" src=\"/assets/images/x.gif\" alt=\"Agyag\" title=\"" . VL_CROP . "\" />" . ${'r' . $i}['clay'] . "|<img class=\"r3\" src=\"/assets/images/x.gif\" alt=\"Vasérc\" title=\"" . VL_IRON . "\" />" . ${'r' . $i}['iron'] . "|<img class=\"r4\" src=\"/assets/images/x.gif\" alt=\"Búza\" title=\"" . VL_CROP . "\" />" . ${'r' . $i}['crop'] . "|<img class=\"clock\" src=\"/assets/images/x.gif\" alt=\"Időtartam\" title=\"\" />";
            echo $generator->getTimeFormat(round(${'r' . $i}['time'] * ($bid22[$village->resarray['f' . $id]]['attri'] / 100) / SPEED));
            if ($session->userinfo['gold'] >= 3 && $building->getTypeLevel(17) > 1) {
                echo "|<a href=\"build.php?gid=17&t=3&r1=" . ${'r' . $i}['wood'] . "&r2=" . ${'r' . $i}['clay'] . "&r3=" . ${'r' . $i}['iron'] . "&r4=" . ${'r' . $i}['crop'] . "\" title=\"" . MK_NPCMERCHANT . "\"><img class=\"npc\" src=\"/assets/images/x.gif\" alt=\"" . MK_NPCMERCHANT . "\" title=\"" . MK_NPCMERCHANT . "\" /></a>";
            }
