...
<div class="boxes boxesColor gray reportFilter offDef">
    ...
    <div class="boxes-contents">
        <button type="button" value="att_all" <?php if (isset($_GET['f']) && $_GET['f'] == '31') {
                                                ...
                                                } ?> onclick="window.location.href = 'allianz.php?s=3&f=31'; return false;"><img src="/assets/images/x.gif" class="att_all" alt="att_all"></button>
        <button type="button" value="def_all" <?php if (isset($_GET['f']) && $_GET['f'] == '32') {
                                                    echo "class=\"iconFilter iconFilterActive\"";
                                                } else {
                                                    echo "class=\"iconFilter\"";
                                                } ?> onclick="window.location.href = 'allianz.php?s=3&f=32'; return false;"><img src="/assets/images/x.gif" class="def_all" alt="def_all"></button>
    </div>
</div>
<div class="clear"></div>
...
if ($_GET['f'] == 31) {
    ...
    if ($query == 0) {
        ...
        while ($row = mysql_fetch_array($sql)) {
            ...
            $outputList .= "<img src=\"/assets/images/x.gif\" class=\"iReport iReport$type\" title=\"" . $noticeClass[$type] . "\">";
            $outputList .= "</a>";
