<style>
    .del {
        width: 12px;
        height: 12px;
        background-image: url(/admin/icon/del.gif);
    }
</style>
...
?>
        <br>
        <table id="profile" cellpadding="1" cellspacing="1" border="1">
            <thead>
                <tr>
                    <th colspan="2">
                        <div align="center">
                            <ul class="tabs">
                                <center>
                                    <li>
                                        Village Information
                                        <a href="?p=village&did=<?php echo $_GET['did']; ?>">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        for ($i = 0; $i <= 3; $i++) {
                            $a = $i + 1;
                            if ($i != 3) {
                                echo $typ[$i] . 'x <img src="/admin/images/r/' . $a . '.gif">| ';
                            } else {
                                echo $typ[$i] . 'x <img src="/admin/images/r/' . $a . '.gif"> ';
                            }
                        }
        ...
        <table id="member" cellpadding="1" cellspacing="1">
            ...
            <tbody>
                <tr>
                    <td>
                        <a href="?delOas&oid=" onClick="return del('oas', '<?php $varray[$i]['wref']; ?>');">
                            <img src="/admin/images/del.gif">
                        </a>
                    </td>
    ...
    <tr>
		<td><center /><img src="/admin/images/un/u/1.gif"></td>
		<td><center /><img src="/admin/images/un/u/2.gif"></td>
		<td><center /><img src="/admin/images/un/u/3.gif"></td>
        <td><center /><img src="/admin/images/un/u/4.gif"></td>
        <td><center /><img src="/admin/images/un/u/5.gif"></td>
		<td><center /><img src="/admin/images/un/u/6.gif"></td>
        <td><center /><img src="/admin/images/un/u/7.gif"></td>
        <td><center /><img src="/admin/images/un/u/8.gif"></td>
        <td><center /><img src="/admin/images/un/u/9.gif"></td>
        <td><center /><img src="/admin/images/un/u/10.gif"></td>
    </tr>
   ...
   <tr>
    ...
    <tr>
		<td><center /><img src="/admin/images/un/u/11.gif"></td>
		<td><center /><img src="/admin/images/un/u/12.gif"></td>
        <td><center /><img src="/admin/images/un/u/13.gif"></td>
        <td><center /><img src="/admin/images/un/u/14.gif"></td>
        <td><center /><img src="/admin/images/un/u/15.gif"></td>
		<td><center /><img src="/admin/images/un/u/16.gif"></td>
        <td><center /><img src="/admin/images/un/u/17.gif"></td>
        <td><center /><img src="/admin/images/un/u/18.gif"></td>
        <td><center /><img src="/admin/images/un/u/19.gif"></td>
        <td><center /><img src="/admin/images/un/u/20.gif"></td>
    </tr>
   ...
   <tr>
    ...
    <tr>
		<td><center /><img src="/admin/images/un/u/21.gif"></td>
		<td><center /><img src="/admin/images/un/u/22.gif"></td>
        <td><center /><img src="/admin/images/un/u/23.gif"></td>
        <td><center /><img src="/admin/images/un/u/24.gif"></td>
        <td><center /><img src="/admin/images/un/u/25.gif"></td>
		<td><center /><img src="/admin/images/un/u/26.gif"></td>
        <td><center /><img src="/admin/images/un/u/27.gif"></td>
        <td><center /><img src="/admin/images/un/u/28.gif"></td>
        <td><center /><img src="/admin/images/un/u/29.gif"></td>
        <td><center /><img src="/admin/images/un/u/30.gif"></td>
    </tr>
   ...
   <tr>
    ...
    <tr>
        <td><center /><img src="/assets/images/u/31.gif"></td>
        <td><center /><img src="/assets/images/u/32.gif"></td>
        <td><center /><img src="/assets/images/u/33.gif"></td>
        <td><center /><img src="/assets/images/u/34.gif"></td>
        <td><center /><img src="/assets/images/u/35.gif"></td>
        <td><center /><img src="/assets/images/u/36.gif"></td>
        <td><center /><img src="/assets/images/u/37.gif"></td>
        <td><center /><img src="/assets/images/u/38.gif"></td>
        <td><center /><img src="/assets/images/u/39.gif"></td>
        <td><center /><img src="/assets/images/u/40.gif"></td>
    </tr>
   ...
   <tr>
    ...
    <tr>
        <td><center /><img src="/assets/images/u/41.gif"></td>
        <td><center /><img src="/assets/images/u/42.gif"></td>
        <td><center /><img src="/assets/images/u/43.gif"></td>
        <td><center /><img src="/assets/images/u/44.gif"></td>
        <td><center /><img src="/assets/images/u/45.gif"></td>
        <td><center /><img src="/assets/images/u/46.gif"></td>
        <td><center /><img src="/assets/images/u/47.gif"></td>
        <td><center /><img src="/assets/images/u/48.gif"></td>
        <td><center /><img src="/assets/images/u/49.gif"></td>
        <td><center /><img src="/assets/images/u/50.gif"></td>
    </tr>
 ...
 <tr><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td></tr>
   ...
   <tr>
        ...
        <?php
        if ($_SESSION['access'] == ADMIN) {
            echo '<div align="right"><a href="index.php?p=edittroops&did=' . $id . '">Edit troops</div></a>';
        } else if ($_SESSION['access'] == MULTIHUNTER) {
            echo '<a href="#"><b><div align="right"><font color="#bcbdbc">Edit troops</font></div></a></b>';
        }
        ?>
        <table id="member" cellpadding="1" cellspacing="1">
            <thead>
            ...
            <tbody>
                ...
                for ($i = 1; $i <= 40; $i++) {
                    if ($fdata['f' . $i . 't'] == 0) {
                        ...
                        $bu = $this->procResType($fdata['f' . $i . 't']);
                    }
                    echo '
      <tr>
        <td class="on">' . $i . '</td>
