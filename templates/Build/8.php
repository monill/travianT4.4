<h1 class="titleInHeader"><?php echo B8; ?> <span
...
<div id="build" class="gid8">
    <div class="build_desc">
        <a href="#" onClick="return Travian.Game.iPopup(8,4);" class="build_logo">
            <img class="building big white g8" src="/assets/images/x.gif" alt="<?php echo B8; ?>" title="<?php echo B8; ?>"/>
        </a>
    ...
    <table cellpadding="1" cellspacing="1" id="build_value">
        <tr>
            ...
            <td>
                <b><?php echo $bid8[$village->resarray['f' . $id]]['attri'] ? $bid8[$village->resarray['f' . $id]]['attri'] : '0'; ?></b>%
            </td>
        </tr>
        <?php
