<h1 class="titleInHeader"><?php echo B15; ?> <span
...
<div id="build" class="gid15">
    <div class="build_desc">
        <a href="#" onClick="return Travian.Game.iPopup(15,4);" class="build_logo">
            <img class="building big white g15" src="/assets/images/x.gif" alt="<?php echo B15; ?>" title="<?php echo B15; ?>"/>
        </a><?php echo B15_DESC; ?></div>


    <table cellpadding="1" cellspacing="1" id="build_value">
        <tr>
            <th><?php echo CUR_CTIME; ?>:</th>
        ...
        if (!$building->isMax($village->resarray['f' . $id . 't'], $id)) {
            ...
            for ($nc = 1; $nc <= $ll; $nc++) {
                ...
                <tr <?php if ($nc < $nli) echo 'style="color:#F88C1F;"'; ?>>
                    <th><?php echo NEXT_CTIME . ' ' . ($village->resarray['f' . $id] + $nc); ?>:</th>
                    <td>
                        <b><?php echo round($bid15[$village->resarray['f' . $id] + $nc]['attri']); ?></b> <?php echo PERCENT; ?>
                    </td>
                </tr>
                <?php
            }
    ...
    if ($village->resarray['f' . $id] >= 10) {
        include("templates/Build/15_1.php");
    }
    ?>
    </p></div>
