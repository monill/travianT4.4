<h1 class="titleInHeader"><?php echo B14; ?> <span
...
<div id="build" class="gid14">
    <div class="build_desc">
        <a href="#" onClick="return Travian.Game.iPopup(14,4);" class="build_logo">
            <img class="building big white g14" src="/assets/images/x.gif" alt="<?php echo B14; ?>" title="<?php echo B14; ?>"/>
        </a>
        <?php echo B14_DESC; ?>
    </div>
        ...
        if (!$building->isMax($village->resarray['f' . $id . 't'], $id)) {
            ...
            for ($nc = 1; $nc <= $ll; $nc++) {
                ...
                <tr <?php if ($nc < $nli) echo 'style="color:#F88C1F;"'; ?>>
                    <th><?php echo NEXT_SPEEDUP;
                        echo $village->resarray['f' . $id] + $nc; ?>:
                    </th>
                    <td><b><?php echo $bid14[$village->resarray['f' . $id] + $nc]['attri']; ?></b></td>
                </tr>
                <?php
            }
        }
