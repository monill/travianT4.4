			...
			reportId:	'21073608'
                        ...
                        <?php if ($session->plus) { ?>
                            <button type="button" value="reportButton delete" class="icon" title="<?php echo AL_DELETE; ?>" onclick="return (function(){
                                    ...
                                    return false;
                                    })()"><img src="/assets/images/x.gif" class="reportButton delete" alt="reportButton delete" />
                            </button>
                        <?php } ?>
                        <div class="clear"></div>
                    </div>
                                ...
                                <td class="s7">
                                    <div class="boxes boxesColor gray trade">
                                        ...
                                        <div class="boxes-contents">
                                            ...
                                            <a href="spieler.php?uid=<?php echo $database->getUserField($dataarray[1], "id", 0); ?>"><?php echo ($dataarray[1] == 0) ? TASKMASTER : $database->getUserField($dataarray[1], "username", 0); ?></a>
                                            ...
                                            if ($dataarray[0] == 0) {
                                                ...
                                                echo "<a href='position_details.php?d=" . $dataarray[0] . "&amp;c=" . $generator->getMapCheck($dataarray[0]) . "'>" . $da0name . "</a>";
                                            }
                                            ?>
                                        </div>
                                    </div>
                                </td>
                                <td class="f16"><img src="/assets/images/x.gif" class="bigArrow" alt=""></td>
                                <td class="s7">
                                    <div class="boxes boxesColor gray trade">
                                        <div class="boxes-tl"></div>
                                        <div class="boxes-tr"></div>
                                        ...
                                        <div class="boxes-contents">
                                            ...
                                            <a href="<?php echo "position_details.php?d=" . $dataarray[14] . "&amp;c=" . $generator->getMapCheck($dataarray[14]) . ""; ?>"><?php echo $da14name; ?></a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
                    ...
                    <table cellpadding="0" cellspacing="0">
                        <thead>
                            <tr>
                                ...
                                <td class="troopHeadline" colspan="11">
                                    <a href="position_details.php?z=<?php echo $dataarray[0]; ?>"><?php echo $da0name; ?></a>
                                    <?php echo AT_SENDREINFTO; ?>
                                    <a href="position_details.php?z=<?php echo $da14name; ?>"><?php echo $da14name; ?></a>
                                </td>
                            </tr>
                        </thead>
                        <tbody class="units">
                        ...
                        <tbody class="infos">
                            ...
                            <tr>
                                ...
                                ?>
                                <td colspan="11">
                                    <img src="/assets/images/x.gif" class="clock" title="<?php echo BL_TIME; ?>"><?php echo $generator->getTimeFormat($time); ?>
                                </td>
                            </tr>
                        </tbody>
                        ...
                        <tbody class="infos">
                            ...
                            <tr>
                                ...
                                <td colspan="11">
                                    <?php echo $technology->getUpkeep($unitarray, $dataarray[2]); ?> <img src="/assets/images/x.gif" class="r4" title="<?php echo VL_CROP; ?>"><?php echo PER_HR; ?>
                                </td>
                            </tr>
                        </tbody>
                    </table>
