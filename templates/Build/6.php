<h1 class="titleInHeader"><?php echo B6; ?> <span
...
<div id="build" class="gid6">
    <div class="build_desc">
        <a href="#" onClick="return Travian.Game.iPopup(6,4);" class="build_logo">
            <img class="building big white g6" src="/assets/images/x.gif" alt="<?php echo B6; ?>" title="<?php echo B6; ?>"/>
        </a>
        <?php echo B6_DESC; ?></div>


    <table cellpadding="1" cellspacing="1" id="build_value">
        <tr>
            <th>
                <?php echo CUR_INC_PROD; ?>:
            </th>
            <td>
                <b><?php echo $bid6[$village->resarray['f' . $id]]['attri'] ? $bid6[$village->resarray['f' . $id]]['attri'] : '0'; ?></b>%
            </td>
        </tr>
        <?php
        if (!$building->isMax($village->resarray['f' . $id . 't'], $id)) {
            ...
            for ($nc = 1; $nc <= $ll; $nc++) {
                ...
                <tr <?php if ($nc < $nli) echo 'style="color:#F88C1F;"'; ?>>
                    <th><?php echo NEXT_INC_PROD;
                        echo $village->resarray['f' . $id] + $nc; ?>:
                    </th>
                    <td><b><?php echo $bid6[$village->resarray['f' . $id] + $nc]['attri']; ?></b>%</td>
                </tr>
                <?php
            }
        }
