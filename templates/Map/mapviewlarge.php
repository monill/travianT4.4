            ...
            <div id="mapContainer" class="lowRes" style="position:absolute;right:-5px;top:0px; width:1320px; height: 600px; display: block; ">
                <div class="mapContainerData" id="mapData" style="width:1346px;height:600px; margin-right:-18px;">
                    ...
                    for ($i = 0; $i <= 219; $i++) {
                        ...
                        switch ($maparray[$index]['fieldtype']) {
                            ...
                            case 0:
                                switch ($maparray[$index]['oasistype']) {
                                    case 1:
                                        $tt = "<img class='r1' src='/assets/images/x.gif' /> wood 25%";
                                        break;
                                    case 2:
                                        $tt = "<img class='r1' src='/assets/images/x.gif' /> wood 50%";
                                        break;
                                    case 3:
                                        $tt = "<img class='r1' src='/assets/images/x.gif' /> wood 25%<br><img class='r4' src='/assets/images/x.gif' /> crop 25%";
                                        break;
                                    case 4:
                                        $tt = "<img class='r2' src='/assets/images/x.gif' /> clay 25%";
                                        break;
                                    case 5:
                                        $tt = "<img class='r2' src='/assets/images/x.gif' /> clay 50%";
                                        break;
                                    case 6:
                                        $tt = "<img class='r2' src='/assets/images/x.gif' /> clay 25%<br><img class='r4' src='/assets/images/x.gif' /> crop 25%";
                                        break;
                                    case 7:
                                        $tt = "<img class='r3' src='/assets/images/x.gif' /> Iron 25%";
                                        break;
                                    case 8:
                                        $tt = "<img class='r3' src='/assets/images/x.gif' /> Iron 50%";
                                        break;
                                    case 9:
                                        $tt = "<img class='r3' src='/assets/images/x.gif' /> Iron 25%<br><img class='r4' src='/assets/images/x.gif' /> crop 25%";
                                        break;
                                    case 10:
                                    case 11:
                                        $tt = "<img class='r4' src='/assets/images/x.gif' /> crop 25%";
                                        break;
                                    case 12:
                                        $tt = "<img class='r4' src='/assets/images/x.gif' /> crop 50%";
                                        break;
                                }
                                break;
                        }
                        ...
                        if ($maparray[$index]['fieldtype'] > 0 && $maparray[$index]['occupied'] == 1) {
                            $targettitle = "<font color='white'><b>" . $maparray[$index]['name'] . "</b></font><br>(" . $maparray[$index]['x'] . "|" . $maparray[$index]['y'] . ")<br>Player " . $username . "<br>جمعیت " . $maparray[$index]['pop'] . "<br>Alliance " . $allyname . "<br>Tribe " . $tribename . "";
                        }
                        ...
                        if (count($incoming_attacks) > 0) {
                            ...
                            if ($inc_atts > 0) {
                                $att = '<img style="margin-right:45px;" class="att1" src="/assets/images/x.gif" />';
                            }
                        }
                ...
                <div class="navigation">
                    <a href="karte2.php?z=<?php echo $generator->getBaseID($x, $west1); ?>" id="navigationMoveLeft" class="moveLeft">
                        <img src="/assets/images/x.gif" title="Moving west"></a>
                    <a href="karte2.php?z=<?php echo $generator->getBaseID($x, $east1); ?>" id="navigationMoveRight" class="moveRight">
                        <img src="/assets/images/x.gif" title="Moving east"></a>
                    <a href="karte2.php?z=<?php echo $generator->getBaseID($north1, $y); ?>" id="navigationMoveUp" class="moveUp">
                        <img src="/assets/images/x.gif" title="Moving north"></a>
                    <a href="karte2.php?z=<?php echo $generator->getBaseID($south1, $y); ?>" id="navigationMoveDown" class="moveDown">
                        <img src="/assets/images/x.gif" title="Moving south"></a>
                    <a href="karte.php?z=<?php echo $_GET['z']; ?>" id="navigationFullScreen" class="viewFullScreen normal"><img src="/assets/images/x.gif" alt="Normal"></a>
                        ...
                        <div class="mr">
                            <div class="mc">
                                <div class="contents">
                                    ...
                                    <button type="submit" value="Confirmation" class="small">
                                        <div class="button-container">
                                            ...
                                            <div class="button-contents">Confirmation</div>
                                        </div>
                                    </button>
                                    <div class="clear"></div>
                                </div>
