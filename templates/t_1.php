...
if ($page == "1" && $lastPage == "1") {
    ...
    $paginationDisplay .= '<img alt="' . PREVPAGE . '" src="/assets/images/x.gif" class="previous disabled">';
    $paginationDisplay .= $centerPages;
    $paginationDisplay .= '<a class="next" href="' . $_SERVER['PHP_SELF'] . '?t=' . $_GET['t'] . '&page=2"><img alt="' . NEXTPAGE . '" src="/assets/images/x.gif"></a> ';
    $paginationDisplay .= '<a class="last" href="' . $_SERVER['PHP_SELF'] . '?t=' . $_GET['t'] . '&page=3"><img alt="' . LASTPAGE . '" src="/assets/images/x.gif"></a>';
} elseif ($page != "1" && $page != $lastPage) {
    $paginationDisplay .= '<a class="first" href="' . $_SERVER['PHP_SELF'] . '?t=' . $_GET['t'] . '&page=1"><img alt="' . FIRSTPAGE . '" src="/assets/images/x.gif"></a> ';
    $paginationDisplay .= '<a class="previous" href="' . $_SERVER['PHP_SELF'] . '?t=' . $_GET['t'] . '&page=' . $previous . '"><img alt="' . PREVPAGE . '" src="/assets/images/x.gif"></a>';
    $paginationDisplay .= $centerPages;
    $paginationDisplay .= '<a class="next" href="' . $_SERVER['PHP_SELF'] . '?t=' . $_GET['t'] . '&page=' . $nextPage . '"><img alt="' . NEXTPAGE . '" src="/assets/images/x.gif"></a> ';
    $paginationDisplay .= '<a class="last" href="' . $_SERVER['PHP_SELF'] . '?t=' . $_GET['t'] . '&page=' . $lastPage . '"><img alt="' . LASTPAGE . '" src="/assets/images/x.gif"></a>';
...
if ($query == 0) {
    ...
    while ($row = mysql_fetch_array($sql2)) {
        ...
        if ($type == 9) {
            $outputList .= "<img src=\"/assets/images/x.gif\" class=\"iReport iReport21\" alt=\"" . $noticeClass[$ntype] . "\" title=\"" . $noticeClass[$ntype] . "\" /> <div>";
        } else {
            $outputList .= "<img src=\"/assets/images/x.gif\" class=\"iReport iReport$type\" alt=\"" . $noticeClass[$type] . "\" title=\"" . $noticeClass[$type] . "\" /> <div>";
        }
        ...
        if ($type == 1 || $type == 2 || $type == 5 || $type == 6 || $type == 7) {
            ...
            $outputList .= "<div class=\"reportInfoIcon\"><img title=\"" . $carry . "\" src=\"/assets/images/x.gif\" class=\"reportInfo carry " . $style . "\"></div>";
        } elseif ($type == 9) {
            $btype = $dataarray[1];
            $type = $dataarray[2];
