<style>
    ...
    body {
        ...
        background-image: url(/assets/images/layout/bgVs.jpg);
        color: #252525;
        font-size: 13px;
    ...
    <div id="content" class="positionDetails">
        ...
        <div id="tileDetails" class="village <?php echo ($basearray['fieldtype'] == 0) ? 'oasis-' . $basearray['oasistype'] : 'village-' . $basearray['fieldtype'] ?>">
            <div class="detailImage">
                <div id="options">
                    <div class="option"><a onclick="position_popup(1);" class="a arrow"><?php echo MP_CENTERMAP; ?></a>
                    </div>
                        ...
                        <?php if ($session->goldclub == 1) { ?>
                            <div class="option">
                                <form action="build.php?gid=16&t=99" method="post">
                                    ...
                                    <input type="hidden" id="name" name="name" type="text" value="<?php echo $data2['username']; ?>">
                                    <input type="hidden" name="type" value="addfarm"><?php $t = $database->getAInfo($database->getVillageID($data2['id'])); ?>
                                    <input type="hidden" name="x" value="<?php echo $t['x']; ?>">
                                    <input type="hidden" name="y" value="<?php echo $t['y']; ?>">

                                    <button class="a arrow" type="submit" value="create" value="reportButton repeat" class="icon" title="<?php echo AT_ADDTOFARM; ?>"><?php echo AT_ADDTOFARM; ?></button>
                                </form>
                            </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <?php if ($uinfo['alliance'] == 0) {
                                ...
                                echo '<td><a onclick="position_popup(8);">' . $database->getUserAlliance($basearray['owner']) . '</a></td>';
                            } ?>
                        </tr>
                        <tr>
            ...
            <table cellpadding="0" cellspacing="0" id="distribution" class="transparent">
                <tbody>
                    ...
                    switch ($basearray['fieldtype']) {
                        case 1:
                            $tt = "
<td><img class=\"r1\" src=\"/assets/images/x.gif\" title=\"" . VL_LUMBER . "\"> 3</td>
<td><img class=\"r2\" src=\"/assets/images/x.gif\" title=\"" . VL_CLAY . "\"> 3</td>
<td><img class=\"r3\" src=\"/assets/images/x.gif\" title=\"" . VL_IRON . "\"> 3</td>
<td><img class=\"r4\" src=\"/assets/images/x.gif\" title=\"" . VL_CROP . "\"> 9</td>";

                            break;
                        case 2:
                            $tt = "
<td><img class=\"r1\" src=\"/assets/images/x.gif\" title=\"" . VL_LUMBER . "\"> 3</td>
<td><img class=\"r2\" src=\"/assets/images/x.gif\" title=\"" . VL_CLAY . "\"> 4</td>
<td><img class=\"r3\" src=\"/assets/images/x.gif\" title=\"" . VL_IRON . "\"> 5</td>
<td><img class=\"r4\" src=\"/assets/images/x.gif\" title=\"" . VL_CROP . "\"> 6</td>";
                            break;
                        case 3:
                            $tt = "
<td><img class=\"r1\" src=\"/assets/images/x.gif\" title=\"" . VL_LUMBER . "\"> 4</td>
<td><img class=\"r2\" src=\"/assets/images/x.gif\" title=\"" . VL_CLAY . "\"> 4</td>
<td><img class=\"r3\" src=\"/assets/images/x.gif\" title=\"" . VL_IRON . "\"> 4</td>
<td><img class=\"r4\" src=\"/assets/images/x.gif\" title=\"" . VL_CROP . "\"> 6</td>";
                            break;
                        case 4:
                            $tt = "
<td><img class=\"r1\" src=\"/assets/images/x.gif\" title=\"" . VL_LUMBER . "\"> 4</td>
<td><img class=\"r2\" src=\"/assets/images/x.gif\" title=\"" . VL_CLAY . "\"> 5</td>
<td><img class=\"r3\" src=\"/assets/images/x.gif\" title=\"" . VL_IRON . "\"> 3</td>
<td><img class=\"r4\" src=\"/assets/images/x.gif\" title=\"" . VL_CROP . "\"> 6</td>";
                            break;
                        case 5:
                            $tt = "
<td><img class=\"r1\" src=\"/assets/images/x.gif\" title=\"" . VL_LUMBER . "\"> 5</td>
<td><img class=\"r2\" src=\"/assets/images/x.gif\" title=\"" . VL_CLAY . "\"> 3</td>
<td><img class=\"r3\" src=\"/assets/images/x.gif\" title=\"" . VL_IRON . "\"> 4</td>
<td><img class=\"r4\" src=\"/assets/images/x.gif\" title=\"" . VL_CROP . "\"> 6</td>";
                            break;
                        case 6:
                            $tt = "
<td><img class=\"r1\" src=\"/assets/images/x.gif\" title=\"" . VL_LUMBER . "\"> 1</td>
<td><img class=\"r2\" src=\"/assets/images/x.gif\" title=\"" . VL_CLAY . "\"> 1</td>
<td><img class=\"r3\" src=\"/assets/images/x.gif\" title=\"" . VL_IRON . "\"> 1</td>
<td><img class=\"r4\" src=\"/assets/images/x.gif\" title=\"" . VL_CROP . "\"> 15</td>";
                            break;
                        case 7:
                            $tt = "
<td><img class=\"r1\" src=\"/assets/images/x.gif\" title=\"" . VL_LUMBER . "\"> 4</td>
<td><img class=\"r2\" src=\"/assets/images/x.gif\" title=\"" . VL_CLAY . "\"> 4</td>
<td><img class=\"r3\" src=\"/assets/images/x.gif\" title=\"" . VL_IRON . "\"> 3</td>
<td><img class=\"r4\" src=\"/assets/images/x.gif\" title=\"" . VL_CROP . "\"> 7</td>";
                            break;
                        case 8:
                            $tt = "
<td><img class=\"r1\" src=\"/assets/images/x.gif\" title=\"" . VL_LUMBER . "\"> 3</td>
...
<td><img class=\"r4\" src=\"/assets/images/x.gif\" title=\"" . VL_CROP . "\"> 6</td>";
                        ...
                        case 0:
                            switch ($basearray['oasistype']) {
                                case 1:
                                    $tt = "
<td class=\"ico\"><img class=\"r1\" src=\"/assets/images/x.gif\" title=\"" . VL_LUMBER . "\"></td>
...
<td class=\"val\">50%</td><td class=\"desc\">" . VL_LUMBER . "</td>";
                                ...
                                case 3:
                                    $tt = "
<tr><td class=\"ico\"><img class=\"r1\" src=\"/assets/images/x.gif\" title=\"" . VL_LUMBER . "\"></td>
<td class=\"val\">25%</td><td class=\"desc\">" . VL_LUMBER . "</td></tr>
<tr><td class=\"ico\"><img class=\"r4\" src=\"/assets/images/x.gif\" title=\"" . VL_CROP . "\"></td>
<td class=\"val\">25%</td><td class=\"desc\">" . VL_CROP . "</td></tr>";
                                    break;
                                case 4:
                                    $tt = "
<td class=\"ico\"><img class=\"r2\" src=\"/assets/images/x.gif\" title=\"" . VL_CLAY . "\"></td>
...
<td class=\"val\">50%</td><td class=\"desc\">" . VL_CLAY . "</td>";
                                ...
                                case 6:
                                    $tt = "
<tr><td class=\"ico\"><img class=\"r2\" src=\"/assets/images/x.gif\" title=\"" . VL_CLAY . "\"></td>
...
<td class=\"val\">25%</td><td class=\"desc\">" . VL_CROP . "</td></tr>";
                                ...
                                case 7:
                                    $tt = "
<td class=\"ico\"><img class=\"r3\" src=\"/assets/images/x.gif\" title=\"" . VL_IRON . "\"></td>
...
<td class=\"val\">50%</td><td class=\"desc\">" . VL_IRON . "</td>";
                                ...
                                case 9:
                                    $tt = "
<tr><td class=\"ico\"><img class=\"r3\" src=\"/assets/images/x.gif\" title=\"" . VL_IRON . "\"></td>
...
<td class=\"val\">25%</td><td class=\"desc\">" . VL_CROP . "</td></tr>";
                                ...
                                case 11:
                                    $tt = "
<td class=\"ico\"><img class=\"r4\" src=\"/assets/images/x.gif\" title=\"" . VL_CROP . "\"></td>
                ...
                <table cellpadding="0" cellspacing="0" id="troop_info" class="transparent">
                    <tbody>
                        ...
                        for ($i = 31; $i <= 40; $i++) {
                            if ($unit['u' . $i]) {
                                echo '<tr>';
                                echo '<td class="ico"><img class="unit u' . $i . '" src="/assets/images/x.gif" alt="' . $unarray[$i] . '" title="' . $unarray[$i] . '" /></td>';
            ...
            <table cellpadding="0" cellspacing="0" id="troop_info" class="rep transparent">
                <tbody>
                    ...
                    while ($row = mysql_fetch_assoc($result)) {
                        ...
                        $type = $row['ntype'];
                        echo "<tr><td>";
                        echo "<img src=\"/assets/images/x.gif\" class=\"iReport iReport" . $row['ntype'] . "\" title=\"" . $noticeClass[$type] . "\"> ";
