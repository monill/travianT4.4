...
<div class="build_desc">
    <a href="#" onclick="return Travian.Game.iPopup(8,4);" class="build_logo">
        <img class="building big white g8" src="/assets/images/x.gif" alt="<?php echo B8; ?>">
    </a>
...
<div id="contract" class="contract contractNew contractWrapper">
    ...
    <a href="#"
       onclick="return Travian.Game.iPopup(4,4, 'gid');"><?php echo B4; ?></a> <span><?php echo BL_LVL; ?> 5</span></span>
    </div>
    <div class="clear"></div>
</div>
<div class="clear"></div>
