<div id="sidebarBoxPlusFuture" class="sidebarBox ">
    ...
    <div class="sidebarBoxInnerBox">
        <div class="innerBox header ">
            ...
            <button type="button" id="button5225ee283d5acasd" class="layoutButton bulbActive2 gold " onclick="return false;" title="<?php echo MV_PLUS; ?>">
                ...
                if ($('button5225ee283d5acasd')) {
                    $('button5225ee283d5acasd').addEvent('click', function() {
                        window.fireEvent('buttonClicked', [this, {
                            ...
                            "speechBubble": "",
                            "class": "",
                            "id": "button5225ee283d5acasd",
                            "redirectUrl": "plus.php",
                            "redirectUrlExternal": ""
                        }]);
                    });
                }
...
<div id="sidebarBoxTravianBank" class="sidebarBox ">
    ...
    <div class="sidebarBoxInnerBox">
        <div class="innerBox header ">
            <div class="clear"></div>
            <div class="boxTitle"></div>
            <button type="button" id="button522583d5acasd" class="layoutButton bulbActive3 gold " onclick="return false;" title="<?php echo MV_BANK; ?>">
                <div class="button-container addHoverClick">
                    <img src="/assets/images/x.gif" alt="">
                </div>
            </button>
                ...
                if ($('button522583d5acasd')) {
                    $('button522583d5acasd').addEvent('click', function() {
                        window.fireEvent('buttonClicked', [this, {
                            ...
                            "speechBubble": "",
                            "class": "",
                            "id": "button522583d5acasd",
                            "redirectUrl": "plus.php?bank",
                            "redirectUrlExternal": ""
                        }]);
                    });
                }
...
<div id="sidebarBoxVillagelist" class="sidebarBox toggleable <?php if (isset($_COOKIE['travian_toggle'])) {
    ...
    <div class="sidebarBoxInnerBox">
        <div class="innerBox header ">
            ...
            <button type="button" id="button5229e52550762" class="layoutButton overviewWhite green  " onclick="return false;" title="دید کلی دهکده">
                <div class="button-container addHoverClick">
                    <img src="/assets/images/x.gif" alt="" />
                </div>
            </button>
            ...
            $wids = $max == 3 ? 100 : $wids;
            ?>
            <div class="expansionSlotInfo" title="<?php echo MV_VILL . $t; ?>/<?php echo $max; ?> </br><?php echo MV_CULTURE . $x; ?> / <?php echo $vmax; ?>">
        ...
        <div class="innerBox content">
            <ul>
                ...
                ?>
                    <li class=" <?php echo $select; ?>" title="<?php echo $database->getVillageField($session->villages[$i - 1], 'name') . '  (' . $coorproc['x'] . '|' . $coorproc['y'] . ')    '; ?>">
                        <a href="?newdid=<?php echo $session->villages[$i - 1] . "&" . $vill; ?>" accesskey="b" class="<?php echo $select; ?>">
                            <img src="/assets/images/x.gif" class="<?php echo $village_attack[$session->villages[$i - 1]]; ?>" />

                            <div class="name"><?php echo $database->getVillageField($session->villages[$i - 1], 'name'); ?>
                            </div>
                            <span class="coordinates coordinatesWrapper coordinatesAligned coordinatesLTR">
                                <span class="coordinateX">(<?php echo $coorproc['x']; ?></span>
                                <span class="coordinatePipe">|</span>
                                <span class="coordinateY"><?php echo $coorproc['y']; ?>)</span>
                            </span>
                        </a>
                    </li><?php } ?>
            </ul>
