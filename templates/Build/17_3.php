...
<div id="build" class="gid17">
    ...
    if (isset($_GET['c'])) {
        ...
        <p><b><?php echo MK_RAWMATERIALSDISTRIBUTED ?>.</b> <?php echo BL_COSTS; ?>: <b>3 </b><img src="/assets/images/x.gif"
                                                                                                   class="gold"
    ...
    <?php } else { ?>
        ...
        <form method="post" name="snd" action="build.php">
            ...
            <p id="submitButton" style="display: block; ">
                ...
                <span class="npc_price"><b>3</b><img src="/assets/images/x.gif" class="gold"/> <?php echo HDR_GOLD; ?></span></p>
            <?php } else {
