<h1 class="titleInHeader"><?php echo B34; ?> <span
...
<div id="build" class="gid34">
    <div class="build_desc">
        <a href="#" onClick="return Travian.Game.iPopup(34,4);" class="build_logo">
            <img class="building big white g34" src="/assets/images/x.gif" alt="<?php echo B34; ?>"
                 title="<?php echo B34; ?>"/></a>
        ...
        if (!$building->isMax($village->resarray['f' . $id . 't'], $id)) {
            ...
            for ($nc = 1; $nc <= $ll; $nc++) {
                ...
                <tr <?php if ($nc < $nli) echo 'style="color:#F88C1F;"'; ?>>
                    <th><?php echo BL_NEXTBSTABLITY . ' ' . ($village->resarray['f' . $id] + $nc); ?>:</th>
                    <td><b><?php echo $bid34[$village->resarray['f' . $id] + $nc]['attri']; ?>%</b></td>
                </tr>
                <?php
            }
        }
