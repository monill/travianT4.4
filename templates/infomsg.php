    ...
    if ($golds['plus'] < ($_SERVER['REQUEST_TIME'] + 3600 * 24)) {
        ...
        $output .= "<br><button type=\"button\" value=\"extend\" id=\"button5288d485c0f4f\" class=\"gold \" coins=\"" . g_plus . "\">
				<div class=\"button-container addHoverClick \">
					...
					<div class=\"button-content\">" . IM_EXTEND . " <img src=\"/assets/images/x.gif\" class=\"goldIcon\" alt=\"\"><span class=\"goldValue\">" . g_plus . "</span></div>
				</div>
			</button>
    ...
    if ($golds['b1'] < ($_SERVER['REQUEST_TIME'] + 3600 * 24)) {
        ...
        $output .= "<br><button type=\"button\" value=\"extend\" id=\"button652W890f4f\" class=\"gold \" coins=\"" . g_wood . "\">
				<div class=\"button-container addHoverClick \">
					...
					<div class=\"button-content\">" . IM_EXTEND . " <img src=\"/assets/images/x.gif\" class=\"goldIcon\" alt=\"\"><span class=\"goldValue\">" . g_wood . "</span></div>
				</div>
			</button>
			<script type=\"text/javascript\">
				window.addEvent('domready', function()
    ...
    if ($golds['b2'] < ($_SERVER['REQUEST_TIME'] + 3600 * 24)) {
        ...
        $output .= "<br><button type=\"button\" value=\"extend\" id=\"button652C890Lf4f\" class=\"gold \" coins=\"" . g_clay . "\">
				<div class=\"button-container addHoverClick \">
					...
					<div class=\"button-content\">" . IM_EXTEND . " <img src=\"/assets/images/x.gif\" class=\"goldIcon\" alt=\"\"><span class=\"goldValue\">" . g_clay . "</span></div>
				</div>
			</button>
			<script type=\"text/javascript\">
				window.addEvent('domready', function() {
    ...
    if ($golds['b3'] < ($_SERVER['REQUEST_TIME'] + 3600 * 24)) {
        ...
        $output .= "<br><button type=\"button\" value=\"extend\" id=\"button652I8900f4f\" class=\"gold \" coins=\"" . g_iron . "\">
				<div class=\"button-container addHoverClick \">
					...
					<div class=\"button-content\">" . IM_EXTEND . " <img src=\"/assets/images/x.gif\" class=\"goldIcon\" alt=\"\"><span class=\"goldValue\">" . g_iron . "</span></div>
				</div>
			</button>
			<script type=\"text/javascript\">
				window.addEvent('domready', function()
    ...
    if ($golds['b4'] < ($_SERVER['REQUEST_TIME'] + 3600 * 24)) {
        ...
        $output .= "<br><button type=\"button\" value=\"extend\" id=\"button652C890Rf4f\" class=\"gold \" coins=\"" . g_crop . "\">
				<div class=\"button-container addHoverClick \">
					...
					<div class=\"button-content\">" . IM_EXTEND . " <img src=\"/assets/images/x.gif\" class=\"goldIcon\" alt=\"\"><span class=\"goldValue\">" . g_crop . "</span></div>
				</div>
			</button>
			<script type=\"text/javascript\">
				window.addEvent('domready', function()
...
include('templates/text_infobox.php');
//bbcode = html code
if ($txt2 != '') {
