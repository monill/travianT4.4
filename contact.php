...
<div id="wrapper">
    ...
    <div class="bodyWrapper">
        ...
        <div id="mid">
            <a id="ingameManual" href="help.php"><img class="question" alt="Help" src="/assets/images/x.gif"></a>
            ...
            <div id="side_info">
                <?php if (NEWSBOX1) { ?>
                    <div class="news news1">
                        <?php include("templates/News/newsbox1.php"); ?>
                    </div>
                <?php } ?>
                <?php if (NEWSBOX2) { ?>
                    <div class="news news2">
                        <?php include("templates/News/newsbox2.php"); ?>
                    </div>
                <?php } ?>
