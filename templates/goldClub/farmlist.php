                ...
                <form action="startRaid.php?id=39&t=99&action=startRaid" method="post">
                    ...
                    <div class="round spacer listTitle" onclick="Travian.Game.RaidList.toggleList(<?php echo $lid; ?>);">
                        <div class="listTitleText">
                            <img alt="del" class="del" src="/assets/images/x.gif" onclick="
                            ...
                            <img alt="<?php echo FD_LOADING; ?>" class="loading hide" src="/assets/images/x.gif" align="absmiddle">
                        </div>
                    ...
                    <div class="listContent ">
                        <div class="detail">
                            <table class="list" cellpadding="1" cellspacing="1">
                                <thead>
                                    <tr>
                                        ...
                                        <td class="village sortable" onclick="Travian.Game.RaidList.sort(<?php echo $lid; ?>, 'village');">
                                            <?php echo VL_VILLAGE; ?></td>
                                        <td class="ew sortable" onclick="Travian.Game.RaidList.sort(<?php echo $lid; ?>, 'ew');">
                                            <?php echo PL_EW; ?></td>
                                        <td class="distance sortable" onclick="Travian.Game.RaidList.sort(<?php echo $lid; ?>, 'distance');">
                                            <?php echo MP_DISTANCE; ?></td>
                                        <td class="troops sortable" onclick="Travian.Game.RaidList.sort(<?php echo $lid; ?>, 'troops');">
                                            <?php echo AT_TROOPS; ?></td>
                                        <td class="lastRaid sortable" onclick="Travian.Game.RaidList.sort(<?php echo $lid; ?>, 'lastRaid');">
                                            <?php echo PL_LASTRAID; ?></td>
                                        <td class="action"></td>
                                    </tr>
                                </thead>
                                <tbody>
                                            ...
                                            <tr class="slotRow">
                                                ...
                                                <td class="village">
                                                    ...
                                                    if (count($incoming_attacks) > 0) {
                                                        ...
                                                        if ($inc_atts > 0) {
                                                            echo '<img class="att2" src="/assets/images/x.gif" title="' . PL_INCOMINGATTACK . '" />';
                                                        }
                                                    } ?>
                                                    ...
                                                    for ($uc = 1; $uc <= 10; $uc++) {
                                                        if (${'t' . $uc} != 0) {
                                                            echo '<div class="troopIcon"><img class="unit u' . ($uc + $ct) . '" title="'
                                                                . constant('U' . ($uc + $ct)) . '" src="/assets/images/x.gif"><span class="troopIconAmount">' . ${'t' . $uc} . '</span></div>';
                                                        }
                                                    }
                                                    ?>
                                                </td>
                                                <td class="lastRaid">
                                                    <?php
                                                    $noticeClass = array(
                                                        NOTICE1, NOTICE2, NOTICE3, NOTICE4, NOTICE5, NOTICE6, NOTICE7, NOTICE8, NOTICE9, NOTICE10, NOTICE11,
                                                    ...
                                                    while ($row2 = mysql_fetch_array($getnotice)) {
                                                        ...
                                                        $type2 = $row2['ntype'];
                                                        echo "<img src=\"/assets/images/x.gif\" class=\"iReport iReport" . $row2['ntype'] . "\" title=\""
                                                            . $noticeClass[$type2] . "\"> ";
                                                        ...
                                                        if ($dataarray[25] + $dataarray[26] + $dataarray[27] + $dataarray[28] == 0) {
                                                            echo "<img title=\"bounty: " . $allres . " resouces max carry: " . $carry
                                                                . " resouces.\" src=\"/assets/images/x.gif\" class=\"carry empty\">";
                                                        } elseif ($dataarray[25] + $dataarray[26] + $dataarray[27] + $dataarray[28] != $dataarray[29]) {
                                                            echo "<img title=\"bounty: " . $allres . " resouces. max carry: " . $carry
                                                                . " resouces.\" src=\"/assets/images/x.gif\" class=\"carry half\">";
                                                        } else {
                                                            echo "<img title=\"bounty: " . $allres . " resouces. max carry: " . $carry
                                                                . " resouces.\" src=\"/assets/images/x.gif\" class=\"carry full\">";
                                                        }
                            ...
                            <div class="addSlot">
                                <button type="button" class="green " value="<?php echo PL_ADD; ?>" onclick="Travian.Game.RaidList.addSlot(<?php echo $lid; ?>);">
                        ...
                        <div class="troopSelection">
                            ...
                            for ($i = $start; $i <= $end; $i++) {
                                echo '<span class="troopSelectionUnit">
										<img class="unit u' . $i . '" title="' . $technology->unarray[$i] . '" src="/assets/images/x.gif">
