<ul id="stockBar">
    <li id="stockBarWarehouseWrapper" class="stock" title="<?php echo HDR_WAREHOUSE; ?>">
        <img class="warehouse" src="/assets/images/x.gif" alt="<?php echo HDR_WAREHOUSE; ?>" />
    ...
    <li id="stockBarResource1" class="stockBarButton" title="<?php echo HDR_WOOD_PROD . $village->getProd('wood') . HDR_CLICKMOREINFO; ?>">
        ...
        <div class="middle">
            ...
            <span id="l1" class="value" style="font-size:<?php if (round($village->awood) > 9999999) {
                                                                echo '9px';
                                                            } else {
                                                                echo '11px;';
                                                            } ?>"><?php echo round($village->awood); ?></span>
            <div class="barBox">
                <div id="lbar1" class="bar" style="width:100%;"></div>
            </div>
            <a href="production.php?t=1" title="<?php echo HDR_WOOD_PROD . $village->getProd('wood') . HDR_CLICKMOREINFO; ?>">
    ...
    <li id="stockBarResource2" class="stockBarButton" title="<?php echo HDR_CLAY_PROD . $village->getProd('clay') . HDR_CLICKMOREINFO; ?>">
        ...
        <div class="middle">
            ...
            <span id="l2" class="value" style="font-size:<?php if (round($village->aclay) > 9999999) {
                                                                echo '9px';
                                                            } else {
                                                                echo '11px;';
                                                            } ?>"><?php echo round($village->aclay); ?></span>
            <div class="barBox">
                <div id="lbar2" class="bar" style="width:100%;"></div>
            </div>
            <a href="production.php?t=2" title="<?php echo HDR_CLAY_PROD . $village->getProd('clay') . HDR_CLICKMOREINFO; ?>">
                <img src="/assets/images/x.gif" alt="" />
            </a>
        </div>
        <div class="end"></div>
    ...
    <li id="stockBarResource3" class="stockBarButton" title="<?php echo HDR_IRON_PROD . $village->getProd('iron') . HDR_CLICKMOREINFO; ?>">
        ...
        <div class="middle">
            ...
            <span id="l3" class="value" style="font-size:<?php if (round($village->airon) > 9999999) {
                                                                echo '9px';
                                                            } else {
                                                                echo '11px;';
                                                            } ?>"><?php echo round($village->airon); ?></span>
            <div class="barBox">
                <div id="lbar3" class="bar" style="width:100%;"></div>
            </div>
            <a href="production.php?t=3" title="<?php echo HDR_IRON_PROD . $village->getProd('clay') . HDR_CLICKMOREINFO; ?>">
                <img src="/assets/images/x.gif" alt="" />
            </a>
        </div>
        <div class="end"></div>
    ...
    <li id="stockBarGranaryWrapper" class="stock" title="<?php echo HDR_GRANARY; ?>">
        <img class="granary" src="/assets/images/x.gif" alt="<?php echo HDR_GRANARY; ?>" />
    ...
    <li id="stockBarResource4" class="stockBarButton">
        ...
        <div class="middle">
            ...
            <?php if ($golds['b4']) echo '<img src="/assets/images/x.gif" class="productionBoost" alt="Crop Production Plus">'; ?>
            <span id="l4" class="value" style="font-size:<?php if (round($village->acrop) > 9999999) {
                                                                echo '9px';
                                                            } else {
                                                                echo '11px;';
                                                            } ?>"><?php echo round($village->acrop); ?></span>
            <div class="barBox">
                <div id="lbar4" class="bar" style="width:100%;"></div>
            </div>
            <a href="production.php?t=4" title="<?php echo HDR_CROP_PROD . $village->getProd('crop') . HDR_CLICKMOREINFO; ?>">
                <img src="/assets/images/x.gif" alt="" />
            </a>
        </div>
        <div class="end"></div>
    ...
    <li id="stockBarFreeCropWrapper" class="stockBarButton r5">
        <div class="begin"></div>
        <div class="middle">
            <img class="res r5Big" src="/assets/images/x.gif" alt="Free crop" />
            <span id="stockBarFreeCrop" class="value" style="font-size:<?php if (round($village->allcrop) > 999999) {
                                                                            echo '8.5px';
                                                                        } else {
                                                                            echo '11px;';
                                                                        } ?>"><?php echo $village->allcrop; ?></span>
            <a href="production.php?t=5" title="<?php echo HDR_CROP_PROD2 . $village->allcrop; ?><Br /><?php echo HDR_CLICKMOREINFO; ?>">
                <img src="/assets/images/x.gif" alt="" />
            </a>
        </div>
        <div class="end"></div>
...
<script type="text/javascript">
    ...
    resources.storage = {
        "l1": <?php echo round($village->awood); ?>,
        "l2": <?php echo round($village->aclay); ?>,
        "l3": <?php echo round($village->airon); ?>,
        "l4": <?php echo round($village->acrop); ?>
    };
