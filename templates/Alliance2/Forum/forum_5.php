<form method="post" name="post" action="allianz.php?s=2&fid=<?php echo $_GET['fid']; ?>&pid=<?php echo $_GET['pid']; ?>">
    ...
    <h4 class="round"><?php echo AL_NEWPOST; ?></h4>
    ...
    <button type="submit" value="save" class="green build" name="s1" id="btn_save">
        <div class="button-container addHoverClick">
            ...
            <div class="button-content"><?php echo AL_CONFIRM; ?></div>
        </div>
    </button>
</form>