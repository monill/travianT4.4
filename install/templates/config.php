    ...
    <div id="statLeft" class="top10Wrapper">
        ...
        <table cellpadding="1" cellspacing="1" id="top10_offs" class="top10 row_table_data">
            ...
            <tr class="hover">
                <td>World Size:</td>
                <td>
                    <select name="wmax" dir="ltr" class="text">
            ...
            <tr class="hover">
                ...
                <td>
                    <select name="reg_open" dir="ltr" class="text">
            ...
            <tr class="hover">
                <td>Language:</td>
                <td>
                    <select name="lang" dir="ltr" class="text">
            ...
            <tr class="hover">
                ...
                <td>
                    <input name="storagemultiplier" dir="ltr" class="text" type="text" id="storagemultiplier" value="1">
                </td>
            </tr>
            <tr class="hover">
            ...
            <tr class="hover">
                <td>Plus Duration:</td>
                <td>
                    <select name="plus_time" dir="ltr" class="text">
            ...
            <tr class="hover">
                ...
                <td>
                    <select name="plus_production" dir="ltr" class="text">
                        <option value="43200" selected="selected">12 hours</option>
                        <option value="86400">1 Days</option>
                        <option value="172800">2 Days</option>
                        <option value="259200">3 Days</option>
            ...
            <tr class="hover">
                ...
                <td>
                    <select name="auction_time" dir="ltr" class="text">
            ...
            <tr class="hover">
                ...
                <td>
                    <input type="text" dir="ltr" class="text" name="medalinterval" id="medalinterval" value="86400">
                </td>
            </tr>
            <tr class="hover">
                <td>Great Workshop:</td>
                <td>
                    <select name="great_wks" dir="ltr" class="text">
            ...
            <tr class="hover">
                <td>WW Stats:</td>
                <td>
                    <select name="ww" dir="ltr" class="text">
        ...
        <table cellpadding="1" cellspacing="1" id="top10_defs" class="top10 row_table_data">
            ...
            <tr class="hover">
                ...
                <td>
                    <select name="admin_rank" dir="ltr" class="text">
    ...
    <div id="statRight" class="top10Wrapper">
        ...
        <table cellpadding="1" cellspacing="1" id="top10_climbers" class="top10 row_table_data">
            <tr class="hover">
                <td>News Box 1 :</td>
                <td>
                    <select name="box1" dir="ltr" class="text">
            ...
            <tr class="hover">
                <td>News Box 2 :</td>
                <td>
                    <select name="box2" dir="ltr" class="text">
                        <option value="1">Enable</option>
                        <option value="0" selected="selected">Disable</option>
                    </select>
                </td>
            ...
            <tr class="hover">
                <td>News Box 3 :</td>
                <td>
                    <select name="box3" dir="ltr" class="text">
                        <option value="1">Enable</option>
                        <option value="0" selected="selected">Disable</option>
                    </select>
                </td>
            ...
            <tr class="hover">
                <td>Log Building:</td>
                <td>
                    <select name="log_build" dir="ltr" class="text">
            ...
            <tr class="hover">
                <td>Log Tech:</td>
                <td>
                    <select name="log_tech" dir="ltr" class="text">
                        <option value="0" selected="selected">No</option>
                        <option value="1">Yes</option>
                    </select>
                </td>
            ...
            <tr class="hover">
                <td>Log Login:</td>
                <td>
                    <select name="log_login" dir="ltr" class="text">
                        <option value="0" selected="selected">No</option>
                        <option value="1">Yes</option>
                    </select>
                </td>
            ...
            <tr class="hover">
                <td>Log Gold:</td>
                <td>
                    <select name="log_gold_fin" dir="ltr" class="text">
                        <option value="0" selected="selected">No</option>
                        <option value="1">Yes</option>
                    </select>
                </td>
            ...
            <tr class="hover">
                <td>Log Admin:</td>
                <td>
                    <select name="log_admin" dir="ltr" class="text">
                        <option value="0" selected="selected">No</option>
                        <option value="1">Yes</option>
                    </select>
                </td>
            ...
            <tr class="hover">
                <td>Log user:</td>
                <td>
                    <select name="trackusers" dir="ltr" class="text">
                        <option value="0" selected="selected">No</option>
                        <option value="1">Yes</option>
                    </select>
                </td>
            ...
            <tr class="hover">
                <td>Log War:</td>
                <td>
                    <select name="log_war" dir="ltr" class="text">
                        <option value="0" selected="selected">No</option>
                        <option value="1">Yes</option>
                    </select>
                </td>
            ...
            <tr class="hover">
                <td>Log Market:</td>
                <td>
                    <select name="log_market" dir="ltr" class="text">
                        <option value="0" selected="selected">No</option>
                        <option value="1">Yes</option>
                    </select>
                </td>
            ...
            <tr class="hover">
                <td>Log Illegal:</td>
                <td>
                    <select name="log_illegal" dir="ltr" class="text">
                        <option value="0" selected="selected">No</option>
                        <option value="1">Yes</option>
                    </select>
                </td>
        ...
        <table cellpadding="1" cellspacing="1" id="top10_raiders" class="top10 row_table_data">
            <tr class="hover">
                <td>check db time:</td>
                <td><input name="check_db" dir="ltr" class="text" type="number" id="check_db" value="360" size="15">
                </td>
            </tr>
            <tr class="hover">
                <td>stats time:</td>
            ...
            <tr class="hover">
                ...
                <td>
                    <select name="activate" dir="ltr" class="text">
                        <option value="0" selected="selected">Disable</option>
                        <option value="1">Enable</option>
                    </select>
                </td>
            ...
            <tr class="hover">
                <td>Limit Mailbox:</td>
                <td>
                    <select name="limit_mailbox" dir="ltr" class="text">
            ...
            <tr class="hover">
                ...
                <td>
                    <select name="demolish" dir="ltr" class="text">
            ...
            <tr class="hover">
                ...
                <td>
                    <select name="village_expand" dir="ltr" class="text">
            ...
            <tr class="hover">
                ...
                <td>
                    <select name="error" dir="ltr" class="text">
