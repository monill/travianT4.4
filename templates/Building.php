<div class="boxes buildingList">
    ...
    <div class="boxes-contents cf">
        <h5><?php echo BD_BUILDING; ?></h5>

        <div class="finishNow">
            <button type="button" value="<?php echo BD_COMPCONSIM; ?>" id="button527fdfcd482b7" class="gold " title="<?php echo BD_COMPCONSIM; ?>">
                    ...
                    if ($('button527fdfcd482b7')) {
                        $('button527fdfcd482b7').addEvent('click', function() {
                            window.fireEvent('buttonClicked', [this, {
                                "type": "button",
                                "value": "<?php echo BD_COMPCONSIM; ?>",
                                "name": "",
                                "id": "button527fdfcd482b7",
                                "class": "gold ",
        ...
        foreach ($building->buildArray as $jobs) {
            ...
            if ($jobs['master'] == 0) {
                ...
                echo "<img src=\"/assets/images/x.gif\" class=\"del\" title=\"" . BD_CANCEL . "\" alt=\"" . BD_CANCEL . "\" /></a>";
                ...
                echo "</span> hours.";
                echo "The ending time " . date('H:i', $jobs['timestamp']) . "</div><div class=\"clear\"></div></li>";
                $timer += 1;
            } else {
                echo "<li><a href=\"?d=" . $jobs['id'] . "&a=0&c=$session->checker\">";
                echo "<img src=\"/assets/images/x.gif\" class=\"del\" title=\"cancel\" alt=\"cancel\" /></a>";
