<form action="spieler.php" method="POST">
    ...
    <table cellpadding="1" cellspacing="1" id="del_acc" class="account transparent">
        <tbody>
			...
			<img src=\"/assets/images/x.gif\" class=\"del\" alt=\"del\"></button>";
                }
            ...
            ?>
                <tr>
                    <td colspan="2">
                        <font color=red><?php echo sprintf(PF_NOTEDELETE, round($cancelduration / 60)); ?></font>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="del_selection">
                        ...
                        <label><input class="radio" type="radio" name="del" value="0" checked="checked"><?php echo NO; ?></label>
                    </td>
                </tr>
                <tr>
        ...
        <tbody>
            <tr>
                <td colspan="2">
                    ...
                    echo sprintf(
                        PF_YOURGOLDAMOUNT,
                        '<img src="/assets/images/x.gif" class="gold" alt="' . HDR_GOLD . '">' . ($udata['gold']),
                        '<img src="/assets/images/x.gif" class="gold" alt="' . HDR_GOLD . '">' . min($udata['boughtgold'], $udata['gold'])
                    );
                    ?>
                </td>
            </tr>
