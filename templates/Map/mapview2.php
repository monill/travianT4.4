                    ...
                    <div class="mr">
                        <div class="mc">
                            <div class="contents">
                                ...
                                <div class="iconButton filterAlliance disabled" title="show alliances marks"></div>
                                <div class="clear"></div>
                            </div>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        window.addEvent('domready', function() {
            ...
            var fnDelayMe = function() {
                ...
                var fnInit = function() {
                    Travian.Game.Map.Options.Rulers.steps = $merge(Travian.Game.Map.Options.Rulers.steps, {
                        "x": {
                            "1": 1,
                            "2": 1,
                            "3": 10,
                    ...
                    Travian.Game.Map.Options.Default.dataStore = $merge(Travian.Game.Map.Options.Default
                        .dataStore, {
                            "cachingTimeForType": {
                                "blocks": 1800000,
                                "symbol": 600000,
                    ...
                    Travian.Game.Map.Options.Default.updater = $merge(Travian.Game.Map.Options.Default
                        .updater, {
                            "maxRequestCount": 5,
                            "requestDelayTime": {
                                "multiple": 100,
                    ...
                    Travian.Game.Map.Tips.tooltipHtml =
                        '<span class=\"coordinates coordinatesWithText\"><span class=\"coordinateX\">({x}<\/span><span class=\"coordinatePipe\">|<\/span><span class=\"coordinateY\">{y})<\/span><\/span>';
                    Travian.Game.Map.Options.Default.block.tooltipHtml =
                        '<span class=\"coordinates coordinatesWithText\"><span class=\"coordinateX\">({x}<\/span><span class=\"coordinatePipe\">|<\/span><span class=\"coordinateY\">{y})<\/span><\/span><br />{k.loadingData}';
                        ...
                        data: {
                            "elements": [{
                                ...
                                "s": [{
                                    ...
                                    "title": "Adventure",
                                    "text": "{a.atm1}\u003Cbr \/\u003E{a.ad} {a.ad2}"
                                }]
                            }, {
                                "x": 17,
                                "y": 228,
                                "s": [{
                                    "dataId": "adventure12589595",
                                    "x": "17",
                                    "y": "228",
                                    "type": "adventure",
                                    "parameters": {
                                    ...
                                    "title": "Adventure",
                                    "text": "{a.atm2}\u003Cbr \/\u003E{a.ad} {a.ad3}"
                                }]
                            }, {
                                "x": 19,
                                "y": 216,
                                "s": [{
                                    "dataId": "adventure12589596",
                                    "x": "19",
                                    "y": "216",
                                    "type": "adventure",
                                    "parameters": {
                                    ...
                                    "title": "Adventure",
                                    "text": "{a.atm3}\u003Cbr \/\u003E{a.ad} {a.ad0}"
                                }]
                            }, {
                                "x": 21,
                                "y": 226,
                                "s": [{
                                    "dataId": "adventure12589597",
                                    "x": "21",
                                    "y": "226",
                                    "type": "adventure",
                                    "parameters": {
                                    ...
                                    "title": "Adventure",
                                    "text": "{a.atm4}\u003Cbr \/\u003E{a.ad} {a.ad1}"
                                }]
                            }, {
                                "x": 16,
                                "y": 222,
                                "s": [{
                                    "dataId": "adventure12589598",
                                    "x": "16",
                                    "y": "222",
                                    "type": "adventure",
                                    "parameters": {
                                    ...
                                    "title": "Adventure",
                                    "text": "{a.atm5}\u003Cbr \/\u003E{a.ad} {a.ad2}"
                                }]
                            }, {
                                "x": 14,
                                "y": 226,
                                "s": [{
                                    "dataId": "adventure12589599",
                                    "x": "14",
                                    "y": "226",
                                    "type": "adventure",
                                    "parameters": {
                                    ...
                                    "title": "Adventure",
                                    "text": "{a.atm6}\u003Cbr \/\u003E{a.ad} {a.ad3}"
                                }]
                            }, {
                                "x": 20,
                                "y": 225,
                                "s": [{
                                    "dataId": "adventure12589600",
                                    "x": "20",
                                    "y": "225",
                                    "type": "adventure",
                                    "parameters": {
                                    ...
                                    "title": "Adventure",
                                    "text": "{a.atm7}\u003Cbr \/\u003E{a.ad} {a.ad0}"
                                }]
                            }, {
                                "x": 18,
                                "y": 219,
                                "s": [{
                                    "dataId": "adventure12589601",
                                    "x": "18",
                                    "y": "219",
                                    "type": "adventure",
                                    "parameters": {
                                    ...
                                    "title": "Adventure",
                                    "text": "{a.atm8}\u003Cbr \/\u003E{a.ad} {a.ad1}"
                                }]
                            }, {
                                "x": 18,
                                "y": 217,
                                "s": [{
                                    "dataId": "adventure12589602",
                                    "x": "18",
                                    "y": "217",
                                    "type": "adventure",
                                    "parameters": {
                                    ...
                                    "title": "Adventure",
                                    "text": "{a.atm9}\u003Cbr \/\u003E{a.ad} {a.ad2}"
                                }]
                            }, {
                                "x": 24,
                                "y": 218,
                                "s": [{
                                    "dataId": "adventure12589603",
                                    "x": "24",
                                    "y": "218",
                                    "type": "adventure",
                                    "parameters": {
                                    ...
                                    "title": "Adventure",
                                    "text": "{a.atm10}\u003Cbr \/\u003E{a.ad} {a.ad3}"
                                }]
                            }, {
                                "x": 12,
                                "y": 224,
                                "s": [{
                                    "dataId": "adventure12589604",
                                    "x": "12",
                                    "y": "224",
                                    "type": "adventure",
                                    "parameters": {
                                    ...
                                    "title": "Adventure",
                                    "text": "{a.atm11}\u003Cbr \/\u003E{a.ad} {a.ad0}"
                                }]
                            }, {
                                "x": 22,
                                "y": 230,
                                "s": [{
                                    "dataId": "adventure12589605",
                                    "x": "22",
                                    "y": "230",
                                    "type": "adventure",
                                    "parameters": {
                                    ...
                                    "title": "Adventure",
                                    "text": "{a.atm12}\u003Cbr \/\u003E{a.ad} {a.ad1}"
                                }]
                            }, {
                                "x": 12,
                                "y": 222,
                                "s": [{
                                    "dataId": "adventure12589606",
                                    "x": "12",
                                    "y": "222",
                                    "type": "adventure",
                                    "parameters": {
                                    ...
                                    "title": "Adventure",
                                    "text": "{a.atm13}\u003Cbr \/\u003E{a.ad} {a.ad2}"
                                }]
                            }, {
                                "x": 13,
                                "y": 230,
                                "s": [{
                                    "dataId": "adventure12589607",
                                    "x": "13",
                                    "y": "230",
                                    "type": "adventure",
                                    "parameters": {
                                    ...
                                    "title": "Adventure",
                                    "text": "{a.atm14}\u003Cbr \/\u003E{a.ad} {a.ad3}"
                                }]
                            }, {
                                "x": 26,
                                "y": 225,
                                "s": [{
                                    "dataId": "adventure12589608",
                                    "x": "26",
                                    "y": "225",
                                    "type": "adventure",
                                    "parameters": {
                                    ...
                                    "title": "Adventure",
                                    "text": "{a.atm15}\u003Cbr \/\u003E{a.ad} {a.ad0}"
                                }]
                            }, {
                                "x": 16,
                                "y": 228,
                                "s": [{
                                    "dataId": "adventure12589609",
                                    "x": "16",
                                    "y": "228",
                                    "type": "adventure",
                                    "parameters": {
                                    ...
                                    "title": "Adventure",
                                    "text": "{a.atm16}\u003Cbr \/\u003E{a.ad} {a.ad1}"
                                }]
                            }, {
                                "x": 8,
                                "y": 226,
                                "s": [{
                                    "dataId": "adventure12589610",
                                    "x": "8",
                                    "y": "226",
                                    "type": "adventure",
                                    "parameters": {
