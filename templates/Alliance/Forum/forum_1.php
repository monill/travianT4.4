...
<script language="JavaScript" type="text/javascript">
    function addRow(element_id) {
        ...
        newTD3.innerHTML = '<img class="add" src="/assets/images/x.gif" title="add" alt="add" onclick="addRow(\'' + element_id + '\')">';
    }
</script>
<script language="JavaScript" type="text/javascript">
...
<form method="post" action="allianz.php?s=2">
    ...
    <h4 id="ally_list_headline" class="tableHeadline hide"><?php echo AL_OPENFORMOREALLY; ?></h4>
        ...
        <tbody>
            <tr>
                ...
                <td class="ad">
                    ...
                    <img class="add" src="/assets/images/x.gif" title="add" alt="add" onclick="addRow('ally_list')" />
                </td>
            </tr>
    </table>
    <h4 id="user_list_headline" class="tableHeadline hide"><?php echo AL_OPENFORMOREPLAYERS; ?></h4>
    <table cellpadding="1" cellspacing="1" id="user_list" class="hide">
        ...
        <tbody>
            <tr>
                ...
                <td class="ad">
                    <img class="add" src="/assets/images/x.gif" title="add" alt="add" onclick="addRow('user_list')" />
                </td>
            </tr>
        </tbody>
    </table>
