...
<div id="build" class="gid36">
    <div class="build_desc">
        <a href="#" onClick="return Travian.Game.iPopup(36,4);" class="build_logo">
            <img class="building big white g36" src="/assets/images/x.gif" alt="<?php echo B36; ?>"
        ...
        <div class="buildActionOverview trainUnits">
            <div class="action first">
                ...
                <div class="details">
                    ...
                    <div class="showCosts">
                        <?php
                        echo '<span class="resources r1"><img class="r1" src="/assets/images/x.gif" alt="' . VL_WOOD . '">' . ($u199['wood']) . '</span><span class="resources r2"><img class="r2" src="/assets/images/x.gif" alt="' . VL_CLAY . '">' . ($u199['clay']) . '</span><span class="resources r3"><img class="r3" src="/assets/images/x.gif" alt="' . VL_IRON . '">' . ($u199['iron']) . '</span><span class="resources r4"><img class="r4" src="/assets/images/x.gif" alt="' . VL_CROP . '">' . ($u199['crop']) . '</span><span class="resources r5"><img class="r5" src="/assets/images/x.gif" alt="' . VL_UPKEEP . '">' . $u199['pop'] . '</span>';
                        ?>
                        <div class="clear"></div>
                        <span class="clocks"><img class="clock" src="/assets/images/x.gif"
                                                  alt="<?php echo AT_DURATION; ?>">
                            <?php
                            echo $eachStr;
                            if ($session->userinfo['gold'] >= 3 && $building->getTypeLevel(17) >= 1) {
                                echo "&nbsp;&nbsp;<button type=\"button\" value=\"npc\" class=\"icon\" onclick=\"window.location.href = 'build.php?gid=17&t=3&r1=" . ($u199['wood'] * $maxtrapPlus) . "&r2=" . ($u199['clay'] * $maxtrapPlus) . "&r3=" . ($u199['iron'] * $maxtrapPlus) . "&r4=" . ($u199['crop'] * $maxtrapPlus) . "'; return false;\"><img src=\"/assets/images/x.gif\" class=\"npc\" alt=\"npc\"></button>";
                            }
                            ?>
</span>
                    ...
                    <span class="value"><?php echo U199; ?></span> <input type="text" class="text" name="t199" value="0"
                                                                          maxlength="4"><span
                            class="value">
/ </span> <a href="#"
    ...
    <table cellpadding=\"1\" cellspacing=\"1\" class=\"under_progress\">
        ...
        foreach ($trainlist as $train) {
            ...
            echo "<img class=\"unit u" . $train['unit'] . "\" src=\"/assets/images/x.gif\" alt=\"" . $train['name'] . "\" title=\"" . $train['name'] . "\" />";
