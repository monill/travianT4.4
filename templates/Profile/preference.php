...
<form action="spieler.php?s=2" method="POST">
    ...
    <h4 class="round spacer"><?php echo LINKS; ?></h4>
    ...
    <table class="transparent" cellpadding="1" cellspacing="1" id="links">
        ...
        <tbody>
            ...
            foreach ($links as $link) : ?>
                <tr>
                    <td>
                        <a href="spieler.php?del=<?php echo $link['id']; ?>&s=2">
                            <img class="del" src="/assets/images/x.gif" alt="delete" title="delete">
                        </a>
                    </td>
                    <td class="nr">
                        <input class="text" type="text" name="nr<?php print $i; ?>" value="<?php print $link['pos']; ?>" size="1" maxlength="3" />
                        <input type="hidden" name="id<?php print $i; ?>" value="<?php print $link['id']; ?>" />
                    </td>
                    <td class="nam">
            ...
            <tr class="addLine templateElement insertElement">
                ...
                <td class="add">
                    <input type="image" value="" name="s1" id="plus" class="plus" src="/assets/images/x.gif" alt="OK" />
                </td>
            </tr>
        </tbody>
    </table>
    ...
    <div class="submitButtonContainer">
        <button type="submit" value="save" name="s1" id="btn_ok">
            <div class="button-container">
                ...
                <div class="button-contents"><?php echo SAVE; ?></div>
            </div>
        </button>
    </div>
</form>