...
if (
    ...
    while ($y1 >= $y0 && $x0 <= $x1) {
        ...
        if (strpos($t, '-') !== FALSE) {
            $loc = 'mkarte/villages';
            $t3 = "/assets/images/" . $loc . "/" . $t . ".gif";
            //var_dump($t3);
            $loc = 'mkarte';
            $t2 = "/assets/images/" . $loc . "/grassland0.gif";
        } elseif (strpos($t, '_') !== FALSE) {
            $loc = 'mkarte';
            $newt = explode('_', $t);

            $t4 = "/assets/images/" . $loc . "/" . $newt[0] . $newt[1] . ".gif";
            $t2 = "/assets/images/" . $loc . "/grassland" . $newt[1] . ".gif";
            ...
            if ($row['oasistype'] != 0) {
                ...
                $t5 = "/assets/images/" . $loc . "/o" . $row['oasistype'] . $ads . ".gif";
            }
        } elseif (strpos($t, 'vulcano') !== FALSE) {
            $loc = 'mkarte';
            $t4 = "/assets/images/" . $loc . "/vulcano0.gif";
            $t2 = "/assets/images/" . $loc . "/grassland0.gif";
        } else {
            $loc = 'mkarte';
    ...
    if (!$PageWasUpdated or $DoIDsMatch) {
        ...
        // Tell the browser which size the content check for the page content
