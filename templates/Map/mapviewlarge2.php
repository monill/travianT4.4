<div id="map_content">
    ...
    <div id="mbig">
        <div id="lightframe">
            <div id="darkframe"><a id="map_popclose" href="karte.php?z=<?php echo $_GET['z']; ?>">
                    <img src="/assets/images/x.gif" alt="Close map" title="Close map"></a>
                <h1>Coordinate(<span id="x"><?php echo $x; ?></span>|<span id="y"><?php echo $y; ?></span>)</h1>
                <div id="map">
                    ...
                    <img id="map_links" src="/assets/images/x.gif" usemap="#map_overlay_large">
                    <script type="text/javascript">
                        m_c.az = {
                            "n1": <?php echo $generator->getBaseID($x, $yp1) ?>,
                            "n1p7": <?php echo $generator->getBaseID($x, $yp7) ?>,
                            "n2": <?php echo $generator->getBaseID($xp1, $y) ?>,
                            "n2p7": <?php echo $generator->getBaseID($xm7, $y) ?>,
                            "n3": <?php echo $generator->getBaseID($x, $ym1) ?>,
                            "n3p7": <?php echo $generator->getBaseID($x, $ym7) ?>,
                            "n4": <?php echo $generator->getBaseID($xm1, $y) ?>,
                            "n4p7": <?php echo $generator->getBaseID($xp7, $y) ?>
                        };
                        m_c.ad = [<?php
                                    $yrow = 0;
                                    $regcount = 0;
                                    ...
                                    for ($h = 0; $h <= 12; $h++) {
                                        if ($yrow != 15) {
                                            $text = "[" . $maparray[$regcount]['x'] .
                                                "," . $maparray[$regcount]['y'] .
                                                "," . $maparray[$regcount]['fieldtype'] .
                                                "," . $maparray[$regcount]['oasistype'] .
                                                ",\"d=" . $maparray[$regcount]['id'] .
                                                "&c=" . $generator->getMapCheck($maparray[$regcount]['id']) .
                                                "\",\"" . $maparray[$regcount]['image'] .
                                                "\"";
                                            if ($maparray[$regcount]['occupied']) {
                                                if ($maparray[$regcount]['fieldtype'] != 0) {
                                                    $text .= ",\"" . $maparray[$regcount]['name'] .
                                                        "\",\"" . $database->getUserField($maparray[$regcount]['owner'], 'username', 0) .
                                                        "\",\"" . $maparray[$regcount]['pop'] . "\",\"" . $database->getUserAlliance($maparray[$regcount]['owner']) .
                                                        "\",\"" . $database->getUserField(
                                                            $maparray[$regcount]['owner'],
                                                            'tribe',
                                                            0
                                                        ) .
                                                        "\"]";
                                                    ...
                                                    $text .= ",\"\",\"" . $database->getUserField($oowner, 'username', 0) .
                                                        "\",\"-\",\"" . $database->getUserAlliance($oowner) .
                                                        "\",\"" . $database->getUserField($oowner, 'tribe', 0) .
                                                        "\"]";
                                                }
                                            } else {
                                                $text .= "]";
                    ...
                    <img id="map_navibox" src="/assets/images/x.gif" usemap="#map_navibox" />
                    <map name="map_navibox">
                        <area id="ma_n1p7" href="karte.php?z=<?php echo $generator->getBaseID($x, $yp7) ?>" coords="51,15,73,3,95,15,73,27" shape="poly" title="North" alt="" />
                        <area id="ma_n2p7" href="karte.php?z=<?php echo $generator->getBaseID($xm7, $y) ?>" coords="51,41,73,29,95,41,73,53" shape="poly" title="East" alt="" />
                        <area id="ma_n3p7" href="karte.php?z=<?php echo $generator->getBaseID($x, $ym7) ?>" coords="4,41,26,29,48,41,26,53" shape="poly" title="South" alt="" />
                        <area id="ma_n4p7" href="karte.php?z=<?php echo $generator->getBaseID($xp7, $y) ?>" coords="4,15,26,3,48,15,26,27" shape="poly" title="West" alt="" />
                        <!--z = baseid-->
                    </map>
                    <div id="map_coords">
                        <form name="map_coords" method="post" action="karte.php">
                            ...
                            <input type="image" id="btn_ok" class="dynamic_img" value="ok" name="s1" src="/assets/images/x.gif" alt="" />
                        </form>
                    </div>
                    <table cellpadding="1" cellspacing="1" id="map_infobox" class="deLumberult">
                        <thead>
                            <tr>
