...
<div id="build" class="gid16">
                ...
                $('button5300d0c550a3c').addEvent('click', function () {
                    window.fireEvent('tabClicked', [this, {
                        ...
                        <?php if (!$session->goldclub) {
                            echo '"goldclubDialog":{"featureKey":"raidList","infoIcon":"http:\/\/t4.answers.travian.ir\/index.php?aid=Travian Answers#go2answer"},';
                        } ?>"containerId": "",
    ...
    <div class="build_desc">
        <a href="#" onClick="return Travian.Game.iPopup(16,4);" class="build_logo">
            <img class="g16 big white" src="/assets/images/x.gif" alt="<?php echo B16; ?>" title="<?php echo B16; ?>"/>
        </a>
    ...
    if (!$village->resarray['f' . $id] < 1) {
        ...
        if (count($village->enforcetome) > 0) {
            foreach ($village->enforcetome as $enforce) {
                ...
                if ($isoasis || $fromVillage['owner'] == 4) {
                    ...
                    for ($i = $start; $i <= ($end); $i++) {
                        echo "<td><img src=\"/assets/images/x.gif\" class=\"unit u$i\" title=\"" . $technology->getUnitName($i) . "\" /></td>";
                    }
                    if ($enforce['hero'] > 0) {
                        echo "<td><img src=\"/assets/images/x.gif\" class=\"unit uhero\" title=\"" . $technology->getUnitName(51) . "\" /></td>";
                    }
				...
				<tbody class=\"infos\"><tr><th>" . VL_WHEATCONSUMPTION . "</th>";
                    ...
                    echo "<div class='sup'>" . $technology->getUpkeep($enforce, $fromTribe) . "<img class=\"r4\" src=\"/assets/images/x.gif\" title=\"Crop\" alt=\"Crop\" />" . BL_PER_HR . " </div><div class='sback'><a href='a2b.php?w=" . $enforce['id'] . "'>" . AT_PULLBACK . "</a></div></td></tr>";
            ...
            if ($heyvoon != 0) {
				...
				<tbody class=\"infos\"><tr><th>" . VL_WHEATCONSUMPTION . "</th>";
                echo "<td colspan=\"10\">";
                echo "<div class='sup'>0<img class=\"r4\" src=\"/assets/images/x.gif\" title=\"Crop\" alt=\"Crop\" />" . BL_PER_HR . " </div><div class='sback'><a href='a2b.php?anim'>" . AT_TRAPPED_KILL . "</a></div></td></tr>";
                echo "</tbody></table>";
            }
        }
        ...
        if (count($village->enforcetoyou) > 0) {
            ...
            foreach ($village->enforcetoyou as $enforce) {
                ...
                for ($i = $start; $i <= ($end); $i++) {
                    echo "<td><img src=\"/assets/images/x.gif\" class=\"unit u$i\" title=\"" . $technology->getUnitName($i) . "\" alt=\"" . $technology->getUnitName($i) . "\" /></td>";
                }
                if ($enforce['hero'] > 0) {
                    echo "<td><img src=\"/assets/images/x.gif\" class=\"unit uhero\" title=\"" . $technology->getUnitName(51) . "\" /></td>";
                }
            ...
            <tbody class=\"infos\"><tr><th>" . VL_WHEATCONSUMPTION . "</th>";
                ...
                echo "<div class='sup'>" . $technology->getUpkeep($enforce, $tribe) . "<img class=\"r4\" src=\"/assets/images/x.gif\" title=\"Crop\" alt=\"Crop\" />Per hour</div><div class='sback'><a href='a2b.php?r=" . $enforce['id'] . "'>" . AT_PULLBACK . "</a></div></td></tr>";
    ...
    if (count($village->trappedinme) > 0) {
        ...
        foreach ($village->trappedinme as $trappedinme) {
            ...
            echo "<div class='sup'>0<img class=\"r4\" src=\"/assets/images/x.gif\" title=\"Crop\" alt=\"Crop\" />per hour </div><div class='sback'><a href='a2b.php?f=" . $trappedinme['id'] . "'>" . AT_TRAPPED_FREE . "</a> " . AT_OR_STR . " <a href='a2b.php?k=" . $trappedinme['id'] . "'>" . AT_TRAPPED_KILL . "</a></div></td></tr>";
    ...
    if (count($village->trappedinyou) > 0) {
        ...
        foreach ($village->trappedinyou as $trappedinyou) {
            ...
            echo "<div class='sup'>" . $technology->getUpkeep($trappedinyou, $tribe) . "<img class=\"r4\" src=\"/assets/images/x.gif\" title=\"Crop\" alt=\"Crop\" />Per hour</div><div class='sback'><a href='a2b.php?k=" . $trappedinyou['id'] . "'>" . AT_PULLBACK . "</a></div></td></tr>";
