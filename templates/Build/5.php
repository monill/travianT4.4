<h1 class="titleInHeader"><?php echo B5; ?> <span
...
<div id="build" class="gid5">
    <div class="build_desc">
        <a href="#" onClick="return Travian.Game.iPopup(5,4);" class="build_logo">
            <img class="building big white g5" src="/assets/images/x.gif" alt="<?php echo B5; ?>" title="<?php echo B5; ?>"/>
        </a>
    ...
    <table cellpadding="1" cellspacing="1" id="build_value">
        <tr>
            ...
            <td>
                <b><?php echo $bid5[$village->resarray['f' . $id]]['attri'] ? $bid5[$village->resarray['f' . $id]]['attri'] : '0'; ?></b>%
            </td>
        </tr>
        <?php
