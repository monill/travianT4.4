...
<div class="build_desc">
    <a href="#" onclick="return Travian.Game.iPopup(22,4);" class="build_logo">
        <img class="building big white g22" src="/assets/images/x.gif" alt="<?php echo B22; ?>">
    </a>
    <?php echo B22_DESC; ?></div>
<div id="contract" class="contract contractNew contractWrapper">
    <div class="contractText"><?php echo BL_COSTS; ?>:</div>
    ...
    <a href="#" onclick="return Travian.Game.iPopup(19,4, 'gid');"><?php echo B19; ?></a> <span><?php echo BL_LVL; ?>
            3</span></span>, <span class="buildingCondition"><a href="#"
                                                                onclick="return Travian.Game.iPopup(15,4, 'gid');"><?php echo B15; ?></a> <span><?php echo BL_LVL; ?>
                3</span></span>
    </div>
    <div class="clear"></div>
</div>
