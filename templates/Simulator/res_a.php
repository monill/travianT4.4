...
<table class="results attacker" cellpadding="1" cellspacing="1">
    <thead>
        <tr>
            ...
            <?php
            for ($i = $start; $i <= $end; $i++) {
                echo '<td><img src="/assets/images/x.gif" class="unit u' . $i . '" alt="' . constant('U' . $i) . '" title="' . constant('U' . $i) . '"></td>';
            }
            ?>
        </tr>
    </thead>
    <tbody>
        <tr>
            ...
            for ($i = $start; $i <= $end; $i++) {
                ...
                if (isset($u) && $u != 0 && $u != '') echo '<td>' . $u . '</td>';
                else echo '<td class="none">0</td>';
            }
            ?>
        </tr>
        <tr>
            ...
            <?php
            for ($i = $start; $i <= $end; $i++) {
                $u = $_POST['result']['casualties']['attacker']['u' . $i];
                if (isset($u) && $u != 0 && $u != '') echo '<td>' . $u . '</td>';
                else echo '<td class="none">0</td>';
            }
            ?>
        ...
        <tbody class="goods">
            <tr>
                <td colspan="11">
                    ...
                    <img class="unit u<?php echo $catp_pic; ?>" src="/assets/images/x.gif" alt="<?php echo constant('U' . $catp_pic); ?>" title="<?php echo constant('U' . $catp_pic); ?>" />
                    <img class="unit ucata" src="/assets/images/x.gif" />
                    <?php echo sprintf(
                        REPORT_BUILDINGDAMAGED,
                        WARSIM_CTAR1,
    ...
    <table class="results attacker" cellpadding="1" cellspacing="1">
        <tbody class="goods">
            <tr>
                <td colspan="11">
                    <?php echo REPORT_INFORMATION; ?>
                    <img class="unit u<?php echo $ram_pic; ?>" src="/assets/images/x.gif" alt="<?php echo $technology->unarray[$ram_pic]; ?>" title="<?php echo $technology->unarray[$ram_pic]; ?>" />
                    <img class="unit <?php echo $class; ?>" alt="<?php echo $title; ?>" title="<?php echo $title; ?>" src="/assets/images/x.gif" />
                    <?php echo sprintf(
                        REPORT_WALLDAMAGEDED,
                        $_POST['result']['had']['defender']['wall'],
