<h1 class="titleInHeader"><?php echo B9; ?> <span
...
<div id="build" class="gid9">
    <div class="build_desc">
        <a href="#" onClick="return Travian.Game.iPopup(9,4);" class="build_logo">
            <img class="building big white g9" src="/assets/images/x.gif" alt="<?php echo B9; ?>" title="<?php echo B9; ?>"/>
        </a>
    ...
    <table cellpadding="1" cellspacing="1" id="build_value">
        <tr>
            ...
            <td>
                <b><?php echo $bid9[$village->resarray['f' . $id]]['attri'] ? $bid9[$village->resarray['f' . $id]]['attri'] : '0'; ?></b>%
            </td>
        </tr>
        <?php
