...
?>
    ...
    <?php if (isset($_POST["custom_url"])) {
        $database->updateUserField($session->uid, GP_LOCATE, $_POST["custom_url"], 1);
    } ?>
    <?php if (isset($_GET["custom_url"])) { ?>
        ...
        <div id="gpack_popup">
            ...
            <div id="gpack_error">
                <img class="logo unknown" src="/assets/images/x.gif" alt="unknown" title="unknown"><span class="error"><?php echo GPNFOUNDDESC; ?>:</span><br>
                <ul>
                ...
                <form action="spieler.php" method="post">
                    ...
                    <div class="btn"><input type="image" alt="OK" src="/assets/images/x.gif" value="ok" class="dynamic_img" id="btn_ok">
                    </div>
                </form>
            </div>
            ...
            <div id="gpack_activate">
                ...
                <img id="preview" src="/assets/images/x.gif"><br>
                ...
                <form action="spieler.php" method="post">
                    ...
                    <div class="btn"><input type="image" alt="save" src="/assets/images/x.gif" value="save" class="dynamic_img" id="btn_save" name="gp_activate_button"></div>
                </form>
            </div>
        </div>
    <?php } ?>
    ...
    <form action="spieler.php" method="post" name="gp_selection">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        ...
                        <div class="example"><?php echo JR_EXAMPLE; ?>: <span class="path">file:///C:/t4dl.ir/gpack/</span>
                            <?php echo OR_STR; ?> <span class="path">http://www.ttwar.org/user/gpack/</span>
                        </div>
        ...
        <p class="btn"><input type="image" alt="OK" src="/assets/images/x.gif" name="gp_selection_button" value="ok" class="dynamic_img" id="btn_ok" /></p>
    </form>
    ...
    <table cellpadding="1" cellspacing="1" id="download">
        ...
        <tbody>
            <tr>
                ...
                <td class="size">4</td>
                <td class="act">
                    <a href="spieler.php?s=4&gp_type=custom&custom_url=gpack/travian_default/"><?php echo ACTIVATE; ?></a>
                </td>
                <td class="down"><a href="gpack/download/travian_default.zip" target="_blank"><?php echo DOWNLOAD; ?></a>
                </td>
            </tr>
        </tbody>
    </table>
