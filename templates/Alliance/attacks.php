...
<div class="boxes boxesColor gray reportFilter offDef">
    ...
    <div class="boxes-contents cf">
        <button type="button" class="iconFilter " title="Attaker" onclick="window.location.href = 'allianz.php?s=3&amp;f=31&amp;fn=0'; return false;">
            <img src="/assets/images/x.gif" class="att_all" alt="att_all" />
        </button>
        <button type="button" class="iconFilter " title="Defender" onclick="window.location.href = 'allianz.php?s=3&amp;f=32&amp;fn=0'; return false;">
            <img src="/assets/images/x.gif" class="def_all" alt="def_all" />
        </button>
    </div>
</div>
<div class="boxes boxesColor gray reportFilter unimportant">
    ...
    <div class="boxes-bc"></div>
    <div class="boxes-contents cf">
        <button type="button" class="iconFilter " title="Don´t show attacks of own alliance (under 100 units, no losses)." onclick="window.location.href = 'allianz.php?s=3&amp;f=-1&amp;fn=1'; return false;">
            <img src="/assets/images/x.gif" class="filterNews" alt="filterNews" />
        </button>
    </div>
</div>
<div class="clear"></div>
...
<?php
if ($_GET['f'] == 31) {
    include "templates/Alliance/attack-attacker.php";
} elseif ($_GET['f'] == 32) {
    ...
    if ($query == 0) {
        ...
        while ($row = mysql_fetch_array($sql)) {
            ...
            if ($type == 18 or $type == 19 or $type == 20 or $type == 21) {
                $outputList .= "<img src=\"/assets/images/scouts/$type.gif\" title=\"" . $topic . "\" />";
            } else {
                $outputList .= "<img src=\"/assets/images/x.gif\" class=\"iReport iReport$type\" title=\"" . $topic . "\">";
            }
            $outputList .= "</a>";
