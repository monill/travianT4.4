...
// HERO FACE:
$face0 = imagecreatefrompng('/assets/images/hero/' . $gdir . '/head/' . $fsize . '/face0.png');
$face = imagecreatefrompng('/assets/images/hero/' . $gdir . '/head/' . $fsize . '/face/face' . $getface . '.png');
$ear = imagecreatefrompng('/assets/images/hero/' . $gdir . '/head/' . $fsize . '/ear/ear' . $getear . '.png');
$eye = imagecreatefrompng('/assets/images/hero/' . $gdir . '/head/' . $fsize . '/eye/eye' . $geteye . '.png');
$eyebrow = imagecreatefrompng('/assets/images/hero/' . $gdir . '/head/' . $fsize . '/eyebrow/eyebrow' . $geteyebrow . (($gender == 0) ? '-' . $color : '') . '.png');
if ($gethair != 5) {
    $hair = imagecreatefrompng('/assets/images/hero/' . $gdir . '/head/' . $fsize . '/hair/hair' . $gethair . '-' . $color . '.png');
}
$mouth = imagecreatefrompng('/assets/images/hero/' . $gdir . '/head/' . $fsize . '/mouth/mouth' . $getmouth . '.png');
$nose = imagecreatefrompng('/assets/images/hero/' . $gdir . '/head/' . $fsize . '/nose/nose' . $getnose . '.png');
if ($getbeard != 5) {
    $beard = imagecreatefrompng('/assets/images/hero/' . $gdir . '/head/' . $fsize . '/beard/beard' . $getbeard . '-' . $color . '.png');
}
...
echo '/assets/images/hero/' . $gdir . '/body/' . $size . '/armor' . $armors . '.png';
...
// HERO BODY:
$body = imagecreatefrompng('/assets/images/hero/' . $gdir . '/body/' . $size . '/hero_body0.png');
if ($gethelmet != 0) {
    $helmet = imagecreatefrompng('/assets/images/hero/' . $gdir . '/body/' . $size . '/helmet' . $helmet . '.png');
}

if ($getarmor != 0) {
    $armor = imagecreatefrompng('/assets/images/hero/' . $gdir . '/body/' . $size . '/shirt' . $armors . '.png');
}
$leftHand = imagecreatefrompng('/assets/images/hero/' . $gdir . '/body/' . $size . '/' . $leftHand . '.png');
$rightHand = imagecreatefrompng('/assets/images/hero/' . $gdir . '/body/' . $size . '/' . $rightHand . '.png');
if ($getshoes != 0) {
    $shoes = imagecreatefrompng('/assets/images/hero/' . $gdir . '/body/' . $size . '/shoes' . $shoes . '.png');
}
if ($gethorse != 0) {
    $horse = imagecreatefrompng('/assets/images/hero/' . $gdir . '/body/' . $size . '/horse0.png');
}
if ($getbag != 0) {
    $bag = imagecreatefromgif('/assets/images/hero/' . $gdir . '/items/item' . $getbag . '.gif');
}
