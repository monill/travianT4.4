...
foreach ($_POST as $value) {
    ...
    foreach ($badwords as $word) {
        if (substr_count($value, $word) > 0) {
            $block_INPUT = $value;
            // echo ("<script> alert ('Probably this message was given to you due to a system crash. If you repeat this message, clear your browser cache and try again.'); location=('logout.php' </script> ");
        }
    }
