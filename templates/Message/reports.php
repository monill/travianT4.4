...
if ($session->uid == 4) {
    if (!isset($_GET['report'])) {
        ...
        include('templates/pagination2.php');
        ...
        if ($query == 0) {
            ...
            while ($row = mysql_fetch_array($sql2)) {
                ...
                $outputList .= "<img src=\"/assets/images/x.gif\" class=\"messageStatus messageStatus" . $viewed . "\" alt=\"" . MS_READ . "\">
            ...
            <table cellpadding="1" cellspacing="1" id="overview" class="inbox">
                <thead>
                    <tr>
                        ...
                        <th style="background-color:#edeceb;" class="dat"><b>ارسال شده&nbsp;</b><img src="/assets/images/x.gif" alt="sort" /></a>
                        </th>
                    </tr>
                </thead>
                                ...
                                if ($('button5225ee283b15922')) {
                                    $('button5225ee283b15922').addEvent('click', function() {
                                        window.fireEvent('buttonClicked', [this, {
                                            ...
                                            "speechBubble": "",
                                            "class": "",
                                            "id": "button5225ee283b15922",
                                            "redirectUrl": "nachrichten.php?t=1&id=<?php echo $database->getUserField($reported_by, 'id', 1); ?>",
                                            "redirectUrlExternal": ""
                                        }]);
                                    });
                                }
                                ...
                                if ($('button5225ee283b1592')) {
                                    $('button5225ee283b1592').addEvent('click', function() {
                                        window.fireEvent('buttonClicked', [this, {
                                            ...
                                            "speechBubble": "",
                                            "class": "",
                                            "id": "button5225ee283b1592",
                                            "redirectUrl": "nachrichten.php?t=1&id=<?php echo $row2['owner']; ?>",
                                            "redirectUrlExternal": ""
                                        }]);
                                    });
                                }
