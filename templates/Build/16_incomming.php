                ...
                if ($units[$y]['attack_type'] == 3 || $units[$y]['attack_type'] == 4) {
                    ...
                    <tr>
                        ...
                        <td colspan="<?php echo $colspan; ?>">
                            <div class="res">
                                        <span class="resource" title="Lumber"><img class="r1" src="/assets/images/x.gif"
                                                                                   alt="Lumber"><?php echo $dataarray[0]; ?></span>
                                <span class="resource" title="Clay"><img class="r2" src="/assets/images/x.gif"
                                                                         alt="Clay"><?php echo $dataarray[1]; ?></span>
                                <span class="resource" title="Iron"><img class="r3" src="/assets/images/x.gif"
                                                                         alt="Iron"><?php echo $dataarray[2]; ?></span>
                                <span class="resource" title="Crop"><img class="r4" src="/assets/images/x.gif"
