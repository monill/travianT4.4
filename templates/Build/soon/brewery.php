...
<div class="build_desc">
    <a href="#" onclick="return Travian.Game.iPopup(35,4);" class="build_logo">
        <img class="building big white g35" src="/assets/images/x.gif" alt="<?php echo B35; ?>">
    </a>
...
<div id="contract" class="contract contractNew contractWrapper">
    ...
    <a href="#"
       onclick="return Travian.Game.iPopup(11,4, 'gid');"><?php echo B11; ?></a> <span><?php echo BL_LVL; ?> 20</span></span>,
